        ...
        if (_operator_equals) {
          {
            ...
            if (_operator_notEquals) {
            ...
            } else {
              {
                ...
                boolean _operator_lessThan_1 = IntegerExtensions.operator_lessThan(i_1, _size_1);
                if (!_operator_lessThan_1) {
                  _operator_and = false;
                } else {
                  boolean _operator_not = BooleanExtensions.operator_not(found);
                  _operator_and = BooleanExtensions.operator_and(_operator_lessThan_1, _operator_not);
                }
                boolean _while_1 = _operator_and;
                while (_while_1) {
                  {
                    Resource _get = resources.get(i_1);
                    ...
                    int _operator_plus = IntegerExtensions.operator_plus(i_1, 1);
                    i_1 = _operator_plus;
                  }
                  boolean _operator_and_2 = false;
                  int _size_2 = resources.size();
                  boolean _operator_lessThan_2 = IntegerExtensions.operator_lessThan(i_1, _size_2);
                  if (!_operator_lessThan_2) {
                    _operator_and_2 = false;
                  } else {
                    boolean _operator_not_2 = BooleanExtensions.operator_not(found);
                    _operator_and_2 = BooleanExtensions.operator_and(_operator_lessThan_2, _operator_not_2);
                  }
