...
public class XcoreResource extends XbaseResource
{
  ...
  protected EObject findEObject(EClass eClass, QualifiedName name, String uriFragment)
  {
    ...
    {
      IScope scope = scopeProvider.getScope(getContents().get(0), eClass.getEPackage() == GenModelPackage.eINSTANCE
        ? XcorePackage.Literals.XGENERIC_TYPE__TYPE : TypesPackage.Literals.JVM_PARAMETERIZED_TYPE_REFERENCE__TYPE);
