			...
			(
				...
				lv_annotations_1_0=ruleXAnnotation
				{
					...
					add(
						...
						"annotations",
						lv_annotations_1_0,
						"org.eclipse.emf.ecore.xcore.Xcore.XAnnotation");
			...
			(
				...
				lv_importDirectives_4_0=ruleXImportDirective
				{
					...
					add(
						...
						"org.eclipse.emf.ecore.xcore.Xcore.XImportDirective");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_annotationDirectives_5_0=ruleXAnnotationDirective
				{
					...
					add(
						...
						"org.eclipse.emf.ecore.xcore.Xcore.XAnnotationDirective");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_classifiers_6_0=ruleXClassifier
				{
					...
					add(
						...
						"classifiers",
						lv_classifiers_6_0,
						"org.eclipse.emf.ecore.xcore.Xcore.XClassifier");
					afterParserOrEnumRuleCall();
				}
			)
		)*
				...
				(
					...
					lv_details_3_0=ruleXStringToStringMapEntry
					{
						...
						add(
							...
							"details",
							lv_details_3_0,
							"org.eclipse.emf.ecore.xcore.Xcore.XStringToStringMapEntry");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_name_3_0=ruleValidID
				{
					...
					set(
						...
						"name",
						lv_name_3_0,
						"org.eclipse.emf.ecore.xcore.Xcore.ValidID");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_typeParameters_4_0=ruleXTypeParameter
					{
						...
						add(
							...
							"org.eclipse.emf.ecore.xcore.Xcore.XTypeParameter");
						afterParserOrEnumRuleCall();
					}
				)
			)
								...
								({true}?=>((
									(
										...
										}
										{
											...
											setWithLastConsumed($current, "serializable", lv_serializable_11_0 != null, "create");
										}
									)
								)
								(
									(
										...
										lv_createBody_12_0=ruleXBlockExpression
										{
											...
											set(
												...
												"createBody",
												lv_createBody_12_0,
												"org.eclipse.emf.ecore.xcore.Xcore.XBlockExpression");
											afterParserOrEnumRuleCall();
										}
									)
								)
				...
				(
					...
					lv_literals_4_0=ruleXEnumLiteral
					{
						...
						add(
							...
							"literals",
							lv_literals_4_0,
							"org.eclipse.emf.ecore.xcore.Xcore.XEnumLiteral");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_value_5_0=ruleSignedInt
					{
						...
						set(
							...
							"value",
							lv_value_5_0,
							"org.eclipse.emf.ecore.xcore.Xcore.SignedInt");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				(
					...
					}
					{
						...
						setWithLastConsumed($current, "interface", lv_interface_4_0 != null, "interface");
					}
				)
			)
		)
				...
				(
					...
					lv_superTypes_12_0=ruleXGenericType
					{
						...
						add(
							...
							"superTypes",
							lv_superTypes_12_0,
							"org.eclipse.emf.ecore.xcore.Xcore.XGenericType");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_members_18_0=ruleXMember
				{
					...
					add(
						...
						"members",
						lv_members_18_0,
						"org.eclipse.emf.ecore.xcore.Xcore.XMember");
					afterParserOrEnumRuleCall();
				}
			)
		)*
						...
						getUnorderedGroupHelper().select(grammarAccess.getXAttributeAccess().getUnorderedGroup_2(), 0);
								...
								({true}?=>((
									...
									}
									{
										...
										setWithLastConsumed($current, "unordered", lv_unordered_3_0 != null, "unordered");
									}
								)
								))
					{ 
						...
						getUnorderedGroupHelper().select(grammarAccess.getXAttributeAccess().getUnorderedGroup_2(), 3);
								...
								({true}?=>((
									...
									}
									{
										...
										setWithLastConsumed($current, "transient", lv_transient_6_0 != null, "transient");
									}
								)
								))
					{ 
						...
						getUnorderedGroupHelper().select(grammarAccess.getXAttributeAccess().getUnorderedGroup_2(), 4);
								...
								({true}?=>((
									...
									}
									{
										...
										setWithLastConsumed($current, "volatile", lv_volatile_7_0 != null, "volatile");
									}
								)
								))
					{ 
						...
						getUnorderedGroupHelper().select(grammarAccess.getXAttributeAccess().getUnorderedGroup_2(), 5);
								...
								({true}?=>((
									...
									}
									{
										...
										setWithLastConsumed($current, "unsettable", lv_unsettable_8_0 != null, "unsettable");
									}
								)
								))
					{ 
						...
						getUnorderedGroupHelper().select(grammarAccess.getXAttributeAccess().getUnorderedGroup_2(), 6);
								...
								({true}?=>((
									...
									}
									{
										...
										setWithLastConsumed($current, "derived", lv_derived_9_0 != null, "derived");
									}
								)
								))
					{ 
						...
						getUnorderedGroupHelper().select(grammarAccess.getXAttributeAccess().getUnorderedGroup_2(), 7);
								...
								({true}?=>((
									...
									}
									{
										...
										setWithLastConsumed($current, "iD", lv_iD_10_0 != null, "id");
									}
								)
								))
					{ 
			...
			(
				...
				lv_multiplicity_12_0=ruleXMultiplicity
				{
					...
					set(
						...
						"org.eclipse.emf.ecore.xcore.Xcore.XMultiplicity");
					afterParserOrEnumRuleCall();
				}
			)
		)?
				...
				(
					(
						...
						}
						{
							...
							setWithLastConsumed($current, "containment", lv_containment_2_0 != null, "contains");
						}
					)
				)
				(
					(
						...
						}
						{
							...
							setWithLastConsumed($current, "resolveProxies", lv_resolveProxies_3_0 != null, "resolving");
						}
					)
				)?
			)
				...
				(
					(
						...
						}
						{
							...
							setWithLastConsumed($current, "resolveProxies", lv_resolveProxies_4_0 != null, "resolving");
						}
					)
				)
				(
					(
						...
						}
						{
							...
							setWithLastConsumed($current, "containment", lv_containment_5_0 != null, "contains");
						}
					)
				)
			)
				...
				(
					(
						...
						}
						{
							...
							setWithLastConsumed($current, "container", lv_container_6_0 != null, "container");
						}
					)
				)
				(
					(
						...
						}
						{
							...
							setWithLastConsumed($current, "resolveProxies", lv_resolveProxies_7_0 != null, "resolving");
						}
					)
				)?
			)
				...
				(
					(
						...
						}
						{
							...
							setWithLastConsumed($current, "resolveProxies", lv_resolveProxies_8_0 != null, "resolving");
						}
					)
				)
				(
					(
						...
						}
						{
							...
							setWithLastConsumed($current, "container", lv_container_9_0 != null, "container");
						}
					)
				)
			)
				...
				(
					(
						...
						}
						{
							...
							setWithLastConsumed($current, "local", lv_local_11_0 != null, "local");
						}
					)
				)?
			)
				...
				(
					(
						...
						}
						{
							...
							setWithLastConsumed($current, "local", lv_local_12_0 != null, "local");
						}
					)
				)
				otherlv_13='refers'
						...
						getUnorderedGroupHelper().select(grammarAccess.getXReferenceAccess().getUnorderedGroup_3(), 0);
								...
								({true}?=>((
									...
									}
									{
										...
										setWithLastConsumed($current, "unordered", lv_unordered_15_0 != null, "unordered");
									}
								)
								))
					{ 
						...
						getUnorderedGroupHelper().select(grammarAccess.getXReferenceAccess().getUnorderedGroup_3(), 1);
								...
								({true}?=>((
									...
									}
									{
										...
										setWithLastConsumed($current, "unique", lv_unique_16_0 != null, "unique");
									}
								)
								))
					{ 
						...
						getUnorderedGroupHelper().select(grammarAccess.getXReferenceAccess().getUnorderedGroup_3(), 2);
								...
								({true}?=>((
									...
									}
									{
										...
										setWithLastConsumed($current, "readonly", lv_readonly_17_0 != null, "readonly");
									}
								)
								))
					{ 
						...
						getUnorderedGroupHelper().select(grammarAccess.getXReferenceAccess().getUnorderedGroup_3(), 3);
								...
								({true}?=>((
									...
									}
									{
										...
										setWithLastConsumed($current, "transient", lv_transient_18_0 != null, "transient");
									}
								)
								))
					{ 
						...
						getUnorderedGroupHelper().select(grammarAccess.getXReferenceAccess().getUnorderedGroup_3(), 4);
								...
								({true}?=>((
									...
									}
									{
										...
										setWithLastConsumed($current, "volatile", lv_volatile_19_0 != null, "volatile");
									}
								)
								))
					{ 
						...
						getUnorderedGroupHelper().select(grammarAccess.getXReferenceAccess().getUnorderedGroup_3(), 5);
								...
								({true}?=>((
									...
									}
									{
										...
										setWithLastConsumed($current, "unsettable", lv_unsettable_20_0 != null, "unsettable");
									}
								)
								))
					{ 
						...
						getUnorderedGroupHelper().select(grammarAccess.getXReferenceAccess().getUnorderedGroup_3(), 6);
								...
								({true}?=>((
									...
									}
									{
										...
										setWithLastConsumed($current, "derived", lv_derived_21_0 != null, "derived");
									}
								)
								))
					{ 
				...
				(
					(
						...
						}
						{
							...
							setWithLastConsumed($current, "unordered", lv_unordered_6_0 != null, "unordered");
						}
					)
				)?
			)
				...
				(
					...
					lv_parameters_17_0=ruleXParameter
					{
						...
						add(
							...
							"parameters",
							lv_parameters_17_0,
							"org.eclipse.emf.ecore.xcore.Xcore.XParameter");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					(
						...
						}
						{
							...
							setWithLastConsumed($current, "unordered", lv_unordered_1_0 != null, "unordered");
						}
					)
				)
				(
					(
						...
						}
						{
							...
							setWithLastConsumed($current, "unique", lv_unique_2_0 != null, "unique");
						}
					)
				)?
			)
				...
				(
					(
						...
						}
						{
							...
							setWithLastConsumed($current, "unordered", lv_unordered_4_0 != null, "unordered");
						}
					)
				)?
			)
				...
				(
					...
					lv_typeArguments_2_0=ruleXGenericTypeArgument
					{
						...
						add(
							...
							"org.eclipse.emf.ecore.xcore.Xcore.XGenericTypeArgument");
						afterParserOrEnumRuleCall();
					}
				)
			)
...
@after {
	...
	(
		...
		(
			('get' | 'isSet' | 'set' | 'unset' | 'void' | 'abstract' | 'annotation' | 'as' | 'class' | 'container' | 'contains' | 'convert' | 'create' | 'derived' | 'enum' | 'extends' | 'extension' | 'id' | 'import' | 'keys' | 'interface' | 'local' | 'op' | 'opposite' | 'package' | 'readonly' | 'refers' | 'resolving' | 'static' | 'throws' | 'transient' | 'unique' | 'unordered' | 'unsettable' | 'volatile' | 'wraps' | '!' | '-' | '+' | 'new' | '{' | 'switch' | 'synchronized' | '<' | 'super' | '#' | '[' | 'false' | 'true' | 'null' | 'typeof' | 'if' | 'for' | 'while' | 'do' | 'throw' | 'return' | 'try' | '(' | RULE_ID | RULE_HEX | RULE_INT | RULE_DECIMAL | RULE_STRING)=>
			(
				{
