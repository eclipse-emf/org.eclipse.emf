 ...
 * </copyright>
 *
 * $Id: XSDFixedFacetItemProvider.java,v 1.1 2004/03/06 18:00:11 marcelop Exp $
 */
    ...
    IItemPropertySource
{
  ...
  public List getPropertyDescriptors(Object object)
  {
    if (itemPropertyDescriptors == null)
    {
      ...
      XSDFixedFacet xsdFixedFacet = ((XSDFixedFacet)object);
      ...
      itemPropertyDescriptors.add
        (new ItemPropertyDescriptor
          (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
           XSDEditPlugin.getString("_UI_Fixed_label"),
           XSDEditPlugin.getString("_UI_Fixed_description"),
