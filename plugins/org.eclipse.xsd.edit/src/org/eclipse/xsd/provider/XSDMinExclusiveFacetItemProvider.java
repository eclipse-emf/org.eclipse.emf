 ...
 * </copyright>
 *
 * $Id: XSDMinExclusiveFacetItemProvider.java,v 1.1 2004/03/06 18:00:11 marcelop Exp $
 */
    ...
    IItemPropertySource
{
  ...
  public List getPropertyDescriptors(Object object)
  {
    if (itemPropertyDescriptors == null)
    {
      ...
      XSDMinExclusiveFacet xsdMinExclusiveFacet = ((XSDMinExclusiveFacet)object);
      ...
      itemPropertyDescriptors.add
        (new ItemPropertyDescriptor
          (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
           ...
           XSDEditPlugin.getString("_UI_ValueMinExclusiveFacet_description"),
  ...
  {
    return XSDEditPlugin.getImage("full/obj16/XSDMinExclusiveFacet");
  }
}
