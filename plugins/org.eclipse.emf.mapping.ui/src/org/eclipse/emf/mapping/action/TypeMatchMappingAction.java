 ...
 * </copyright>
 *
 * $Id: TypeMatchMappingAction.java,v 1.1.2.1 2005/06/08 18:27:44 nickb Exp $
 */
      ...
      if (collection != null)
      {
        ...
        if (!mappedObjects.isEmpty())
        {
          ...
          switch (mappings.size())
          {
            ...
            case 1:
            {
              result = appendIfCanExecute(TypeMatchMappingCommand.create(mappingDomain, (Mapping)mappings.iterator().next()));
              break;
            }
            default:
            {
