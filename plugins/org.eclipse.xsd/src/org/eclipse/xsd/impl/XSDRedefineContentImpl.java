 ...
 * </copyright>
 *
 * $Id: XSDRedefineContentImpl.java,v 1.1 2004/03/06 18:00:11 marcelop Exp $
 */
  ...
  implements XSDRedefineContent
{
  ...
  {
    return XSDPackage.eINSTANCE.getXSDRedefineContent();
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs)
  {
    if (featureID >= 0)
    {
      ...
      {
        case XSDPackage.XSD_REDEFINE_CONTENT__DIAGNOSTICS:
  ...
  public Object eGet(EStructuralFeature eFeature, boolean resolve)
  {
    ...
    {
      case XSDPackage.XSD_REDEFINE_CONTENT__ELEMENT:
        return getElement();
      case XSDPackage.XSD_REDEFINE_CONTENT__CONTAINER:
        return getContainer();
      case XSDPackage.XSD_REDEFINE_CONTENT__ROOT_CONTAINER:
        return getRootContainer();
      case XSDPackage.XSD_REDEFINE_CONTENT__SCHEMA:
        return getSchema();
      case XSDPackage.XSD_REDEFINE_CONTENT__DIAGNOSTICS:
