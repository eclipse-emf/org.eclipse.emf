 ...
 * </copyright>
 *
 * $Id: XSDMaxFacetImpl.java,v 1.1 2004/03/06 18:00:10 marcelop Exp $
 */
  ...
  implements XSDMaxFacet
{
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs)
  {
    if (featureID >= 0)
    {
      ...
      {
        case XSDPackage.XSD_MAX_FACET__DIAGNOSTICS:
          return ((InternalEList)getDiagnostics()).basicRemove(otherEnd, msgs);
        case XSDPackage.XSD_MAX_FACET__ANNOTATION:
  ...
  public Object eGet(EStructuralFeature eFeature, boolean resolve)
  {
    switch (eDerivedStructuralFeatureID(eFeature))
    {
      case XSDPackage.XSD_MAX_FACET__ELEMENT:
        return getElement();
      case XSDPackage.XSD_MAX_FACET__CONTAINER:
        return getContainer();
      case XSDPackage.XSD_MAX_FACET__ROOT_CONTAINER:
        return getRootContainer();
      case XSDPackage.XSD_MAX_FACET__SCHEMA:
        return getSchema();
      case XSDPackage.XSD_MAX_FACET__DIAGNOSTICS:
        return getDiagnostics();
      case XSDPackage.XSD_MAX_FACET__LEXICAL_VALUE:
        return getLexicalValue();
      case XSDPackage.XSD_MAX_FACET__FACET_NAME:
        return getFacetName();
      case XSDPackage.XSD_MAX_FACET__EFFECTIVE_VALUE:
        return getEffectiveValue();
      case XSDPackage.XSD_MAX_FACET__ANNOTATION:
        return getAnnotation();
      case XSDPackage.XSD_MAX_FACET__SIMPLE_TYPE_DEFINITION:
        return getSimpleTypeDefinition();
      case XSDPackage.XSD_MAX_FACET__FIXED:
