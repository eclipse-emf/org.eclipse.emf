 ...
 * </copyright>
 *
 * $Id: XSDMaxInclusiveFacetImpl.java,v 1.1 2004/03/06 18:00:10 marcelop Exp $
 */
  ...
  implements XSDMaxInclusiveFacet
{
  ...
  {
    return XSDPackage.eINSTANCE.getXSDMaxInclusiveFacet();
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs)
  {
    if (featureID >= 0)
    {
      ...
      {
        case XSDPackage.XSD_MAX_INCLUSIVE_FACET__DIAGNOSTICS:
          return ((InternalEList)getDiagnostics()).basicRemove(otherEnd, msgs);
        case XSDPackage.XSD_MAX_INCLUSIVE_FACET__ANNOTATION:
  ...
  public Object eGet(EStructuralFeature eFeature, boolean resolve)
  {
    ...
    {
      case XSDPackage.XSD_MAX_INCLUSIVE_FACET__ELEMENT:
        return getElement();
      case XSDPackage.XSD_MAX_INCLUSIVE_FACET__CONTAINER:
        return getContainer();
      case XSDPackage.XSD_MAX_INCLUSIVE_FACET__ROOT_CONTAINER:
        return getRootContainer();
      case XSDPackage.XSD_MAX_INCLUSIVE_FACET__SCHEMA:
        return getSchema();
      case XSDPackage.XSD_MAX_INCLUSIVE_FACET__DIAGNOSTICS:
        return getDiagnostics();
      case XSDPackage.XSD_MAX_INCLUSIVE_FACET__LEXICAL_VALUE:
        return getLexicalValue();
      case XSDPackage.XSD_MAX_INCLUSIVE_FACET__FACET_NAME:
        return getFacetName();
      case XSDPackage.XSD_MAX_INCLUSIVE_FACET__EFFECTIVE_VALUE:
        return getEffectiveValue();
      case XSDPackage.XSD_MAX_INCLUSIVE_FACET__ANNOTATION:
        return getAnnotation();
      case XSDPackage.XSD_MAX_INCLUSIVE_FACET__SIMPLE_TYPE_DEFINITION:
        return getSimpleTypeDefinition();
      case XSDPackage.XSD_MAX_INCLUSIVE_FACET__FIXED:
        return isFixed() ? Boolean.TRUE : Boolean.FALSE;
      case XSDPackage.XSD_MAX_INCLUSIVE_FACET__VALUE:
        return getValue();
      case XSDPackage.XSD_MAX_INCLUSIVE_FACET__INCLUSIVE:
        return isInclusive() ? Boolean.TRUE : Boolean.FALSE;
      case XSDPackage.XSD_MAX_INCLUSIVE_FACET__EXCLUSIVE:
