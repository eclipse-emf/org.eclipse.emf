...
public class Editor
{
  ...
  protected final String TEXT_66 = NL + "\t\t\t\ttry" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\tshowTabs();" + NL + "\t\t\t\t\taddPage(getPageCount(), problemEditorPart, getEditorInput());" + NL + "\t\t\t\t\tlastEditorPage++;" + NL + "\t\t\t\t\tsetPageText(lastEditorPage, problemEditorPart.getPartName());" + NL + "\t\t\t\t\tsetActivePage(lastEditorPage);" + NL + "\t\t\t\t}" + NL + "\t\t\t\tcatch (PartInitException exception)" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\t";
