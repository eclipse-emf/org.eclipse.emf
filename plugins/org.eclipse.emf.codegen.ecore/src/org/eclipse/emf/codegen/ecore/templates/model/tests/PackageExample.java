...
public class PackageExample
{
  ...
  protected final String TEXT_26 = NL + "\t\t// Register the appropriate resource factory to handle all file extensions." + NL + "\t\t//" + NL + "\t\tresourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put" + NL + "\t\t\t(Resource.Factory.Registry.DEFAULT_EXTENSION, " + NL + "\t\t\t new ";
  protected final String TEXT_27 = "());";
  protected final String TEXT_28 = NL + NL + "\t\t// Register the package to ensure it is available during loading." + NL + "\t\t//" + NL + "\t\tresourceSet.getPackageRegistry().put" + NL + "\t\t\t(";
  protected final String TEXT_29 = ".eNS_URI, " + NL + "\t\t\t ";
  protected final String TEXT_30 = ".eINSTANCE);" + NL + "        " + NL + "\t\t// If there are no arguments, emit an appropriate usage message." + NL + "\t\t//" + NL + "\t\tif (args.length == 0)" + NL + "\t\t{";
  protected final String TEXT_31 = NL + "\t\t\tSystem.out.println(\"Enter a list of file paths or URIs that have content like this:\");";
  protected final String TEXT_32 = NL + "\t\t\ttry" + NL + "\t\t\t{";
  protected final String TEXT_33 = NL + "\t\t\t\t";
  protected final String TEXT_34 = " resource = resourceSet.createResource(";
  protected final String TEXT_35 = ".createURI(\"http:///My.";
  protected final String TEXT_36 = "\"), ";
  protected final String TEXT_37 = ".eCONTENT_TYPE);";
  protected final String TEXT_38 = NL + "\t\t\t\t";
  protected final String TEXT_39 = " resource = resourceSet.createResource(";
  protected final String TEXT_40 = ".createURI(\"http:///My.";
  protected final String TEXT_41 = "\"));";
  protected final String TEXT_42 = NL + "\t\t\t\t";
  protected final String TEXT_43 = " documentRoot = ";
  ...
  protected final String TEXT_49 = NL + "\t\t\t\tdocumentRoot.eSet(";
  protected final String TEXT_50 = ", root);";
  protected final String TEXT_51 = NL + "\t\t\t\tdocumentRoot.set";
  protected final String TEXT_52 = "(root);";
  protected final String TEXT_53 = NL + "\t\t\t\tresource.getContents().add(";
  protected final String TEXT_54 = "(";
  protected final String TEXT_55 = ")";
  protected final String TEXT_56 = "documentRoot);";
  protected final String TEXT_57 = NL + "\t\t\t\t";
  protected final String TEXT_58 = " root = ";
  protected final String TEXT_59 = ".create";
  protected final String TEXT_60 = "();" + NL + "\t\t\t\tresource.getContents().add(";
  protected final String TEXT_61 = "(";
  protected final String TEXT_62 = ")";
  protected final String TEXT_63 = "root);";
  protected final String TEXT_64 = NL + "\t\t\t\tresource.save(";
  protected final String TEXT_65 = ".out, null);" + NL + "\t\t\t}" + NL + "\t\t\tcatch (";
  protected final String TEXT_66 = " exception) " + NL + "\t\t\t{" + NL + "\t\t\t\texception.printStackTrace();" + NL + "\t\t\t}";
  protected final String TEXT_67 = NL + "\t\t\tSystem.out.println(\"Enter a list of file paths or URIs\");";
  protected final String TEXT_68 = NL + "\t\t}" + NL + "\t\telse" + NL + "\t\t{" + NL + "\t\t\t// Iterate over all the arguments." + NL + "\t\t\t//" + NL + "\t\t\tfor (int i = 0; i < args.length; ++i)" + NL + "\t\t\t{" + NL + "\t\t\t\t// Construct the URI for the instance file." + NL + "\t\t\t\t// The argument is treated as a file path only if it denotes an existing file." + NL + "\t\t\t\t// Otherwise, it's directly treated as a URL." + NL + "\t\t\t\t//" + NL + "\t\t\t\t";
  protected final String TEXT_69 = " file = new ";
  protected final String TEXT_70 = "(args[i]);" + NL + "\t\t\t\t";
  protected final String TEXT_71 = " uri = file.isFile() ? ";
  protected final String TEXT_72 = ".createFileURI(file.getAbsolutePath()): URI.createURI(args[0]);" + NL + "" + NL + "\t\t\t\ttry" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\t// Demand load resource for this file." + NL + "\t\t\t\t\t//" + NL + "\t\t\t\t\t";
  protected final String TEXT_73 = " resource = resourceSet.getResource(uri, true);" + NL + "\t\t\t\t\tSystem.out.println(\"Loaded \" + uri);";
  protected final String TEXT_74 = NL + NL + "\t\t\t\t\t// Validate the contents of the loaded resource." + NL + "\t\t\t\t\t//";
  protected final String TEXT_75 = NL + "\t\t\t\t\tfor (";
  protected final String TEXT_76 = " eObject : resource.getContents())";
  protected final String TEXT_77 = NL + "\t\t\t\t\tfor (";
  protected final String TEXT_78 = " j = resource.getContents().iterator(); j.hasNext(); )";
  protected final String TEXT_79 = NL + "\t\t\t\t\t{";
  protected final String TEXT_80 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_81 = " eObject = (";
  protected final String TEXT_82 = ")j.next();";
  protected final String TEXT_83 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_84 = " diagnostic = ";
  protected final String TEXT_85 = ".INSTANCE.validate(eObject);" + NL + "\t\t\t\t\t\tif (diagnostic.getSeverity() != Diagnostic.OK)" + NL + "\t\t\t\t\t\t{" + NL + "\t\t\t\t\t\t\tprintDiagnostic(diagnostic, \"\");";
  protected final String TEXT_86 = NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\tcatch (";
  protected final String TEXT_87 = " exception) " + NL + "\t\t\t\t{" + NL + "\t\t\t\t\tSystem.out.println(\"Problem loading \" + uri);";
  protected final String TEXT_88 = NL + "\t\t\t\t\texception.printStackTrace();" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t}" + NL + "\t" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * Prints diagnostics with indentation." + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @param diagnostic the diagnostic to print." + NL + "\t * @param indent the indentation for printing." + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected static void printDiagnostic(Diagnostic diagnostic, String indent)" + NL + "\t{" + NL + "\t\tSystem.out.print(indent);" + NL + "\t\tSystem.out.println(diagnostic.getMessage());";
  protected final String TEXT_89 = NL + "\t\tfor (Diagnostic child : diagnostic.getChildren())" + NL + "\t\t{" + NL + "\t\t\tprintDiagnostic(child, indent + \"  \");";
  protected final String TEXT_90 = NL + "\t\t}";
  protected final String TEXT_91 = NL + "\t\tfor (Iterator i = diagnostic.getChildren().iterator(); i.hasNext(); )" + NL + "\t\t{" + NL + "\t\t\tprintDiagnostic((Diagnostic)i.next(), indent + \"  \");";
