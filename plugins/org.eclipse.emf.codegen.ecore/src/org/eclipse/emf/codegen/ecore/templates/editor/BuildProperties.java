...
public class BuildProperties
{
  ...
  protected final String TEXT_7 = ",\\" + NL + "\t\t\t\tplugin.properties,\\" + NL + "\t\t\t\ticons/" + NL + "jars.compile.order = ";
  protected final String TEXT_8 = NL + "source.";
  protected final String TEXT_9 = " = src/" + NL + "output.";
  protected final String TEXT_10 = " = bin/";
  protected final String TEXT_11 = NL + "bin.includes =\tplugin.xml,\\" + NL + "\t\t\t\tplugin.properties,\\" + NL + "\t\t\t\ticons/";
 ...
 */
    ...
    String jarFile = "runtime/"+genModel.getEditorPluginID()+".jar";
