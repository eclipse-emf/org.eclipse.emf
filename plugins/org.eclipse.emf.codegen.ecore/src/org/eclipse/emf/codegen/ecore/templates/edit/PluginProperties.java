...
public class PluginProperties
{
  ...
  protected final String TEXT_7 = NL + "_UI_CreateChild_text = {0}" + NL + "_UI_CreateChild_text2 = {1} {0}" + NL + "_UI_CreateChild_tooltip = Create New {0} Under {1} Feature" + NL + "_UI_CreateChild_description = Create a new child of type {0} for the {1} feature of the selected {2}." + NL + "_UI_CreateSibling_description = Create a new sibling of type {0} for the selected {2}, under the {1} feature of their parent." + NL;
  ...
  protected final String TEXT_11 = NL + "_UI_Unknown_type = Object" + NL;
  protected final String TEXT_12 = NL + "_UI_";
  protected final String TEXT_13 = "_";
  protected final String TEXT_14 = "_feature = ";
  protected final String TEXT_15 = NL + "_UI_Unknown_feature = Unspecified";
