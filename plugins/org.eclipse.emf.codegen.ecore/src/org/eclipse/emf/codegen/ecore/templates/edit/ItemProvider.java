...
public class ItemProvider
{
  ...
  protected final String TEXT_87 = NL + "\tprotected boolean shouldComposeCreationImage() " + NL + "\t{" + NL + "\t\treturn true;" + NL + "\t}" + NL;
  protected final String TEXT_88 = NL + "\t/**" + NL + "\t * This returns the label text for the adapted class." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_89 = NL + "\t@Override";
  protected final String TEXT_90 = NL + "\tpublic String getText(Object object)" + NL + "\t{";
  protected final String TEXT_91 = NL + "\t\treturn ((";
  protected final String TEXT_92 = ")getStyledText(object)).getString();";
  protected final String TEXT_93 = NL + "\t\t";
  protected final String TEXT_94 = "<?, ?>";
  protected final String TEXT_95 = " ";
  protected final String TEXT_96 = " = (";
  protected final String TEXT_97 = "<?, ?>";
  protected final String TEXT_98 = ")object;";
  protected final String TEXT_99 = NL + "\t\treturn \"\" + ";
  protected final String TEXT_100 = ".getKey() + \" -> \" + ";
  protected final String TEXT_101 = ".getValue();";
  protected final String TEXT_102 = NL + "\t\tString key = crop(\"\" + ";
  protected final String TEXT_103 = ".getKey());";
  protected final String TEXT_104 = NL + "\t\tString key = \"\" + ";
  protected final String TEXT_105 = ".getKey();";
  protected final String TEXT_106 = NL + "\t\tString value = crop(\"\" + ";
  protected final String TEXT_107 = ".getValue());";
  protected final String TEXT_108 = NL + "\t\tString value = \"\" + ";
  protected final String TEXT_109 = ".getValue();";
  protected final String TEXT_110 = NL + "\t\treturn key + \" -> \" + value;";
  protected final String TEXT_111 = NL + "\t\t";
  protected final String TEXT_112 = " ";
  protected final String TEXT_113 = " = (";
  protected final String TEXT_114 = ")object;" + NL + "\t\treturn getString(\"_UI_";
  protected final String TEXT_115 = "_type\") + \" \" + ";
  protected final String TEXT_116 = ".";
  protected final String TEXT_117 = "();";
  protected final String TEXT_118 = NL + "\t\tString label = crop(((";
  protected final String TEXT_119 = ")object).";
  protected final String TEXT_120 = "());";
  protected final String TEXT_121 = NL + "\t\tString label = ((";
  protected final String TEXT_122 = ")object).";
  protected final String TEXT_123 = "();";
  protected final String TEXT_124 = NL + "\t\t";
  protected final String TEXT_125 = " labelValue = ((";
  protected final String TEXT_126 = ")object).eGet(";
  protected final String TEXT_127 = ");";
  protected final String TEXT_128 = NL + "\t\t";
  protected final String TEXT_129 = " labelValue = ((";
  protected final String TEXT_130 = ")object).";
  protected final String TEXT_131 = "();";
  protected final String TEXT_132 = NL + "\t\tString label = labelValue == null ? null : labelValue.toString();";
  protected final String TEXT_133 = NL + "\t\treturn label == null || label.length() == 0 ?" + NL + "\t\t\tgetString(\"_UI_";
  protected final String TEXT_134 = "_type\") :";
  protected final String TEXT_135 = NL + "\t\t\tgetString(\"_UI_";
  protected final String TEXT_136 = "_type\") + \" \" + label;";
  protected final String TEXT_137 = NL + "\t\treturn getString(\"_UI_";
  protected final String TEXT_138 = "_type\");";
  protected final String TEXT_139 = NL + "\t}" + NL + "\t";
  protected final String TEXT_140 = NL + "\t/**" + NL + "\t * This returns the label styled text for the adapted class." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_141 = NL + "\t@Override";
  protected final String TEXT_142 = NL + "\tpublic Object getStyledText(Object object)" + NL + "\t{";
  ...
  protected final String TEXT_151 = ".getKey()).append(\" -> \", ";
  protected final String TEXT_152 = ".QUALIFIER_STYLER).append(\"\" + ";
  protected final String TEXT_153 = ".getValue());";
  protected final String TEXT_154 = NL + "\t\tString key = crop(\"\" + ";
  protected final String TEXT_155 = ".getKey());";
  protected final String TEXT_156 = NL + "\t\tString key = \"\" + ";
  protected final String TEXT_157 = ".getKey();";
  protected final String TEXT_158 = NL + "\t\tString value = crop(\"\" + ";
  protected final String TEXT_159 = ".getValue());";
  protected final String TEXT_160 = NL + "\t\tString value = \"\" + ";
  protected final String TEXT_161 = ".getValue();";
  protected final String TEXT_162 = NL + "\t\treturn new ";
  protected final String TEXT_163 = "(key).append(\" -> \", ";
  protected final String TEXT_164 = ".QUALIFIER_STYLER).append(value);";
  protected final String TEXT_165 = NL + "\t\t";
  protected final String TEXT_166 = " ";
  protected final String TEXT_167 = " = (";
  protected final String TEXT_168 = ")object;" + NL + "\t\treturn new ";
  protected final String TEXT_169 = "(getString(\"_UI_";
  protected final String TEXT_170 = "_type\"), ";
  protected final String TEXT_171 = ".QUALIFIER_STYLER).append(\" \").append(";
  protected final String TEXT_172 = ".toString(";
  protected final String TEXT_173 = ".";
  protected final String TEXT_174 = "()));";
  protected final String TEXT_175 = NL + "\t\tString label = crop(((";
  protected final String TEXT_176 = ")object).";
  protected final String TEXT_177 = "());";
  protected final String TEXT_178 = NL + "\t\tString label = ((";
  protected final String TEXT_179 = ")object).";
  protected final String TEXT_180 = "();";
  protected final String TEXT_181 = NL + "\t\t";
  protected final String TEXT_182 = " labelValue = ((";
  protected final String TEXT_183 = ")object).eGet(";
  protected final String TEXT_184 = ");";
  protected final String TEXT_185 = NL + "\t\t";
  protected final String TEXT_186 = " labelValue = ((";
  protected final String TEXT_187 = ")object).";
  protected final String TEXT_188 = "();";
  protected final String TEXT_189 = NL + "\t\tString label = labelValue == null ? null : labelValue.toString();";
  protected final String TEXT_190 = NL + "    \t";
  protected final String TEXT_191 = " styledLabel = new ";
  protected final String TEXT_192 = "();" + NL + "\t\tif (label == null || label.length() == 0) " + NL + "\t\t{" + NL + "\t\t\tstyledLabel.append(getString(\"_UI_";
  protected final String TEXT_193 = "_type\"), ";
  protected final String TEXT_194 = ".QUALIFIER_STYLER); ";
  protected final String TEXT_195 = NL + "\t\t} else {" + NL + "\t\t\tstyledLabel.append(getString(\"_UI_";
  protected final String TEXT_196 = "_type\"), ";
  protected final String TEXT_197 = ".QUALIFIER_STYLER).append(\" \" + label);";
  protected final String TEXT_198 = NL + "\t\t}" + NL + "\t\treturn styledLabel;";
  protected final String TEXT_199 = NL + "\t\treturn new ";
  protected final String TEXT_200 = "(getString(\"_UI_";
  protected final String TEXT_201 = "_type\"));";
  protected final String TEXT_202 = NL + "\t}\t";
  protected final String TEXT_203 = NL + NL + "\t/**" + NL + "\t * This handles model notifications by calling {@link #updateChildren} to update any cached" + NL + "\t * children and by creating a viewer notification, which it passes to {@link #fireNotifyChanged}." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_204 = NL + "\t@Override";
  protected final String TEXT_205 = NL + "\tpublic void notifyChanged(Notification notification)" + NL + "\t{" + NL + "\t\tupdateChildren(notification);";
  protected final String TEXT_206 = NL + NL + "\t\tswitch (notification.getFeatureID(";
  protected final String TEXT_207 = ".class))" + NL + "\t\t{";
  protected final String TEXT_208 = NL + "\t\t\tcase ";
  protected final String TEXT_209 = ":";
  protected final String TEXT_210 = NL + "\t\t\t\tfireNotifyChanged(new ";
  protected final String TEXT_211 = "(notification, notification.getNotifier(), false, true));" + NL + "\t\t\t\treturn;";
  protected final String TEXT_212 = NL + "\t\t\tcase ";
  protected final String TEXT_213 = ":";
  protected final String TEXT_214 = NL + "\t\t\t\tfireNotifyChanged(new ";
  protected final String TEXT_215 = "(notification, notification.getNotifier(), true, false));" + NL + "\t\t\t\treturn;";
  protected final String TEXT_216 = NL + "\t\t\tcase ";
  protected final String TEXT_217 = ":";
  protected final String TEXT_218 = NL + "\t\t\t\tfireNotifyChanged(new ";
  protected final String TEXT_219 = "(notification, notification.getNotifier(), true, true));" + NL + "\t\t\t\treturn;";
  protected final String TEXT_220 = NL + "\t\t}";
  protected final String TEXT_221 = NL + "\t\tsuper.notifyChanged(notification);" + NL + "\t}" + NL;
  protected final String TEXT_222 = NL + "\t/**" + NL + "\t * This adds {@link org.eclipse.emf.edit.command.CommandParameter}s describing the children" + NL + "\t * that can be created under this object." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_223 = NL + "\t@Override";
  protected final String TEXT_224 = NL + "\tprotected void collectNewChildDescriptors(";
  protected final String TEXT_225 = " newChildDescriptors, Object object)" + NL + "\t{" + NL + "\t\tsuper.collectNewChildDescriptors(newChildDescriptors, object);";
  protected final String TEXT_226 = NL + NL + "\t\tnewChildDescriptors.add" + NL + "\t\t\t(createChildParameter" + NL + "\t\t\t\t(";
  protected final String TEXT_227 = "," + NL + "\t\t\t\t ";
  protected final String TEXT_228 = ".createEntry" + NL + "\t\t\t\t\t(";
  ...
  protected final String TEXT_248 = " // TODO: ensure this is a valid literal value";
  protected final String TEXT_249 = NL + NL + "\t\tnewChildDescriptors.add" + NL + "\t\t\t(createChildParameter" + NL + "\t\t\t\t(";
  ...
  protected final String TEXT_257 = NL + NL + "\t\tnewChildDescriptors.add" + NL + "\t\t\t(createChildParameter" + NL + "\t\t\t\t(";
  ...
  protected final String TEXT_264 = ".createFromString(";
  protected final String TEXT_265 = ", ";
  protected final String TEXT_266 = ")));";
  protected final String TEXT_267 = " // TODO: ensure this is a valid literal value";
  protected final String TEXT_268 = NL + "\t}" + NL;
  protected final String TEXT_269 = NL + "\t/**" + NL + "\t * This returns the label text for {@link org.eclipse.emf.edit.command.CreateChildCommand}." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_270 = NL + "\t@Override";
  protected final String TEXT_271 = NL + "\tpublic String getCreateChildText(Object owner, Object feature, Object child, ";
  protected final String TEXT_272 = " selection)" + NL + "\t{" + NL + "\t\tObject childFeature = feature;" + NL + "\t\tObject childObject = child;" + NL;
  protected final String TEXT_273 = NL + "\t\tif (childFeature instanceof ";
  protected final String TEXT_274 = " && ";
  protected final String TEXT_275 = ".isFeatureMap((EStructuralFeature)childFeature))" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_276 = ".Entry entry = (FeatureMap.Entry)childObject;" + NL + "\t\t\tchildFeature = entry.getEStructuralFeature();" + NL + "\t\t\tchildObject = entry.getValue();" + NL + "\t\t}" + NL;
  protected final String TEXT_277 = NL + "\t\tboolean qualify =";
  protected final String TEXT_278 = NL + "\t\t\tchildFeature == ";
  protected final String TEXT_279 = NL + NL + "\t\tif (qualify)" + NL + "\t\t{" + NL + "\t\t\treturn getString" + NL + "\t\t\t\t(\"_UI_CreateChild_text2\",";
  protected final String TEXT_280 = NL + "\t\t\t\t new Object[] { getTypeText(childObject), getFeatureText(childFeature), getTypeText(owner) });" + NL + "\t\t}" + NL + "\t\treturn super.getCreateChildText(owner, feature, child, selection);" + NL + "\t}" + NL;
  protected final String TEXT_281 = NL + "\t/**" + NL + "\t * Return the resource locator for this item provider's resources." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_282 = NL + "\t@Override";
  protected final String TEXT_283 = NL + "\tpublic ";
  protected final String TEXT_284 = " getResourceLocator()" + NL + "\t{";
  protected final String TEXT_285 = NL + "\t\treturn ((";
  protected final String TEXT_286 = ")adapterFactory).getResourceLocator();";
  protected final String TEXT_287 = NL + "\t\treturn ";
  protected final String TEXT_288 = ".INSTANCE;";
