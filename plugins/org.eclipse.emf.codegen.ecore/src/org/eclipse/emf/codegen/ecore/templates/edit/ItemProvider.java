...
public class ItemProvider
{
  ...
  protected final String TEXT_29 = NL + "\t\t\t\t getString(\"_UI_";
  protected final String TEXT_30 = "_";
  protected final String TEXT_31 = "_description\"),";
  protected final String TEXT_32 = NL + "\t\t\t\t ";
  protected final String TEXT_33 = ".eINSTANCE.get";
  protected final String TEXT_34 = "()," + NL + "\t\t\t\t ";
  protected final String TEXT_35 = ",";
  protected final String TEXT_36 = NL + "\t\t\t\t null,";
  protected final String TEXT_37 = NL + "\t\t\t\t ";
  protected final String TEXT_38 = ".";
  protected final String TEXT_39 = ",";
  protected final String TEXT_40 = NL + "\t\t\t\t null,";
  protected final String TEXT_41 = NL + "\t\t\t\t getString(\"_UI_";
  protected final String TEXT_42 = "PropertyCategory\"),";
  protected final String TEXT_43 = NL + "\t\t\t\t null));";
  protected final String TEXT_44 = NL + "\t\t\t\t new String[] {";
  protected final String TEXT_45 = NL + "\t\t\t\t\t\"";
  protected final String TEXT_46 = "\"";
  protected final String TEXT_47 = ",";
  protected final String TEXT_48 = NL + "\t\t\t\t }));";
  protected final String TEXT_49 = NL + "\t}" + NL;
  protected final String TEXT_50 = NL + "\t/**" + NL + "\t * This specifies how to implement {@link #getChildren} and is used to deduce an appropriate feature for an" + NL + "\t * {@link org.eclipse.emf.edit.command.AddCommand}, {@link org.eclipse.emf.edit.command.RemoveCommand} or" + NL + "\t * {@link org.eclipse.emf.edit.command.MoveCommand} in {@link #createCommand}." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_51 = " getChildrenFeatures(Object object)" + NL + "\t{" + NL + "\t\tif (childrenFeatures == null)" + NL + "\t\t{" + NL + "\t\t\tsuper.getChildrenFeatures(object);";
  protected final String TEXT_52 = NL + "\t\t\tchildrenFeatures.add(";
  protected final String TEXT_53 = ".eINSTANCE.get";
  protected final String TEXT_54 = "());";
  protected final String TEXT_55 = NL + "\t\t}" + NL + "\t\treturn childrenFeatures;" + NL + "\t}" + NL;
  protected final String TEXT_56 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
  protected final String TEXT_57 = " getChildFeature(Object object, Object child)" + NL + "\t{" + NL + "\t\t// Check the type of the specified child object and return the proper feature to use for" + NL + "\t\t// adding (see {@link AddCommand}) it as a child." + NL + "" + NL + "\t\treturn super.getChildFeature(object, child);" + NL + "\t}" + NL;
  protected final String TEXT_58 = NL + "\t/**" + NL + "\t * This returns ";
  protected final String TEXT_59 = ".gif." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic Object getImage(Object object)" + NL + "\t{" + NL + "\t\treturn getResourceLocator().getImage(\"full/obj16/";
  protected final String TEXT_60 = "\");";
  protected final String TEXT_61 = NL + "\t}" + NL;
  protected final String TEXT_62 = NL + "\t/**" + NL + "\t * This returns the label text for the adapted class." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic String getText(Object object)" + NL + "\t{";
  protected final String TEXT_63 = NL + "\t\t";
  protected final String TEXT_64 = " ";
  protected final String TEXT_65 = " = (";
  protected final String TEXT_66 = ")object;" + NL + "\t\treturn \"\" + ";
  protected final String TEXT_67 = ".getKey() + \" -> \" + ";
  protected final String TEXT_68 = ".getValue();";
  protected final String TEXT_69 = NL + "\t\t";
  protected final String TEXT_70 = " ";
  protected final String TEXT_71 = " = (";
  protected final String TEXT_72 = ")object;" + NL + "\t\treturn getString(\"_UI_";
  protected final String TEXT_73 = "_type\") + \" \" + ";
  protected final String TEXT_74 = ".";
  protected final String TEXT_75 = "();";
  protected final String TEXT_76 = NL + "\t\tString label = ((";
  protected final String TEXT_77 = ")object).";
  protected final String TEXT_78 = "();";
  protected final String TEXT_79 = NL + "\t\t";
  protected final String TEXT_80 = " labelValue = ((";
  protected final String TEXT_81 = ")object).";
  protected final String TEXT_82 = "();" + NL + "\t\tString label = labelValue == null ? null : labelValue.toString();";
  protected final String TEXT_83 = NL + "\t\treturn label == null || label.length() == 0 ?" + NL + "\t\t\tgetString(\"_UI_";
  protected final String TEXT_84 = "_type\") :";
  protected final String TEXT_85 = NL + "\t\t\tgetString(\"_UI_";
  protected final String TEXT_86 = "_type\") + \" \" + label;";
  protected final String TEXT_87 = NL + "\t\treturn getString(\"_UI_";
  protected final String TEXT_88 = "_type\");";
  protected final String TEXT_89 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * This handles model notifications by calling {@link #updateChildren} to update any cached" + NL + "\t * children and by creating a viewer notification, which it passes to {@link #fireNotifyChanged}." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void notifyChanged(Notification notification)" + NL + "\t{" + NL + "\t\tupdateChildren(notification);";
  ...
  protected final String TEXT_99 = "(notification, notification.getNotifier(), true, false));" + NL + "\t\t\t\treturn;";
  protected final String TEXT_100 = NL + "\t\t\tcase ";
  protected final String TEXT_101 = ":";
  protected final String TEXT_102 = NL + "\t\t\t\tfireNotifyChanged(new ";
  protected final String TEXT_103 = "(notification, notification.getNotifier(), true, true));" + NL + "\t\t\t\treturn;";
  protected final String TEXT_104 = NL + "\t\t}";
  protected final String TEXT_105 = NL + "\t\tsuper.notifyChanged(notification);" + NL + "\t}" + NL;
  protected final String TEXT_106 = NL + "\t/**" + NL + "\t * This adds to the collection of {@link org.eclipse.emf.edit.command.CommandParameter}s" + NL + "\t * describing all of the children that can be created under this object." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected void collectNewChildDescriptors(";
  protected final String TEXT_107 = " newChildDescriptors, Object object)" + NL + "\t{" + NL + "\t\tsuper.collectNewChildDescriptors(newChildDescriptors, object);";
  ...
  protected final String TEXT_118 = NL + NL + "\t\tnewChildDescriptors.add" + NL + "\t\t\t(createChildParameter" + NL + "\t\t\t\t(";
  protected final String TEXT_119 = ".eINSTANCE.get";
  protected final String TEXT_120 = "()," + NL + "\t\t\t\t ";
  protected final String TEXT_121 = ".createEntry" + NL + "\t\t\t\t\t(";
  ...
  protected final String TEXT_131 = NL + NL + "\t\tnewChildDescriptors.add" + NL + "\t\t\t(createChildParameter" + NL + "\t\t\t\t(";
  ...
  protected final String TEXT_146 = " // TODO: ensure this is a valid literal value";
  ...
  protected final String TEXT_151 = ".eINSTANCE.create(";
  ...
  protected final String TEXT_165 = ".eINSTANCE.createFromString(";
  protected final String TEXT_166 = ".eINSTANCE.get";
  protected final String TEXT_167 = "(), ";
  protected final String TEXT_168 = ")));";
  protected final String TEXT_169 = " // TODO: ensure this is a valid literal value";
  protected final String TEXT_170 = NL + "\t}" + NL;
  protected final String TEXT_171 = NL + "\t/**" + NL + "\t * This returns the label text for {@link org.eclipse.emf.edit.command.CreateChildCommand}." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic String getCreateChildText(Object owner, Object feature, Object child, ";
  protected final String TEXT_172 = " selection)" + NL + "\t{" + NL + "\t\tObject childFeature = feature;" + NL + "\t\tObject childObject = child;" + NL;
  protected final String TEXT_173 = NL + "\t\tif (childFeature instanceof ";
  protected final String TEXT_174 = " && ";
  protected final String TEXT_175 = ".isFeatureMap((EStructuralFeature)childFeature))" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_176 = ".Entry entry = (FeatureMap.Entry)childObject;" + NL + "\t\t\tchildFeature = entry.getEStructuralFeature();" + NL + "\t\t\tchildObject = entry.getValue();" + NL + "\t\t}" + NL;
  protected final String TEXT_177 = NL + "\t\tboolean qualify =";
  protected final String TEXT_178 = NL + "\t\t\tchildFeature == ";
  protected final String TEXT_179 = ".eINSTANCE.get";
  protected final String TEXT_180 = "()";
  protected final String TEXT_181 = NL + NL + "\t\tif (qualify)" + NL + "\t\t{" + NL + "\t\t\treturn getString" + NL + "\t\t\t\t(\"_UI_CreateChild_text2\",";
  protected final String TEXT_182 = NL + "\t\t\t\t new Object[] { getTypeText(childObject), getFeatureText(childFeature), getTypeText(owner) });" + NL + "\t\t}" + NL + "\t\treturn super.getCreateChildText(owner, feature, child, selection);" + NL + "\t}" + NL;
  protected final String TEXT_183 = NL + "\t/**" + NL + "\t * This returns the icon image for {@link org.eclipse.emf.edit.command.CreateChildCommand}." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic Object getCreateChildImage(Object owner, Object feature, Object child, Collection selection)" + NL + "\t{" + NL + "\t\tif (feature instanceof ";
  protected final String TEXT_184 = " && ";
  protected final String TEXT_185 = ".isFeatureMap((";
  protected final String TEXT_186 = ")feature))" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_187 = ".Entry entry = (";
  protected final String TEXT_188 = ".Entry)child;" + NL + "\t\t\tfeature = entry.getEStructuralFeature();" + NL + "\t\t\tchild = entry.getValue();        " + NL + "\t\t}" + NL + "" + NL + "\t\tif (feature instanceof ";
  protected final String TEXT_189 = " && child instanceof ";
  protected final String TEXT_190 = ")" + NL + "\t\t{" + NL + "\t\t\tString name = \"full/obj16/\" + ((EObject)child).eClass().getName();";
  protected final String TEXT_191 = NL + NL + "\t\t\ttry" + NL + "\t\t\t{" + NL + "\t\t\t\treturn getResourceLocator().getImage(name);" + NL + "\t\t\t}" + NL + "\t\t\tcatch (Exception e)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  protected final String TEXT_192 = ".INSTANCE.log(e);" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "" + NL + "\t\treturn super.getCreateChildImage(owner, feature, child, selection);" + NL + "\t}" + NL;
  protected final String TEXT_193 = NL + "\t/**" + NL + "\t * Return the resource locator for this item provider's resources." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ResourceLocator getResourceLocator()" + NL + "\t{" + NL + "\t\treturn ";
