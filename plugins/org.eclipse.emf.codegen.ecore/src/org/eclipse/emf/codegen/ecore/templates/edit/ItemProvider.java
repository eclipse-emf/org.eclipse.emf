...
public class ItemProvider
{
  ...
  protected final String TEXT_69 = ")object;";
  protected final String TEXT_70 = NL + "\t\treturn \"\" + ";
  protected final String TEXT_71 = ".getKey() + \" -> \" + ";
  protected final String TEXT_72 = ".getValue();";
  protected final String TEXT_73 = NL + "\t\tString key = crop(\"\" + ";
  protected final String TEXT_74 = ".getKey());";
  protected final String TEXT_75 = NL + "\t\tString key = \"\" + ";
  protected final String TEXT_76 = ".getKey();";
  protected final String TEXT_77 = NL + "\t\tString value = crop(\"\" + ";
  protected final String TEXT_78 = ".getValue());";
  protected final String TEXT_79 = NL + "\t\tString value = \"\" + ";
  protected final String TEXT_80 = ".getValue();";
  protected final String TEXT_81 = NL + "\t\treturn key + \" -> \" + value;";
  protected final String TEXT_82 = NL + "\t\t";
  protected final String TEXT_83 = " ";
  protected final String TEXT_84 = " = (";
  protected final String TEXT_85 = ")object;" + NL + "\t\treturn getString(\"_UI_";
  protected final String TEXT_86 = "_type\") + \" \" + ";
  protected final String TEXT_87 = ".";
  protected final String TEXT_88 = "();";
  protected final String TEXT_89 = NL + "\t\tString label = crop(((";
  ...
  protected final String TEXT_103 = NL + "\t\tString label = labelValue == null ? null : labelValue.toString();";
  protected final String TEXT_104 = NL + "\t\treturn label == null || label.length() == 0 ?" + NL + "\t\t\tgetString(\"_UI_";
  protected final String TEXT_105 = "_type\") :";
  protected final String TEXT_106 = NL + "\t\t\tgetString(\"_UI_";
  protected final String TEXT_107 = "_type\") + \" \" + label;";
  protected final String TEXT_108 = NL + "\t\treturn getString(\"_UI_";
  protected final String TEXT_109 = "_type\");";
  protected final String TEXT_110 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * This handles model notifications by calling {@link #updateChildren} to update any cached" + NL + "\t * children and by creating a viewer notification, which it passes to {@link #fireNotifyChanged}." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void notifyChanged(Notification notification)" + NL + "\t{" + NL + "\t\tupdateChildren(notification);";
  protected final String TEXT_111 = NL + NL + "\t\tswitch (notification.getFeatureID(";
  protected final String TEXT_112 = ".class))" + NL + "\t\t{";
  protected final String TEXT_113 = NL + "\t\t\tcase ";
  protected final String TEXT_114 = ":";
  protected final String TEXT_115 = NL + "\t\t\t\tfireNotifyChanged(new ";
  protected final String TEXT_116 = "(notification, notification.getNotifier(), false, true));" + NL + "\t\t\t\treturn;";
  protected final String TEXT_117 = NL + "\t\t\tcase ";
  protected final String TEXT_118 = ":";
  protected final String TEXT_119 = NL + "\t\t\t\tfireNotifyChanged(new ";
  protected final String TEXT_120 = "(notification, notification.getNotifier(), true, false));" + NL + "\t\t\t\treturn;";
  protected final String TEXT_121 = NL + "\t\t\tcase ";
  protected final String TEXT_122 = ":";
  protected final String TEXT_123 = NL + "\t\t\t\tfireNotifyChanged(new ";
  protected final String TEXT_124 = "(notification, notification.getNotifier(), true, true));" + NL + "\t\t\t\treturn;";
  protected final String TEXT_125 = NL + "\t\t}";
  protected final String TEXT_126 = NL + "\t\tsuper.notifyChanged(notification);" + NL + "\t}" + NL;
  protected final String TEXT_127 = NL + "\t/**" + NL + "\t * This adds to the collection of {@link org.eclipse.emf.edit.command.CommandParameter}s" + NL + "\t * describing all of the children that can be created under this object." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected void collectNewChildDescriptors(";
  protected final String TEXT_128 = " newChildDescriptors, Object object)" + NL + "\t{" + NL + "\t\tsuper.collectNewChildDescriptors(newChildDescriptors, object);";
  protected final String TEXT_129 = NL + NL + "\t\tnewChildDescriptors.add" + NL + "\t\t\t(createChildParameter" + NL + "\t\t\t\t(";
  ...
  protected final String TEXT_149 = ".createEntry" + NL + "\t\t\t\t\t(";
  ...
  protected final String TEXT_168 = NL + NL + "\t\tnewChildDescriptors.add" + NL + "\t\t\t(createChildParameter" + NL + "\t\t\t\t(";
  ...
  protected final String TEXT_188 = NL + NL + "\t\tif (qualify)" + NL + "\t\t{" + NL + "\t\t\treturn getString" + NL + "\t\t\t\t(\"_UI_CreateChild_text2\",";
  protected final String TEXT_189 = NL + "\t\t\t\t new Object[] { getTypeText(childObject), getFeatureText(childFeature), getTypeText(owner) });" + NL + "\t\t}" + NL + "\t\treturn super.getCreateChildText(owner, feature, child, selection);" + NL + "\t}" + NL;
  protected final String TEXT_190 = NL + "\t/**" + NL + "\t * This returns the icon image for {@link org.eclipse.emf.edit.command.CreateChildCommand}." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic Object getCreateChildImage(Object owner, Object feature, Object child, Collection selection)" + NL + "\t{" + NL + "\t\tif (feature instanceof ";
  protected final String TEXT_191 = " && ";
  protected final String TEXT_192 = ".isFeatureMap((";
  protected final String TEXT_193 = ")feature))" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_194 = ".Entry entry = (";
  protected final String TEXT_195 = ".Entry)child;" + NL + "\t\t\tfeature = entry.getEStructuralFeature();" + NL + "\t\t\tchild = entry.getValue();        " + NL + "\t\t}" + NL + "" + NL + "\t\tif (feature instanceof ";
  protected final String TEXT_196 = " && child instanceof ";
  protected final String TEXT_197 = ")" + NL + "\t\t{" + NL + "\t\t\tString name = \"full/obj16/\" + ((EObject)child).eClass().getName();";
  protected final String TEXT_198 = NL + NL + "\t\t\ttry" + NL + "\t\t\t{" + NL + "\t\t\t\treturn getResourceLocator().getImage(name);" + NL + "\t\t\t}" + NL + "\t\t\tcatch (Exception e)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  protected final String TEXT_199 = ".INSTANCE.log(e);" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "" + NL + "\t\treturn super.getCreateChildImage(owner, feature, child, selection);" + NL + "\t}" + NL;
  protected final String TEXT_200 = NL + "\t/**" + NL + "\t * Return the resource locator for this item provider's resources." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ResourceLocator getResourceLocator()" + NL + "\t{" + NL + "\t\treturn ";
  protected final String TEXT_201 = ".INSTANCE;" + NL + "\t}" + NL;
