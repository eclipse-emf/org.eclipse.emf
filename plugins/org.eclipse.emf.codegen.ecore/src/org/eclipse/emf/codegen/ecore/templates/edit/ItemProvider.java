...
public class ItemProvider
{
  ...
  protected final String TEXT_81 = NL + "\t/**" + NL + "\t * This returns the label text for the adapted class." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_82 = NL + "\t@Override";
  protected final String TEXT_83 = NL + "\tpublic String getText(Object object)" + NL + "\t{";
  ...
  protected final String TEXT_93 = NL + "\t\tString key = crop(\"\" + ";
  protected final String TEXT_94 = ".getKey());";
  protected final String TEXT_95 = NL + "\t\tString key = \"\" + ";
  protected final String TEXT_96 = ".getKey();";
  protected final String TEXT_97 = NL + "\t\tString value = crop(\"\" + ";
  protected final String TEXT_98 = ".getValue());";
  protected final String TEXT_99 = NL + "\t\tString value = \"\" + ";
  protected final String TEXT_100 = ".getValue();";
  protected final String TEXT_101 = NL + "\t\treturn key + \" -> \" + value;";
  protected final String TEXT_102 = NL + "\t\t";
  protected final String TEXT_103 = " ";
  protected final String TEXT_104 = " = (";
  protected final String TEXT_105 = ")object;" + NL + "\t\treturn getString(\"_UI_";
  protected final String TEXT_106 = "_type\") + \" \" + ";
  protected final String TEXT_107 = ".";
  protected final String TEXT_108 = "();";
  protected final String TEXT_109 = NL + "\t\tString label = crop(((";
  protected final String TEXT_110 = ")object).";
  protected final String TEXT_111 = "());";
  protected final String TEXT_112 = NL + "\t\tString label = ((";
  protected final String TEXT_113 = ")object).";
  protected final String TEXT_114 = "();";
  protected final String TEXT_115 = NL + "\t\t";
  protected final String TEXT_116 = " labelValue = ((";
  protected final String TEXT_117 = ")object).eGet(";
  protected final String TEXT_118 = ");";
  protected final String TEXT_119 = NL + "\t\t";
  protected final String TEXT_120 = " labelValue = ((";
  protected final String TEXT_121 = ")object).";
  protected final String TEXT_122 = "();";
  protected final String TEXT_123 = NL + "\t\tString label = labelValue == null ? null : labelValue.toString();";
  protected final String TEXT_124 = NL + "\t\treturn label == null || label.length() == 0 ?" + NL + "\t\t\tgetString(\"_UI_";
  protected final String TEXT_125 = "_type\") :";
  protected final String TEXT_126 = NL + "\t\t\tgetString(\"_UI_";
  protected final String TEXT_127 = "_type\") + \" \" + label;";
  protected final String TEXT_128 = NL + "\t\treturn getString(\"_UI_";
  protected final String TEXT_129 = "_type\");";
  protected final String TEXT_130 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * This handles model notifications by calling {@link #updateChildren} to update any cached" + NL + "\t * children and by creating a viewer notification, which it passes to {@link #fireNotifyChanged}." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_131 = NL + "\t@Override";
  protected final String TEXT_132 = NL + "\tpublic void notifyChanged(Notification notification)" + NL + "\t{" + NL + "\t\tupdateChildren(notification);";
  protected final String TEXT_133 = NL + NL + "\t\tswitch (notification.getFeatureID(";
  protected final String TEXT_134 = ".class))" + NL + "\t\t{";
  protected final String TEXT_135 = NL + "\t\t\tcase ";
  protected final String TEXT_136 = ":";
  protected final String TEXT_137 = NL + "\t\t\t\tfireNotifyChanged(new ";
  protected final String TEXT_138 = "(notification, notification.getNotifier(), false, true));" + NL + "\t\t\t\treturn;";
  ...
  protected final String TEXT_145 = NL + "\t\t\t\tfireNotifyChanged(new ";
  protected final String TEXT_146 = "(notification, notification.getNotifier(), true, true));" + NL + "\t\t\t\treturn;";
  protected final String TEXT_147 = NL + "\t\t}";
  protected final String TEXT_148 = NL + "\t\tsuper.notifyChanged(notification);" + NL + "\t}" + NL;
  protected final String TEXT_149 = NL + "\t/**" + NL + "\t * This adds {@link org.eclipse.emf.edit.command.CommandParameter}s describing the children" + NL + "\t * that can be created under this object." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  ...
  protected final String TEXT_163 = ".createEntry" + NL + "\t\t\t\t\t(";
  protected final String TEXT_164 = ",";
  protected final String TEXT_165 = NL + "\t\t\t\t\t ";
  protected final String TEXT_166 = ".create(";
  protected final String TEXT_167 = "))));";
  protected final String TEXT_168 = NL + "\t\t\t\t\t ";
  protected final String TEXT_169 = ".create";
  protected final String TEXT_170 = "())));";
  protected final String TEXT_171 = NL + NL + "\t\tnewChildDescriptors.add" + NL + "\t\t\t(createChildParameter" + NL + "\t\t\t\t(";
  protected final String TEXT_172 = "," + NL + "\t\t\t\t ";
  protected final String TEXT_173 = ".createEntry" + NL + "\t\t\t\t\t(";
  ...
  protected final String TEXT_180 = ".createFromString(";
  protected final String TEXT_181 = ", ";
  protected final String TEXT_182 = "))));";
  protected final String TEXT_183 = " // TODO: ensure this is a valid literal value";
  protected final String TEXT_184 = NL + NL + "\t\tnewChildDescriptors.add" + NL + "\t\t\t(createChildParameter" + NL + "\t\t\t\t(";
  protected final String TEXT_185 = ",";
  protected final String TEXT_186 = NL + "\t\t\t\t ";
  protected final String TEXT_187 = ".create(";
  protected final String TEXT_188 = ")));";
  protected final String TEXT_189 = NL + "\t\t\t\t ";
  protected final String TEXT_190 = ".create";
  protected final String TEXT_191 = "()));";
  protected final String TEXT_192 = NL + NL + "\t\tnewChildDescriptors.add" + NL + "\t\t\t(createChildParameter" + NL + "\t\t\t\t(";
  ...
  protected final String TEXT_202 = " // TODO: ensure this is a valid literal value";
  protected final String TEXT_203 = NL + "\t}" + NL;
  protected final String TEXT_204 = NL + "\t/**" + NL + "\t * This returns the label text for {@link org.eclipse.emf.edit.command.CreateChildCommand}." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_205 = NL + "\t@Override";
  protected final String TEXT_206 = NL + "\tpublic String getCreateChildText(Object owner, Object feature, Object child, ";
  protected final String TEXT_207 = " selection)" + NL + "\t{" + NL + "\t\tObject childFeature = feature;" + NL + "\t\tObject childObject = child;" + NL;
  protected final String TEXT_208 = NL + "\t\tif (childFeature instanceof ";
  protected final String TEXT_209 = " && ";
  protected final String TEXT_210 = ".isFeatureMap((EStructuralFeature)childFeature))" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_211 = ".Entry entry = (FeatureMap.Entry)childObject;" + NL + "\t\t\tchildFeature = entry.getEStructuralFeature();" + NL + "\t\t\tchildObject = entry.getValue();" + NL + "\t\t}" + NL;
  protected final String TEXT_212 = NL + "\t\tboolean qualify =";
  protected final String TEXT_213 = NL + "\t\t\tchildFeature == ";
  protected final String TEXT_214 = NL + NL + "\t\tif (qualify)" + NL + "\t\t{" + NL + "\t\t\treturn getString" + NL + "\t\t\t\t(\"_UI_CreateChild_text2\",";
  protected final String TEXT_215 = NL + "\t\t\t\t new Object[] { getTypeText(childObject), getFeatureText(childFeature), getTypeText(owner) });" + NL + "\t\t}" + NL + "\t\treturn super.getCreateChildText(owner, feature, child, selection);" + NL + "\t}" + NL;
  protected final String TEXT_216 = NL + "\t/**" + NL + "\t * This returns the icon image for {@link org.eclipse.emf.edit.command.CreateChildCommand}." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_217 = NL + "\t@Override";
  protected final String TEXT_218 = NL + "\tpublic Object getCreateChildImage(Object owner, Object feature, Object child, ";
  protected final String TEXT_219 = " selection)" + NL + "\t{" + NL + "\t\tif (feature instanceof ";
  protected final String TEXT_220 = " && ";
  protected final String TEXT_221 = ".isFeatureMap((";
  protected final String TEXT_222 = ")feature))" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_223 = ".Entry entry = (";
  protected final String TEXT_224 = ".Entry)child;" + NL + "\t\t\tfeature = entry.getEStructuralFeature();" + NL + "\t\t\tchild = entry.getValue();        " + NL + "\t\t}" + NL + "" + NL + "\t\tif (feature instanceof ";
  protected final String TEXT_225 = " && child instanceof ";
  protected final String TEXT_226 = ")" + NL + "\t\t{" + NL + "\t\t\tString name = \"full/obj16/\" + ((EObject)child).eClass().getName();";
  protected final String TEXT_227 = NL + NL + "\t\t\ttry" + NL + "\t\t\t{" + NL + "\t\t\t\treturn getResourceLocator().getImage(name);" + NL + "\t\t\t}" + NL + "\t\t\tcatch (Exception e)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  protected final String TEXT_228 = ".INSTANCE.log(e);" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "" + NL + "\t\treturn super.getCreateChildImage(owner, feature, child, selection);" + NL + "\t}" + NL;
  protected final String TEXT_229 = NL + "\t/**" + NL + "\t * Return the resource locator for this item provider's resources." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_230 = NL + "\t@Override";
  protected final String TEXT_231 = NL + "\tpublic ResourceLocator getResourceLocator()" + NL + "\t{" + NL + "\t\treturn ";
  protected final String TEXT_232 = ".INSTANCE;" + NL + "\t}" + NL;
