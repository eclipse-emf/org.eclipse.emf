...
public class ActionBarContributor
{
  ...
  protected final String TEXT_21 = NL + "\t\t{" + NL + "\t\t\tpublic boolean isEnabled()" + NL + "\t\t\t{" + NL + "\t\t\t\treturn getPage().getActivePart() instanceof IViewerProvider;" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tpublic void run()" + NL + "\t\t\t{" + NL + "\t\t\t\tif (getPage().getActivePart() instanceof IViewerProvider)" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\tViewer viewer = ((IViewerProvider)getPage().getActivePart()).getViewer();" + NL + "\t\t\t\t\tif(viewer != null)" + NL + "\t\t\t\t\t{" + NL + "\t\t\t\t\t\tviewer.refresh();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t};" + NL;
