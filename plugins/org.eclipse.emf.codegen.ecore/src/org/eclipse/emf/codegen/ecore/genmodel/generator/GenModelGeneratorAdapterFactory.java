 ...
 * </copyright>
 *
 * $Id: GenModelGeneratorAdapterFactory.java,v 1.2.2.2 2006/11/09 21:38:29 davidms Exp $
 */
...
public class GenModelGeneratorAdapterFactory extends GenModelAdapterFactory implements GeneratorAdapterFactory
{
   ...
   * 
   * <p>This method is only invoked if {@link #getTemplatePath(GenModel)} has not been overridden. To maintain
   * compatibility with 2.2.1, it should not be invoked by subclasses, except from its own overrides. Nor should such 
   * overrides be invoked.
   * 
