...
public class PluginXML
{
  ...
  protected final String TEXT_41 = NL + NL + "  <extension point=\"org.eclipse.emf.ecore.content_parser\">" + NL + "    <parser" + NL + "        contentTypeIdentifier=\"";
  protected final String TEXT_42 = "\"" + NL + "        class=\"";
  protected final String TEXT_43 = "\"/>" + NL + "  </extension>" + NL + "" + NL + "  <extension point=\"org.eclipse.core.runtime.contentTypes\">" + NL + "    <content-type" + NL + "        base-type=\"";
  protected final String TEXT_44 = "\"" + NL + "        file-extensions=\"";
  protected final String TEXT_45 = "\"" + NL + "        id=\"";
  protected final String TEXT_46 = "\"" + NL + "        name=\"%_UI_";
  protected final String TEXT_47 = "_content_type\"" + NL + "        priority=\"normal\">" + NL + "      <describer class=\"org.eclipse.emf.ecore.xmi.impl.RootXMLContentHandlerImpl$Describer\">";
  protected final String TEXT_48 = NL + "        <parameter name=\"namespace\" value=\"";
  protected final String TEXT_49 = "\"/>";
  protected final String TEXT_50 = NL + "        <parameter name=\"kind\" value=\"xmi\"/>";
  protected final String TEXT_51 = NL + "      </describer>" + NL + "    </content-type>" + NL + "  </extension>";
  protected final String TEXT_52 = NL + NL + "  <extension point=\"org.eclipse.emf.ecore.extension_parser\">" + NL + "    <parser" + NL + "        type=\"";
  protected final String TEXT_53 = "\"" + NL + "        class=\"";
  protected final String TEXT_54 = "\"/>" + NL + "  </extension>";
  protected final String TEXT_55 = NL + NL + "  <extension" + NL + "    point=\"org.eclipse.core.runtime.applications\"" + NL + "    id=\"";
  protected final String TEXT_56 = "Application\">" + NL + "    <application>" + NL + "      <run" + NL + "        class=\"";
  protected final String TEXT_57 = "$Application\">" + NL + "      </run>" + NL + "    </application>" + NL + "  </extension>" + NL + "" + NL + "   <extension" + NL + "    point=\"org.eclipse.ui.perspectives\">" + NL + "    <perspective" + NL + "      name=\"%_UI_Perspective_label\"" + NL + "      class=\"";
  protected final String TEXT_58 = "$Perspective\"" + NL + "      id=\"";
  protected final String TEXT_59 = "Perspective\">" + NL + "    </perspective>" + NL + "  </extension>" + NL + "" + NL + "  <extension" + NL + "    point=\"org.eclipse.ui.commands\">" + NL + "    <command" + NL + "      name=\"%_UI_Menu_OpenURI_label\"" + NL + "      description=\"%_UI_Menu_OpenURI_description\"" + NL + "      categoryId=\"org.eclipse.ui.category.file\"" + NL + "      id=\"";
  protected final String TEXT_60 = "OpenURICommand\" />  " + NL + "    <command" + NL + "      name=\"%_UI_Menu_Open_label\"" + NL + "      description=\"%_UI_Menu_Open_description\"" + NL + "      categoryId=\"org.eclipse.ui.category.file\"" + NL + "      id=\"";
  protected final String TEXT_61 = "OpenCommand\" />  " + NL + "  </extension>" + NL + "  " + NL + "  <extension" + NL + "    point=\"org.eclipse.ui.bindings\">" + NL + "    <key" + NL + "      commandId=\"";
  ...
  protected final String TEXT_63 = "OpenCommand\"" + NL + "      sequence=\"M1+O\"" + NL + "      schemeId=\"org.eclipse.ui.defaultAcceleratorConfiguration\" />" + NL + "  </extension>" + NL + "" + NL + "  <extension" + NL + "    point=\"org.eclipse.ui.actionSets\">" + NL + "    <actionSet" + NL + "      label=\"%_UI_";
  ...
  protected final String TEXT_67 = "AboutAction\">" + NL + "      </action>" + NL + "      <action" + NL + "        label=\"%_UI_Menu_OpenURI_label\"" + NL + "        definitionId=\"";
  ...
  protected final String TEXT_70 = "OpenURIAction\">" + NL + "      </action>" + NL + "      <action" + NL + "        label=\"%_UI_Menu_Open_label\"" + NL + "        definitionId=\"";
  ...
  protected final String TEXT_73 = "OpenAction\">" + NL + "      </action>" + NL + "    </actionSet>" + NL + "  </extension>   ";
  protected final String TEXT_74 = NL + NL + "  <extension" + NL + "    point=\"org.eclipse.ui.actionSets\">" + NL + "    <actionSet" + NL + "      label=\"%_UI_";
  protected final String TEXT_75 = "_ActionSet_label\"" + NL + "      visible=\"true\"" + NL + "      id=\"";
  protected final String TEXT_76 = "ActionSet\">" + NL + "      <action" + NL + "        label=\"%_UI_";
  protected final String TEXT_77 = "_label\"" + NL + "        class=\"";
  protected final String TEXT_78 = "$NewAction\"" + NL + "        menubarPath=\"file/new/additions\"" + NL + "        id=\"";
  protected final String TEXT_79 = "NewAction\">" + NL + "      </action>" + NL + "    </actionSet>" + NL + "  </extension>  ";
  protected final String TEXT_80 = NL + NL + "  <extension" + NL + "    point = \"org.eclipse.ui.newWizards\">" + NL + "    <category" + NL + "      id = \"org.eclipse.emf.ecore.Wizard.category.ID\"" + NL + "      name=\"%_UI_Wizard_category\">" + NL + "    </category>" + NL + "    <wizard" + NL + "      id = \"";
  protected final String TEXT_81 = "ID\"" + NL + "      name = \"%_UI_";
  protected final String TEXT_82 = "_label\"" + NL + "      class = \"";
  protected final String TEXT_83 = "\"" + NL + "      category = \"org.eclipse.emf.ecore.Wizard.category.ID\"" + NL + "      icon = \"icons/full/obj16/";
  ...
  protected final String TEXT_86 = NL + NL + "  <extension point = \"org.eclipse.ui.editors\">" + NL + "    <editor" + NL + "        id = \"";
  protected final String TEXT_87 = "ID\"" + NL + "        name = \"%_UI_";
  ...
  protected final String TEXT_92 = NL + "        class = \"";
  protected final String TEXT_93 = "\" " + NL + "        contributorClass=\"";
  protected final String TEXT_94 = "\">";
  protected final String TEXT_95 = NL + "      <contentTypeBinding contentTypeId=\"";
