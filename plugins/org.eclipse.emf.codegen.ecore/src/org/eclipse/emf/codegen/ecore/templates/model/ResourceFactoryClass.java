...
public class ResourceFactoryClass
{
  ...
  protected final String TEXT_22 = NL + "\t\textendedMetaData = ";
  ...
  protected final String TEXT_31 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * Creates an instance of the resource." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic Resource createResource(URI uri)" + NL + "\t{";
  protected final String TEXT_32 = NL + "\t\t";
  protected final String TEXT_33 = " result = new ";
  protected final String TEXT_34 = "(uri);" + NL + "\t\tresult.getDefaultSaveOptions().put(";
  ...
  protected final String TEXT_42 = "(uri);" + NL + "\t\tresult.getDefaultSaveOptions().put(";
  ...
  protected final String TEXT_47 = NL + "\t\treturn result;" + NL + "\t}" + NL + "} //";
 ...
 * </copyright>
 *
 * $Id: ResourceFactoryClass.java,v 1.1 2004/03/06 17:31:31 marcelop Exp $
 */
