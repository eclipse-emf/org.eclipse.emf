...
public class PluginProperties
{
  ...
  protected final String TEXT_18 = " model" + NL + "" + NL + "_UI_";
  ...
  protected final String TEXT_22 = "FilenameExtension = ";
  protected final String TEXT_23 = NL;
  protected final String TEXT_24 = NL + "_UI_Wizard_label = New" + NL + "" + NL + "_WARN_FilenameExtension = The file name must end in \".{0}\"" + NL + "" + NL + "_UI_ModelObject = Model Object" + NL + "_UI_XMLEncoding = XML Encoding" + NL + "_UI_XMLEncodingChoices = ";
