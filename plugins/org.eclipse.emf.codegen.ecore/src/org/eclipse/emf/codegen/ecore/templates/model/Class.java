...
public class Class
{
  ...
  protected final String TEXT_382 = NL + "\t\t// TODO: implement this method to return the '";
  protected final String TEXT_383 = "' ";
  protected final String TEXT_384 = NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT";
  protected final String TEXT_385 = NL + "\t\t// The list is expected to implement org.eclipse.emf.ecore.util.InternalEList and org.eclipse.emf.ecore.EStructuralFeature.Setting" + NL + "\t\t// so it's likely that an appropriate subclass of org.eclipse.emf.ecore.util.";
  protected final String TEXT_386 = "EcoreEMap";
  protected final String TEXT_387 = "BasicFeatureMap";
  protected final String TEXT_388 = "EcoreEList";
  protected final String TEXT_389 = " should be used.";
  protected final String TEXT_390 = NL + "\t\tthrow new UnsupportedOperationException();";
  protected final String TEXT_391 = NL + "\t}" + NL;
  protected final String TEXT_392 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_393 = " basicGet";
  protected final String TEXT_394 = "()" + NL + "\t{";
  protected final String TEXT_395 = NL + "\t\tif (eContainerFeatureID != ";
  protected final String TEXT_396 = ") return null;" + NL + "\t\treturn (";
  protected final String TEXT_397 = ")eInternalContainer();";
  ...
  protected final String TEXT_405 = ".Internal.Wrapper)get";
  protected final String TEXT_406 = "()).featureMap().get(";
  ...
  protected final String TEXT_411 = ", false);";
  protected final String TEXT_412 = NL + "\t\t// TODO: implement this method to return the '";
  protected final String TEXT_413 = "' ";
  protected final String TEXT_414 = NL + "\t\t// -> do not perform proxy resolution" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tthrow new UnsupportedOperationException();";
  protected final String TEXT_415 = NL + "\t}" + NL;
  protected final String TEXT_416 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_417 = " basicSet";
  protected final String TEXT_418 = "(";
  protected final String TEXT_419 = " new";
  protected final String TEXT_420 = ", ";
  protected final String TEXT_421 = " msgs)" + NL + "\t{";
  protected final String TEXT_422 = NL + "\t\tmsgs = eBasicSetContainer((";
  protected final String TEXT_423 = ")new";
  protected final String TEXT_424 = ", ";
  protected final String TEXT_425 = ", msgs);";
  protected final String TEXT_426 = NL + "\t\treturn msgs;";
  protected final String TEXT_427 = NL + "\t\tObject old";
  protected final String TEXT_428 = " = eVirtualSet(";
  ...
  protected final String TEXT_437 = NL + "\t\tboolean isSetChange = old";
  protected final String TEXT_438 = " == EVIRTUAL_NO_VALUE;";
  protected final String TEXT_439 = NL + "\t\tboolean old";
  protected final String TEXT_440 = "ESet = (";
  protected final String TEXT_441 = " & ";
  protected final String TEXT_442 = "_ESETFLAG) != 0;" + NL + "\t\t";
  ...
  protected final String TEXT_447 = "ESet;" + NL + "\t\t";
  protected final String TEXT_448 = "ESet = true;";
  protected final String TEXT_449 = NL + "\t\tif (eNotificationRequired())" + NL + "\t\t{";
  protected final String TEXT_450 = NL + "\t\t\t";
  protected final String TEXT_451 = " notification = new ";
  protected final String TEXT_452 = "(this, ";
  protected final String TEXT_453 = ".SET, ";
  protected final String TEXT_454 = ", ";
  protected final String TEXT_455 = "isSetChange ? null : old";
  protected final String TEXT_456 = "old";
  protected final String TEXT_457 = ", new";
  protected final String TEXT_458 = ", ";
  protected final String TEXT_459 = "isSetChange";
  protected final String TEXT_460 = "!old";
  protected final String TEXT_461 = "ESet";
  protected final String TEXT_462 = ");";
  protected final String TEXT_463 = NL + "\t\t\t";
  protected final String TEXT_464 = " notification = new ";
  ...
  protected final String TEXT_473 = NL + "\t\t\tif (msgs == null) msgs = notification; else msgs.add(notification);" + NL + "\t\t}";
  protected final String TEXT_474 = NL + "\t\treturn msgs;";
  ...
  protected final String TEXT_478 = "()).featureMap()).basicAdd(";
  protected final String TEXT_479 = ", new";
  protected final String TEXT_480 = ", msgs);";
  protected final String TEXT_481 = NL + "\t\treturn ((";
  protected final String TEXT_482 = ".Internal)get";
  protected final String TEXT_483 = "()).basicAdd(";
  protected final String TEXT_484 = ", new";
  protected final String TEXT_485 = ", msgs);";
  protected final String TEXT_486 = NL + "\t\t// TODO: implement this method to set the contained '";
  protected final String TEXT_487 = "' ";
  protected final String TEXT_488 = NL + "\t\t// -> this method is automatically invoked to keep the containment relationship in synch" + NL + "\t\t// -> do not modify other features" + NL + "\t\t// -> return msgs, after adding any generated Notification to it (if it is null, a NotificationChain object must be created first)" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tthrow new UnsupportedOperationException();";
  protected final String TEXT_489 = NL + "\t}" + NL;
  protected final String TEXT_490 = NL + "\t/**" + NL + "\t * Sets the value of the '{@link ";
  protected final String TEXT_491 = "#";
  protected final String TEXT_492 = " <em>";
  protected final String TEXT_493 = "</em>}' ";
  protected final String TEXT_494 = "." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @param value the new value of the '<em>";
  protected final String TEXT_495 = "</em>' ";
  protected final String TEXT_496 = ".";
  protected final String TEXT_497 = NL + "\t * @see ";
  protected final String TEXT_498 = NL + "\t * @see #isSet";
  protected final String TEXT_499 = "()";
  protected final String TEXT_500 = NL + "\t * @see #unset";
  protected final String TEXT_501 = "()";
  protected final String TEXT_502 = NL + "\t * @see #";
  protected final String TEXT_503 = "()" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_504 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_505 = NL + "\tvoid set";
  protected final String TEXT_506 = "(";
  protected final String TEXT_507 = " value);" + NL;
  protected final String TEXT_508 = NL + "\tpublic void set";
  protected final String TEXT_509 = "(";
  protected final String TEXT_510 = " new";
  protected final String TEXT_511 = ")" + NL + "\t{";
  protected final String TEXT_512 = NL + "\t\teSet(";
  ...
  protected final String TEXT_519 = NL + "\t\tif (new";
  protected final String TEXT_520 = " != eInternalContainer() || (eContainerFeatureID != ";
  protected final String TEXT_521 = " && new";
  protected final String TEXT_522 = " != null))" + NL + "\t\t{" + NL + "\t\t\tif (";
  protected final String TEXT_523 = ".isAncestor(this, ";
  protected final String TEXT_524 = "new";
  protected final String TEXT_525 = "))" + NL + "\t\t\t\tthrow new ";
  protected final String TEXT_526 = "(\"Recursive containment not allowed for \" + toString());";
  protected final String TEXT_527 = NL + "\t\t\t";
  protected final String TEXT_528 = " msgs = null;" + NL + "\t\t\tif (eInternalContainer() != null)" + NL + "\t\t\t\tmsgs = eBasicRemoveFromContainer(msgs);" + NL + "\t\t\tif (new";
  protected final String TEXT_529 = " != null)" + NL + "\t\t\t\tmsgs = ((";
  protected final String TEXT_530 = ")new";
  protected final String TEXT_531 = ").eInverseAdd(this, ";
  protected final String TEXT_532 = ", ";
  protected final String TEXT_533 = ".class, msgs);" + NL + "\t\t\tmsgs = basicSet";
  protected final String TEXT_534 = "(";
  protected final String TEXT_535 = "new";
  protected final String TEXT_536 = ", msgs);" + NL + "\t\t\tif (msgs != null) msgs.dispatch();" + NL + "\t\t}";
  protected final String TEXT_537 = NL + "\t\telse if (eNotificationRequired())" + NL + "\t\t\teNotify(new ";
  ...
  protected final String TEXT_546 = ")eVirtualGet(";
  protected final String TEXT_547 = ");";
  protected final String TEXT_548 = NL + "\t\tif (new";
  protected final String TEXT_549 = " != ";
  protected final String TEXT_550 = ")" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_551 = " msgs = null;" + NL + "\t\t\tif (";
  protected final String TEXT_552 = " != null)";
  protected final String TEXT_553 = NL + "\t\t\t\tmsgs = ((";
  protected final String TEXT_554 = ")";
  protected final String TEXT_555 = ").eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ";
  protected final String TEXT_556 = ", null, msgs);" + NL + "\t\t\tif (new";
  protected final String TEXT_557 = " != null)" + NL + "\t\t\t\tmsgs = ((";
  protected final String TEXT_558 = ")new";
  protected final String TEXT_559 = ").eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ";
  protected final String TEXT_560 = ", null, msgs);";
  protected final String TEXT_561 = NL + "\t\t\t\tmsgs = ((";
  protected final String TEXT_562 = ")";
  protected final String TEXT_563 = ").eInverseRemove(this, ";
  protected final String TEXT_564 = ", ";
  protected final String TEXT_565 = ".class, msgs);" + NL + "\t\t\tif (new";
  protected final String TEXT_566 = " != null)" + NL + "\t\t\t\tmsgs = ((";
  protected final String TEXT_567 = ")new";
  protected final String TEXT_568 = ").eInverseAdd(this, ";
  protected final String TEXT_569 = ", ";
  protected final String TEXT_570 = ".class, msgs);";
  protected final String TEXT_571 = NL + "\t\t\tmsgs = basicSet";
  ...
  protected final String TEXT_577 = "ESet = eVirtualIsSet(";
  protected final String TEXT_578 = ");";
  protected final String TEXT_579 = NL + "\t\t\tboolean old";
  protected final String TEXT_580 = "ESet = (";
  protected final String TEXT_581 = " & ";
  protected final String TEXT_582 = "_ESETFLAG) != 0;";
  protected final String TEXT_583 = NL + "\t\t\t";
  protected final String TEXT_584 = " |= ";
  protected final String TEXT_585 = "_ESETFLAG;";
  ...
  protected final String TEXT_590 = "ESet = true;";
  protected final String TEXT_591 = NL + "\t\t\tif (eNotificationRequired())" + NL + "\t\t\t\teNotify(new ";
  ...
  protected final String TEXT_599 = NL + "\t\telse if (eNotificationRequired())" + NL + "\t\t\teNotify(new ";
  ...
  protected final String TEXT_613 = "_EFLAG; else ";
  protected final String TEXT_614 = " &= ~";
  protected final String TEXT_615 = "_EFLAG;";
  ...
  protected final String TEXT_644 = NL + "\t\tboolean isSetChange = old";
  protected final String TEXT_645 = " == EVIRTUAL_NO_VALUE;";
  ...
  protected final String TEXT_657 = "ESet = true;";
  ...
  protected final String TEXT_686 = "()).featureMap()).set(";
  ...
  protected final String TEXT_694 = ".Internal)get";
  ...
  protected final String TEXT_702 = NL + "\t\t// TODO: implement this method to set the '";
  protected final String TEXT_703 = "' ";
  protected final String TEXT_704 = NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tthrow new UnsupportedOperationException();";
  protected final String TEXT_705 = NL + "\t}" + NL;
  protected final String TEXT_706 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_707 = " basicUnset";
  protected final String TEXT_708 = "(";
  protected final String TEXT_709 = " msgs)" + NL + "\t{";
  protected final String TEXT_710 = NL + "\t\tObject old";
  protected final String TEXT_711 = " = eVirtualUnset(";
  ...
  protected final String TEXT_723 = "_ESETFLAG) != 0;" + NL + "\t\t";
  protected final String TEXT_724 = " &= ~";
  protected final String TEXT_725 = "_ESETFLAG;";
  protected final String TEXT_726 = NL + "\t\tboolean old";
  protected final String TEXT_727 = "ESet = ";
  protected final String TEXT_728 = "ESet;" + NL + "\t\t";
  protected final String TEXT_729 = "ESet = false;";
  protected final String TEXT_730 = NL + "\t\tif (eNotificationRequired())" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_731 = " notification = new ";
  protected final String TEXT_732 = "(this, ";
  protected final String TEXT_733 = ".UNSET, ";
  protected final String TEXT_734 = ", ";
  protected final String TEXT_735 = "isSetChange ? old";
  ...
  protected final String TEXT_742 = ");" + NL + "\t\t\tif (msgs == null) msgs = notification; else msgs.add(notification);" + NL + "\t\t}" + NL + "\t\treturn msgs;";
  protected final String TEXT_743 = NL + "\t\t// TODO: implement this method to unset the contained '";
  protected final String TEXT_744 = "' ";
  protected final String TEXT_745 = NL + "\t\t// -> this method is automatically invoked to keep the containment relationship in synch" + NL + "\t\t// -> do not modify other features" + NL + "\t\t// -> return msgs, after adding any generated Notification to it (if it is null, a NotificationChain object must be created first)" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tthrow new UnsupportedOperationException();";
  protected final String TEXT_746 = NL + "\t}" + NL;
  protected final String TEXT_747 = NL + "\t/**" + NL + "\t * Unsets the value of the '{@link ";
  protected final String TEXT_748 = "#";
  protected final String TEXT_749 = " <em>";
  protected final String TEXT_750 = "</em>}' ";
  protected final String TEXT_751 = "." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_752 = NL + "\t * @see #isSet";
  protected final String TEXT_753 = "()";
  protected final String TEXT_754 = NL + "\t * @see #";
  protected final String TEXT_755 = "()";
  protected final String TEXT_756 = NL + "\t * @see #set";
  protected final String TEXT_757 = "(";
  protected final String TEXT_758 = ")";
  protected final String TEXT_759 = NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_760 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_761 = NL + "\tvoid unset";
  protected final String TEXT_762 = "();" + NL;
  protected final String TEXT_763 = NL + "\tpublic void unset";
  protected final String TEXT_764 = "()" + NL + "\t{";
  protected final String TEXT_765 = NL + "\t\teUnset(";
  ...
  protected final String TEXT_774 = ".Unsettable";
  protected final String TEXT_775 = ")";
  protected final String TEXT_776 = ").unset();";
  protected final String TEXT_777 = NL + "\t\t";
  protected final String TEXT_778 = " ";
  protected final String TEXT_779 = " = (";
  protected final String TEXT_780 = ")eVirtualGet(";
  protected final String TEXT_781 = ");";
  protected final String TEXT_782 = NL + "\t\tif (";
  protected final String TEXT_783 = " != null)" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_784 = " msgs = null;";
  protected final String TEXT_785 = NL + "\t\t\tmsgs = ((";
  protected final String TEXT_786 = ")";
  protected final String TEXT_787 = ").eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ";
  protected final String TEXT_788 = ", null, msgs);";
  protected final String TEXT_789 = NL + "\t\t\tmsgs = ((";
  protected final String TEXT_790 = ")";
  protected final String TEXT_791 = ").eInverseRemove(this, ";
  protected final String TEXT_792 = ", ";
  protected final String TEXT_793 = ".class, msgs);";
  protected final String TEXT_794 = NL + "\t\t\tmsgs = basicUnset";
  protected final String TEXT_795 = "(msgs);" + NL + "\t\t\tif (msgs != null) msgs.dispatch();" + NL + "\t\t}" + NL + "\t\telse" + NL + "\t\t{";
  ...
  protected final String TEXT_810 = "ESet = false;";
  ...
  protected final String TEXT_814 = ", null, null, old";
  ...
  protected final String TEXT_821 = "_EFLAG) != 0;";
  protected final String TEXT_822 = NL + "\t\tObject old";
  protected final String TEXT_823 = " = eVirtualUnset(";
  protected final String TEXT_824 = ");";
  protected final String TEXT_825 = NL + "\t\t";
  protected final String TEXT_826 = " old";
  protected final String TEXT_827 = " = ";
  protected final String TEXT_828 = ";";
  protected final String TEXT_829 = NL + "\t\tboolean isSetChange = old";
  protected final String TEXT_830 = " != EVIRTUAL_NO_VALUE;";
  ...
  protected final String TEXT_835 = NL + "\t\tboolean old";
  ...
  protected final String TEXT_849 = "isSetChange ? old";
  ...
  protected final String TEXT_860 = "_EFLAG; else ";
  ...
  protected final String TEXT_868 = "_ESETFLAG;";
  ...
  protected final String TEXT_875 = "isSetChange ? old";
  protected final String TEXT_876 = " : ";
  protected final String TEXT_877 = "old";
  protected final String TEXT_878 = ", ";
  protected final String TEXT_879 = ", ";
  protected final String TEXT_880 = "isSetChange";
  protected final String TEXT_881 = "old";
  protected final String TEXT_882 = "ESet";
  protected final String TEXT_883 = "));";
  protected final String TEXT_884 = NL + "\t\t((";
  protected final String TEXT_885 = ".Internal)((";
  protected final String TEXT_886 = ".Internal.Wrapper)get";
  protected final String TEXT_887 = "()).featureMap()).clear(";
  protected final String TEXT_888 = ");";
  protected final String TEXT_889 = NL + "\t\t((";
  protected final String TEXT_890 = ".Internal)get";
  protected final String TEXT_891 = "()).clear(";
  protected final String TEXT_892 = ");";
  protected final String TEXT_893 = NL + "\t\t// TODO: implement this method to unset the '";
  protected final String TEXT_894 = "' ";
  protected final String TEXT_895 = NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tthrow new UnsupportedOperationException();";
  protected final String TEXT_896 = NL + "\t}" + NL;
  protected final String TEXT_897 = NL + "\t/**" + NL + "\t * Returns whether the value of the '{@link ";
  protected final String TEXT_898 = "#";
  protected final String TEXT_899 = " <em>";
  protected final String TEXT_900 = "</em>}' ";
  protected final String TEXT_901 = " is set." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return whether the value of the '<em>";
  protected final String TEXT_902 = "</em>' ";
  protected final String TEXT_903 = " is set.";
  protected final String TEXT_904 = NL + "\t * @see #unset";
  protected final String TEXT_905 = "()";
  protected final String TEXT_906 = NL + "\t * @see #";
  protected final String TEXT_907 = "()";
  protected final String TEXT_908 = NL + "\t * @see #set";
  protected final String TEXT_909 = "(";
  protected final String TEXT_910 = ")";
  protected final String TEXT_911 = NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_912 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_913 = NL + "\tboolean isSet";
  protected final String TEXT_914 = "();" + NL;
  protected final String TEXT_915 = NL + "\tpublic boolean isSet";
  protected final String TEXT_916 = "()" + NL + "\t{";
  protected final String TEXT_917 = NL + "\t\treturn eIsSet(";
  ...
  protected final String TEXT_949 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_950 = NL + "\t * <!-- begin-model-doc -->" + NL + "\t * ";
  protected final String TEXT_951 = NL + "\t * <!-- end-model-doc -->";
  ...
  protected final String TEXT_962 = NL + "\tpublic ";
  protected final String TEXT_963 = " ";
  protected final String TEXT_964 = "(";
  protected final String TEXT_965 = ")";
  protected final String TEXT_966 = NL + "\t{";
  protected final String TEXT_967 = NL + "\t\t";
  protected final String TEXT_968 = NL + "\t\t// TODO: implement this method" + NL + "\t\t// -> specify the condition that violates the invariant" + NL + "\t\t// -> verify the details of the diagnostic, including severity and message" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tif (false)" + NL + "\t\t{" + NL + "\t\t\tif (";
  protected final String TEXT_969 = " != null)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  protected final String TEXT_970 = ".add" + NL + "\t\t\t\t\t(new ";
  protected final String TEXT_971 = NL + "\t\t\t\t\t\t(";
  protected final String TEXT_972 = ".ERROR," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_973 = ".DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_974 = ".";
  protected final String TEXT_975 = "," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_976 = ".INSTANCE.getString(\"_UI_GenericInvariant_diagnostic\", new Object[] { \"";
  protected final String TEXT_977 = "\", ";
  protected final String TEXT_978 = ".getObjectLabel(this, ";
  protected final String TEXT_979 = ") }),";
  protected final String TEXT_980 = NL + "\t\t\t\t\t\t new Object [] { this }));" + NL + "\t\t\t}" + NL + "\t\t\treturn false;" + NL + "\t\t}" + NL + "\t\treturn true;";
  ...
  protected final String TEXT_984 = NL + "\t@SuppressWarnings(\"unchecked\")";
  protected final String TEXT_985 = NL + "\t@Override";
  protected final String TEXT_986 = NL + "\tpublic ";
  protected final String TEXT_987 = " eInverseAdd(";
  protected final String TEXT_988 = " otherEnd, int featureID, ";
  protected final String TEXT_989 = " msgs)" + NL + "\t{" + NL + "\t\tswitch (featureID)" + NL + "\t\t{";
  protected final String TEXT_990 = NL + "\t\t\tcase ";
  protected final String TEXT_991 = ":";
  protected final String TEXT_992 = NL + "\t\t\t\treturn ((";
  protected final String TEXT_993 = "(";
  protected final String TEXT_994 = ".InternalMapView";
  protected final String TEXT_995 = ")";
  protected final String TEXT_996 = "()).eMap()).basicAdd(otherEnd, msgs);";
  protected final String TEXT_997 = NL + "\t\t\t\treturn (";
  protected final String TEXT_998 = "()).basicAdd(otherEnd, msgs);";
  protected final String TEXT_999 = NL + "\t\t\t\tif (eInternalContainer() != null)" + NL + "\t\t\t\t\tmsgs = eBasicRemoveFromContainer(msgs);";
  protected final String TEXT_1000 = NL + "\t\t\t\treturn basicSet";
  protected final String TEXT_1001 = "((";
  protected final String TEXT_1002 = ")otherEnd, msgs);";
  protected final String TEXT_1003 = NL + "\t\t\t\treturn eBasicSetContainer(otherEnd, ";
  protected final String TEXT_1004 = ", msgs);";
  protected final String TEXT_1005 = NL + "\t\t\t\t";
  protected final String TEXT_1006 = " ";
  protected final String TEXT_1007 = " = (";
  protected final String TEXT_1008 = ")eVirtualGet(";
  protected final String TEXT_1009 = ");";
  protected final String TEXT_1010 = NL + "\t\t\t\tif (";
  protected final String TEXT_1011 = " != null)";
  protected final String TEXT_1012 = NL + "\t\t\t\t\tmsgs = ((";
  protected final String TEXT_1013 = ")";
  protected final String TEXT_1014 = ").eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ";
  protected final String TEXT_1015 = ", null, msgs);";
  protected final String TEXT_1016 = NL + "\t\t\t\t\tmsgs = ((";
  protected final String TEXT_1017 = ")";
  protected final String TEXT_1018 = ").eInverseRemove(this, ";
  protected final String TEXT_1019 = ", ";
  protected final String TEXT_1020 = ".class, msgs);";
  ...
  protected final String TEXT_1025 = NL + "\t\treturn super.eInverseAdd(otherEnd, featureID, msgs);";
  protected final String TEXT_1026 = NL + "\t\treturn eDynamicInverseAdd(otherEnd, featureID, msgs);";
  protected final String TEXT_1027 = NL + "\t}" + NL;
  protected final String TEXT_1028 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_1029 = NL + "\t@Override";
  protected final String TEXT_1030 = NL + "\tpublic ";
  protected final String TEXT_1031 = " eInverseRemove(";
  protected final String TEXT_1032 = " otherEnd, int featureID, ";
  protected final String TEXT_1033 = " msgs)" + NL + "\t{" + NL + "\t\tswitch (featureID)" + NL + "\t\t{";
  protected final String TEXT_1034 = NL + "\t\t\tcase ";
  protected final String TEXT_1035 = ":";
  protected final String TEXT_1036 = NL + "\t\t\t\treturn ((";
  protected final String TEXT_1037 = ")((";
  protected final String TEXT_1038 = ".InternalMapView";
  protected final String TEXT_1039 = ")";
  protected final String TEXT_1040 = "()).eMap()).basicRemove(otherEnd, msgs);";
  protected final String TEXT_1041 = NL + "\t\t\t\treturn ((";
  protected final String TEXT_1042 = ")((";
  protected final String TEXT_1043 = ".Internal.Wrapper)";
  protected final String TEXT_1044 = "()).featureMap()).basicRemove(otherEnd, msgs);";
  protected final String TEXT_1045 = NL + "\t\t\t\treturn ((";
  protected final String TEXT_1046 = ")";
  protected final String TEXT_1047 = "()).basicRemove(otherEnd, msgs);";
  protected final String TEXT_1048 = NL + "\t\t\t\treturn eBasicSetContainer(null, ";
  protected final String TEXT_1049 = ", msgs);";
  protected final String TEXT_1050 = NL + "\t\t\t\treturn basicUnset";
  protected final String TEXT_1051 = "(msgs);";
  protected final String TEXT_1052 = NL + "\t\t\t\treturn basicSet";
  protected final String TEXT_1053 = "(null, msgs);";
  protected final String TEXT_1054 = NL + "\t\t}";
  protected final String TEXT_1055 = NL + "\t\treturn super.eInverseRemove(otherEnd, featureID, msgs);";
  protected final String TEXT_1056 = NL + "\t\treturn eDynamicInverseRemove(otherEnd, featureID, msgs);";
  protected final String TEXT_1057 = NL + "\t}" + NL;
  protected final String TEXT_1058 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_1059 = NL + "\t@Override";
  protected final String TEXT_1060 = NL + "\tpublic ";
  protected final String TEXT_1061 = " eBasicRemoveFromContainerFeature(";
  protected final String TEXT_1062 = " msgs)" + NL + "\t{" + NL + "\t\tswitch (eContainerFeatureID)" + NL + "\t\t{";
  protected final String TEXT_1063 = NL + "\t\t\tcase ";
  protected final String TEXT_1064 = ":" + NL + "\t\t\t\treturn eInternalContainer().eInverseRemove(this, ";
  protected final String TEXT_1065 = ", ";
  protected final String TEXT_1066 = ".class, msgs);";
  protected final String TEXT_1067 = NL + "\t\t}";
  protected final String TEXT_1068 = NL + "\t\treturn super.eBasicRemoveFromContainerFeature(msgs);";
  protected final String TEXT_1069 = NL + "\t\treturn eDynamicBasicRemoveFromContainer(msgs);";
  protected final String TEXT_1070 = NL + "\t}" + NL;
  protected final String TEXT_1071 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_1072 = NL + "\t@Override";
  protected final String TEXT_1073 = NL + "\tpublic Object eGet(int featureID, boolean resolve, boolean coreType)" + NL + "\t{" + NL + "\t\tswitch (featureID)" + NL + "\t\t{";
  protected final String TEXT_1074 = NL + "\t\t\tcase ";
  protected final String TEXT_1075 = ":";
  protected final String TEXT_1076 = NL + "\t\t\t\treturn ";
  protected final String TEXT_1077 = "() ? Boolean.TRUE : Boolean.FALSE;";
  protected final String TEXT_1078 = NL + "\t\t\t\treturn new ";
  protected final String TEXT_1079 = "(";
  protected final String TEXT_1080 = "());";
  protected final String TEXT_1081 = NL + "\t\t\t\tif (resolve) return ";
  protected final String TEXT_1082 = "();" + NL + "\t\t\t\treturn basicGet";
  protected final String TEXT_1083 = "();";
  protected final String TEXT_1084 = NL + "\t\t\t\tif (coreType) return ((";
  protected final String TEXT_1085 = ".InternalMapView";
  protected final String TEXT_1086 = ")";
  protected final String TEXT_1087 = "()).eMap();" + NL + "\t\t\t\telse return ";
  protected final String TEXT_1088 = "();";
  protected final String TEXT_1089 = NL + "\t\t\t\tif (coreType) return ";
  protected final String TEXT_1090 = "();" + NL + "\t\t\t\telse return ";
  protected final String TEXT_1091 = "().map();";
  protected final String TEXT_1092 = NL + "\t\t\t\tif (coreType) return ((";
  protected final String TEXT_1093 = ".Internal.Wrapper)";
  protected final String TEXT_1094 = "()).featureMap();" + NL + "\t\t\t\treturn ";
  ...
  protected final String TEXT_1099 = "()).getWrapper();";
  protected final String TEXT_1100 = NL + "\t\t\t\treturn ";
  protected final String TEXT_1101 = "();";
  protected final String TEXT_1102 = NL + "\t\t}";
  protected final String TEXT_1103 = NL + "\t\treturn super.eGet(featureID, resolve, coreType);";
  protected final String TEXT_1104 = NL + "\t\treturn eDynamicGet(featureID, resolve, coreType);";
  protected final String TEXT_1105 = NL + "\t}" + NL;
  protected final String TEXT_1106 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_1107 = NL + "\t@SuppressWarnings(\"unchecked\")";
  protected final String TEXT_1108 = NL + "\t@Override";
  protected final String TEXT_1109 = NL + "\tpublic void eSet(int featureID, Object newValue)" + NL + "\t{" + NL + "\t\tswitch (featureID)" + NL + "\t\t{";
  ...
  protected final String TEXT_1115 = "()).featureMap()).set(newValue);";
  protected final String TEXT_1116 = NL + "\t\t\t\t((";
  protected final String TEXT_1117 = ".Internal)";
  ...
  protected final String TEXT_1123 = "()).eMap()).set(newValue);";
  protected final String TEXT_1124 = NL + "\t\t\t\t((";
  protected final String TEXT_1125 = ".Setting)";
  protected final String TEXT_1126 = "()).set(newValue);";
  protected final String TEXT_1127 = NL + "\t\t\t\t";
  protected final String TEXT_1128 = "().clear();" + NL + "\t\t\t\t";
  protected final String TEXT_1129 = "().addAll((";
  protected final String TEXT_1130 = "<? extends ";
  protected final String TEXT_1131 = ">";
  protected final String TEXT_1132 = ")newValue);";
  protected final String TEXT_1133 = NL + "\t\t\t\tset";
  protected final String TEXT_1134 = "(((";
  protected final String TEXT_1135 = ")newValue).";
  ...
  protected final String TEXT_1144 = NL + "\t\tsuper.eSet(featureID, newValue);";
  protected final String TEXT_1145 = NL + "\t\teDynamicSet(featureID, newValue);";
  ...
  protected final String TEXT_1149 = NL + "\tpublic void eUnset(int featureID)" + NL + "\t{" + NL + "\t\tswitch (featureID)" + NL + "\t\t{";
  protected final String TEXT_1150 = NL + "\t\t\tcase ";
  protected final String TEXT_1151 = ":";
  protected final String TEXT_1152 = NL + "\t\t\t\t((";
  protected final String TEXT_1153 = ".Internal.Wrapper)";
  protected final String TEXT_1154 = "()).featureMap().clear();";
  protected final String TEXT_1155 = NL + "\t\t\t\t";
  protected final String TEXT_1156 = "().clear();";
  protected final String TEXT_1157 = NL + "\t\t\t\tunset";
  protected final String TEXT_1158 = "();";
  protected final String TEXT_1159 = NL + "\t\t\t\tset";
  protected final String TEXT_1160 = "((";
  protected final String TEXT_1161 = ")null);";
  protected final String TEXT_1162 = NL + "\t\t\t\tset";
  ...
  protected final String TEXT_1167 = NL + "\t\tsuper.eUnset(featureID);";
  protected final String TEXT_1168 = NL + "\t\teDynamicUnset(featureID);";
  protected final String TEXT_1169 = NL + "\t}" + NL;
  protected final String TEXT_1170 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_1171 = NL + "\t@Override";
  protected final String TEXT_1172 = NL + "\tpublic boolean eIsSet(int featureID)" + NL + "\t{" + NL + "\t\tswitch (featureID)" + NL + "\t\t{";
  ...
  protected final String TEXT_1177 = "()).featureMap().isEmpty();";
  protected final String TEXT_1178 = NL + "\t\t\t\treturn ";
  protected final String TEXT_1179 = " != null && !";
  protected final String TEXT_1180 = ".featureMap().isEmpty();";
  ...
  protected final String TEXT_1214 = NL + "\t\t\t\treturn eVirtualGet(";
  ...
  protected final String TEXT_1224 = ".equals(";
  ...
  protected final String TEXT_1229 = ")eVirtualGet(";
  ...
  protected final String TEXT_1250 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (derivedFeatureID)" + NL + "\t\t\t{";
  protected final String TEXT_1251 = NL + "\t\t\t\tcase ";
  protected final String TEXT_1252 = ": return ";
  protected final String TEXT_1253 = ";";
  protected final String TEXT_1254 = NL + "\t\t\t\tdefault: return -1;" + NL + "\t\t\t}" + NL + "\t\t}";
  protected final String TEXT_1255 = NL + "\t\treturn super.eBaseStructuralFeatureID(derivedFeatureID, baseClass);" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_1256 = NL + "\t@Override";
  protected final String TEXT_1257 = NL + "\tpublic int eDerivedStructuralFeatureID(int baseFeatureID, Class";
  protected final String TEXT_1258 = " baseClass)" + NL + "\t{";
  protected final String TEXT_1259 = NL + "\t\tif (baseClass == ";
  protected final String TEXT_1260 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (baseFeatureID)" + NL + "\t\t\t{";
  protected final String TEXT_1261 = NL + "\t\t\t\tcase ";
  protected final String TEXT_1262 = ": return ";
  protected final String TEXT_1263 = ";";
  protected final String TEXT_1264 = NL + "\t\t\t\tdefault: return -1;" + NL + "\t\t\t}" + NL + "\t\t}";
  protected final String TEXT_1265 = NL + "\t\treturn super.eDerivedStructuralFeatureID(baseFeatureID, baseClass);" + NL + "\t}" + NL;
  ...
  protected final String TEXT_1268 = NL + "\tprotected Object[] eVirtualValues()" + NL + "\t{" + NL + "\t\treturn ";
  protected final String TEXT_1269 = ";" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_1270 = NL + "\t@Override";
  protected final String TEXT_1271 = NL + "\tprotected void eSetVirtualValues(Object[] newValues)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1272 = " = newValues;" + NL + "\t}" + NL;
  ...
  protected final String TEXT_1275 = NL + "\tprotected int eVirtualIndexBits(int offset)" + NL + "\t{" + NL + "\t\tswitch (offset)" + NL + "\t\t{";
  protected final String TEXT_1276 = NL + "\t\t\tcase ";
  protected final String TEXT_1277 = " :" + NL + "\t\t\t\treturn ";
  protected final String TEXT_1278 = ";";
  protected final String TEXT_1279 = NL + "\t\t\tdefault :" + NL + "\t\t\t\tthrow new IndexOutOfBoundsException();" + NL + "\t\t}" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_1280 = NL + "\t@Override";
  protected final String TEXT_1281 = NL + "\tprotected void eSetVirtualIndexBits(int offset, int newIndexBits)" + NL + "\t{" + NL + "\t\tswitch (offset)" + NL + "\t\t{";
  protected final String TEXT_1282 = NL + "\t\t\tcase ";
  protected final String TEXT_1283 = " :" + NL + "\t\t\t\t";
  protected final String TEXT_1284 = " = newIndexBits;" + NL + "\t\t\t\tbreak;";
  protected final String TEXT_1285 = NL + "\t\t\tdefault :" + NL + "\t\t\t\tthrow new IndexOutOfBoundsException();" + NL + "\t\t}" + NL + "\t}" + NL;
  protected final String TEXT_1286 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_1287 = NL + "\t@Override";
  protected final String TEXT_1288 = NL + "\tpublic String toString()" + NL + "\t{" + NL + "\t\tif (eIsProxy()) return super.toString();" + NL + "" + NL + "\t\tStringBuffer result = new StringBuffer(super.toString());";
  protected final String TEXT_1289 = NL + "\t\tresult.append(\" (";
  protected final String TEXT_1290 = ": \");";
  protected final String TEXT_1291 = NL + "\t\tresult.append(\", ";
  protected final String TEXT_1292 = ": \");";
  protected final String TEXT_1293 = NL + "\t\tif (eVirtualIsSet(";
  protected final String TEXT_1294 = ")) result.append(eVirtualGet(";
  protected final String TEXT_1295 = ")); else result.append(\"<unset>\");";
  protected final String TEXT_1296 = NL + "\t\tif (";
  protected final String TEXT_1297 = "(";
  protected final String TEXT_1298 = " & ";
  protected final String TEXT_1299 = "_ESETFLAG) != 0";
  protected final String TEXT_1300 = "ESet";
  protected final String TEXT_1301 = ") result.append((";
  protected final String TEXT_1302 = " & ";
  protected final String TEXT_1303 = "_EFLAG) != 0); else result.append(\"<unset>\");";
  protected final String TEXT_1304 = NL + "\t\tif (";
  protected final String TEXT_1305 = "(";
  protected final String TEXT_1306 = " & ";
  protected final String TEXT_1307 = "_ESETFLAG) != 0";
  protected final String TEXT_1308 = "ESet";
  protected final String TEXT_1309 = ") result.append(";
  protected final String TEXT_1310 = "); else result.append(\"<unset>\");";
  protected final String TEXT_1311 = NL + "\t\tresult.append(eVirtualGet(";
  protected final String TEXT_1312 = ", ";
  protected final String TEXT_1313 = "));";
  protected final String TEXT_1314 = NL + "\t\tresult.append((";
  protected final String TEXT_1315 = " & ";
  protected final String TEXT_1316 = "_EFLAG) != 0);";
  protected final String TEXT_1317 = NL + "\t\tresult.append(";
  protected final String TEXT_1318 = ");";
  protected final String TEXT_1319 = NL + "\t\tresult.append(')');" + NL + "\t\treturn result.toString();" + NL + "\t}" + NL;
  protected final String TEXT_1320 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected int hash = -1;" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic int getHash()" + NL + "\t{" + NL + "\t\tif (hash == -1)" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_1321 = " theKey = getKey();" + NL + "\t\t\thash = (theKey == null ? 0 : theKey.hashCode());" + NL + "\t\t}" + NL + "\t\treturn hash;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void setHash(int hash)" + NL + "\t{" + NL + "\t\tthis.hash = hash;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_1322 = " getKey()" + NL + "\t{";
  protected final String TEXT_1323 = NL + "\t\treturn new ";
  protected final String TEXT_1324 = "(getTypedKey());";
  protected final String TEXT_1325 = NL + "\t\treturn getTypedKey();";
  protected final String TEXT_1326 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void setKey(";
  protected final String TEXT_1327 = " key)" + NL + "\t{";
  protected final String TEXT_1328 = NL + "\t\tgetTypedKey().addAll(";
  protected final String TEXT_1329 = "(";
  protected final String TEXT_1330 = ")";
  protected final String TEXT_1331 = "key);";
  protected final String TEXT_1332 = NL + "\t\tsetTypedKey(key);";
  protected final String TEXT_1333 = NL + "\t\tsetTypedKey(((";
  protected final String TEXT_1334 = ")key).";
  protected final String TEXT_1335 = "());";
  protected final String TEXT_1336 = NL + "\t\tsetTypedKey((";
  protected final String TEXT_1337 = ")key);";
  protected final String TEXT_1338 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_1339 = " getValue()" + NL + "\t{";
  protected final String TEXT_1340 = NL + "\t\treturn new ";
  protected final String TEXT_1341 = "(getTypedValue());";
  protected final String TEXT_1342 = NL + "\t\treturn getTypedValue();";
  protected final String TEXT_1343 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_1344 = " setValue(";
  protected final String TEXT_1345 = " value)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1346 = " oldValue = getValue();";
  protected final String TEXT_1347 = NL + "\t\tgetTypedValue().clear();" + NL + "\t\tgetTypedValue().addAll(";
  protected final String TEXT_1348 = "(";
  protected final String TEXT_1349 = ")";
  protected final String TEXT_1350 = "value);";
  protected final String TEXT_1351 = NL + "\t\tsetTypedValue(value);";
  protected final String TEXT_1352 = NL + "\t\tsetTypedValue(((";
  protected final String TEXT_1353 = ")value).";
  protected final String TEXT_1354 = "());";
  protected final String TEXT_1355 = NL + "\t\tsetTypedValue((";
  protected final String TEXT_1356 = ")value);";
  protected final String TEXT_1357 = NL + "\t\treturn oldValue;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_1358 = NL + "\t@SuppressWarnings(\"unchecked\")";
  protected final String TEXT_1359 = NL + "\tpublic ";
  protected final String TEXT_1360 = " getEMap()" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1361 = " container = eContainer();" + NL + "\t\treturn container == null ? null : (";
  protected final String TEXT_1362 = ")container.eGet(eContainmentFeature());" + NL + "\t}" + NL;
