...
public class Class
{
  ...
  protected final String TEXT_534 = ".add" + NL + "\t\t\t\t\t(new ";
  protected final String TEXT_535 = NL + "\t\t\t\t\t\t(";
  protected final String TEXT_536 = ".ERROR," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_537 = ".DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_538 = ".";
  protected final String TEXT_539 = "," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_540 = ".INSTANCE.getString(\"_UI_GenericInvariant_diagnostic\", new Object[] { \"";
  protected final String TEXT_541 = "\", ";
  protected final String TEXT_542 = ".getObjectLabel(this, ";
  protected final String TEXT_543 = ") }),";
  protected final String TEXT_544 = NL + "\t\t\t\t\t\t new Object [] { this }));" + NL + "\t\t\t}" + NL + "\t\t\treturn false;" + NL + "\t\t}" + NL + "\t\treturn true;";
  protected final String TEXT_545 = NL + "\t\t// TODO: implement this method" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tthrow new UnsupportedOperationException();";
  protected final String TEXT_546 = NL + "\t}" + NL;
  protected final String TEXT_547 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_548 = " eInverseAdd(";
  protected final String TEXT_549 = " otherEnd, int featureID, Class baseClass, ";
  protected final String TEXT_550 = " msgs)" + NL + "\t{" + NL + "\t\tif (featureID >= 0)" + NL + "\t\t{" + NL + "\t\t\tswitch (eDerivedStructuralFeatureID(featureID, baseClass))" + NL + "\t\t\t{";
  protected final String TEXT_551 = NL + "\t\t\t\tcase ";
  protected final String TEXT_552 = ":";
  protected final String TEXT_553 = NL + "\t\t\t\t\treturn ((";
  protected final String TEXT_554 = ")((";
  protected final String TEXT_555 = ")";
  protected final String TEXT_556 = "()).eMap()).basicAdd(otherEnd, msgs);";
  protected final String TEXT_557 = NL + "\t\t\t\t\treturn ((";
  protected final String TEXT_558 = ")";
  protected final String TEXT_559 = "()).basicAdd(otherEnd, msgs);";
  protected final String TEXT_560 = NL + "\t\t\t\t\tif (eContainer != null)" + NL + "\t\t\t\t\t\tmsgs = eBasicRemoveFromContainer(msgs);" + NL + "\t\t\t\t\treturn eBasicSetContainer(otherEnd, ";
  protected final String TEXT_561 = ", msgs);";
  protected final String TEXT_562 = NL + "\t\t\t\t\tif (";
  protected final String TEXT_563 = " != null)";
  protected final String TEXT_564 = NL + "\t\t\t\t\t\tmsgs = ((";
  protected final String TEXT_565 = ")";
  protected final String TEXT_566 = ").eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ";
  protected final String TEXT_567 = ", null, msgs);";
  protected final String TEXT_568 = NL + "\t\t\t\t\t\tmsgs = ((";
  protected final String TEXT_569 = ")";
  protected final String TEXT_570 = ").eInverseRemove(this, ";
  protected final String TEXT_571 = ", ";
  protected final String TEXT_572 = ".class, msgs);";
  protected final String TEXT_573 = NL + "\t\t\t\t\treturn basicSet";
  protected final String TEXT_574 = "((";
  protected final String TEXT_575 = ")otherEnd, msgs);";
  protected final String TEXT_576 = NL + "\t\t\t\tdefault:" + NL + "\t\t\t\t\treturn eDynamicInverseAdd(otherEnd, featureID, baseClass, msgs);" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\tif (eContainer != null)" + NL + "\t\t\tmsgs = eBasicRemoveFromContainer(msgs);" + NL + "\t\treturn eBasicSetContainer(otherEnd, featureID, msgs);" + NL + "\t}" + NL;
  protected final String TEXT_577 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_578 = " eInverseRemove(";
  protected final String TEXT_579 = " otherEnd, int featureID, Class baseClass, ";
  protected final String TEXT_580 = " msgs)" + NL + "\t{" + NL + "\t\tif (featureID >= 0)" + NL + "\t\t{" + NL + "\t\t\tswitch (eDerivedStructuralFeatureID(featureID, baseClass))" + NL + "\t\t\t{";
  protected final String TEXT_581 = NL + "\t\t\t\tcase ";
  protected final String TEXT_582 = ":";
  protected final String TEXT_583 = NL + "\t\t\t\t\treturn ((";
  protected final String TEXT_584 = ")((";
  protected final String TEXT_585 = ")";
  protected final String TEXT_586 = "()).eMap()).basicRemove(otherEnd, msgs);";
  protected final String TEXT_587 = NL + "\t\t\t\treturn ((";
  protected final String TEXT_588 = ")((";
  protected final String TEXT_589 = ")";
  protected final String TEXT_590 = "()).featureMap()).basicRemove(otherEnd, msgs);";
  protected final String TEXT_591 = NL + "\t\t\t\t\treturn ((";
  protected final String TEXT_592 = ")";
  protected final String TEXT_593 = "()).basicRemove(otherEnd, msgs);";
  protected final String TEXT_594 = NL + "\t\t\t\t\treturn eBasicSetContainer(null, ";
  protected final String TEXT_595 = ", msgs);";
  protected final String TEXT_596 = NL + "\t\t\t\t\treturn basicUnset";
  protected final String TEXT_597 = "(msgs);";
  protected final String TEXT_598 = NL + "\t\t\t\t\treturn basicSet";
  protected final String TEXT_599 = "(null, msgs);";
  protected final String TEXT_600 = NL + "\t\t\t\tdefault:" + NL + "\t\t\t\t\treturn eDynamicInverseRemove(otherEnd, featureID, baseClass, msgs);" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\treturn eBasicSetContainer(null, featureID, msgs);" + NL + "\t}" + NL;
  protected final String TEXT_601 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_602 = " eBasicRemoveFromContainer(";
  protected final String TEXT_603 = " msgs)" + NL + "\t{" + NL + "\t\tif (eContainerFeatureID >= 0)" + NL + "\t\t{" + NL + "\t\t\tswitch (eContainerFeatureID)" + NL + "\t\t\t{";
  protected final String TEXT_604 = NL + "\t\t\t\tcase ";
  protected final String TEXT_605 = ":" + NL + "\t\t\t\t\treturn eContainer.eInverseRemove(this, ";
  protected final String TEXT_606 = ", ";
  protected final String TEXT_607 = ".class, msgs);";
  protected final String TEXT_608 = NL + "\t\t\t\tdefault:" + NL + "\t\t\t\t\treturn eDynamicBasicRemoveFromContainer(msgs);" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\treturn eContainer.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - eContainerFeatureID, null, msgs);" + NL + "\t}" + NL;
  protected final String TEXT_609 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic Object eGet(";
  protected final String TEXT_610 = " eFeature, boolean resolve)" + NL + "\t{" + NL + "\t\tswitch (eDerivedStructuralFeatureID(eFeature))" + NL + "\t\t{";
  protected final String TEXT_611 = NL + "\t\t\tcase ";
  protected final String TEXT_612 = ":";
  protected final String TEXT_613 = NL + "\t\t\t\treturn ";
  protected final String TEXT_614 = "() ? Boolean.TRUE : Boolean.FALSE;";
  protected final String TEXT_615 = NL + "\t\t\t\treturn new ";
  protected final String TEXT_616 = "(";
  protected final String TEXT_617 = "());";
  protected final String TEXT_618 = NL + "\t\t\t\tif (resolve) return ";
  protected final String TEXT_619 = "();" + NL + "\t\t\t\treturn basicGet";
  protected final String TEXT_620 = "();";
  protected final String TEXT_621 = NL + "\t\t\t\treturn ((";
  protected final String TEXT_622 = ")";
  protected final String TEXT_623 = "()).eMap();";
  protected final String TEXT_624 = NL + "\t\t\t\treturn ((";
  protected final String TEXT_625 = ")";
  protected final String TEXT_626 = "()).featureMap();";
  protected final String TEXT_627 = NL + "\t\t\t\treturn ";
  protected final String TEXT_628 = "();";
  protected final String TEXT_629 = NL + "\t\t}" + NL + "\t\treturn eDynamicGet(eFeature, resolve);" + NL + "\t}" + NL;
  protected final String TEXT_630 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void eSet(";
  protected final String TEXT_631 = " eFeature, Object newValue)" + NL + "\t{" + NL + "\t\tswitch (eDerivedStructuralFeatureID(eFeature))" + NL + "\t\t{";
  protected final String TEXT_632 = NL + "\t\t\tcase ";
  protected final String TEXT_633 = ":";
  protected final String TEXT_634 = NL + "\t\t\t\t((";
  protected final String TEXT_635 = ")";
  protected final String TEXT_636 = "()).featureMap().clear();";
  protected final String TEXT_637 = NL + "\t\t\t\t";
  protected final String TEXT_638 = "().clear();";
  protected final String TEXT_639 = NL + "\t\t\t\t((";
  protected final String TEXT_640 = ")";
  protected final String TEXT_641 = "()).featureMap().addAll((";
  protected final String TEXT_642 = ")newValue);";
  protected final String TEXT_643 = NL + "\t\t\t\t((";
  protected final String TEXT_644 = ")";
  protected final String TEXT_645 = "()).eMap().addAll((";
  protected final String TEXT_646 = ")newValue);";
  protected final String TEXT_647 = NL + "\t\t\t\t";
  protected final String TEXT_648 = "().addAll((";
  protected final String TEXT_649 = ")newValue);";
  protected final String TEXT_650 = NL + "\t\t\t\tset";
  protected final String TEXT_651 = "(((";
  protected final String TEXT_652 = ")newValue).";
  protected final String TEXT_653 = "());";
  protected final String TEXT_654 = NL + "\t\t\t\tset";
  protected final String TEXT_655 = "((";
  protected final String TEXT_656 = ")newValue);";
  protected final String TEXT_657 = NL + "\t\t\t\treturn;";
  protected final String TEXT_658 = NL + "\t\t}" + NL + "\t\teDynamicSet(eFeature, newValue);" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void eUnset(";
  protected final String TEXT_659 = " eFeature)" + NL + "\t{" + NL + "\t\tswitch (eDerivedStructuralFeatureID(eFeature))" + NL + "\t\t{";
  protected final String TEXT_660 = NL + "\t\t\tcase ";
  protected final String TEXT_661 = ":";
  protected final String TEXT_662 = NL + "\t\t\t\t((";
  protected final String TEXT_663 = ")";
  protected final String TEXT_664 = "()).featureMap().clear();";
  protected final String TEXT_665 = NL + "\t\t\t\t";
  protected final String TEXT_666 = "().clear();";
  protected final String TEXT_667 = NL + "\t\t\t\tunset";
  protected final String TEXT_668 = "();";
  protected final String TEXT_669 = NL + "\t\t\t\tset";
  protected final String TEXT_670 = "((";
  protected final String TEXT_671 = ")null);";
  protected final String TEXT_672 = NL + "\t\t\t\tset";
  protected final String TEXT_673 = "(";
  protected final String TEXT_674 = "_EDEFAULT);";
  protected final String TEXT_675 = NL + "\t\t\t\treturn;";
  protected final String TEXT_676 = NL + "\t\t}" + NL + "\t\teDynamicUnset(eFeature);" + NL + "\t}" + NL;
  protected final String TEXT_677 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic boolean eIsSet(";
  protected final String TEXT_678 = " eFeature)" + NL + "\t{" + NL + "\t\tswitch (eDerivedStructuralFeatureID(eFeature))" + NL + "\t\t{";
  protected final String TEXT_679 = NL + "\t\t\tcase ";
  protected final String TEXT_680 = ":";
  protected final String TEXT_681 = NL + "\t\t\t\treturn !((";
  protected final String TEXT_682 = ")";
  protected final String TEXT_683 = "()).featureMap().isEmpty();";
  protected final String TEXT_684 = NL + "\t\t\t\treturn ";
  protected final String TEXT_685 = " != null && !";
  protected final String TEXT_686 = ".featureMap().isEmpty();";
  protected final String TEXT_687 = NL + "\t\t\t\treturn !";
  protected final String TEXT_688 = "().isEmpty();";
  protected final String TEXT_689 = NL + "\t\t\t\treturn ";
  protected final String TEXT_690 = " != null && !";
  protected final String TEXT_691 = ".isEmpty();";
  protected final String TEXT_692 = NL + "\t\t\t\treturn isSet";
  protected final String TEXT_693 = "();";
  protected final String TEXT_694 = NL + "\t\t\t\treturn basicGet";
  ...
  protected final String TEXT_704 = "_EDEFAULT;";
  protected final String TEXT_705 = NL + "\t\t\t\treturn ";
  protected final String TEXT_706 = " != ";
  protected final String TEXT_707 = "_EDEFAULT;";
  protected final String TEXT_708 = NL + "\t\t\t\treturn ";
  protected final String TEXT_709 = "_EDEFAULT == null ? ";
  protected final String TEXT_710 = "() != null : !";
  protected final String TEXT_711 = "_EDEFAULT.equals(";
  protected final String TEXT_712 = "());";
  protected final String TEXT_713 = NL + "\t\t\t\treturn ";
  protected final String TEXT_714 = "_EDEFAULT == null ? ";
  protected final String TEXT_715 = " != null : !";
  protected final String TEXT_716 = "_EDEFAULT.equals(";
  protected final String TEXT_717 = ");";
  protected final String TEXT_718 = NL + "\t\t}" + NL + "\t\treturn eDynamicIsSet(eFeature);" + NL + "\t}" + NL;
  protected final String TEXT_719 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic int eBaseStructuralFeatureID(int derivedFeatureID, Class baseClass)" + NL + "\t{";
  protected final String TEXT_720 = NL + "\t\tif (baseClass == ";
  protected final String TEXT_721 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (derivedFeatureID)" + NL + "\t\t\t{";
  protected final String TEXT_722 = NL + "\t\t\t\tcase ";
  protected final String TEXT_723 = ": return ";
  protected final String TEXT_724 = ";";
  protected final String TEXT_725 = NL + "\t\t\t\tdefault: return -1;" + NL + "\t\t\t}" + NL + "\t\t}";
  protected final String TEXT_726 = NL + "\t\treturn super.eBaseStructuralFeatureID(derivedFeatureID, baseClass);" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic int eDerivedStructuralFeatureID(int baseFeatureID, Class baseClass)" + NL + "\t{";
  protected final String TEXT_727 = NL + "\t\tif (baseClass == ";
  protected final String TEXT_728 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (baseFeatureID)" + NL + "\t\t\t{";
  protected final String TEXT_729 = NL + "\t\t\t\tcase ";
  protected final String TEXT_730 = ": return ";
  protected final String TEXT_731 = ";";
  protected final String TEXT_732 = NL + "\t\t\t\tdefault: return -1;" + NL + "\t\t\t}" + NL + "\t\t}";
  protected final String TEXT_733 = NL + "\t\treturn super.eDerivedStructuralFeatureID(baseFeatureID, baseClass);" + NL + "\t}" + NL;
  protected final String TEXT_734 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic String toString()" + NL + "\t{" + NL + "\t\tif (eIsProxy()) return super.toString();" + NL + "" + NL + "\t\tStringBuffer result = new StringBuffer(super.toString());";
  ...
  protected final String TEXT_740 = "ESet) result.append(";
  protected final String TEXT_741 = "); else result.append(\"<unset>\");";
  protected final String TEXT_742 = NL + "\t\tresult.append(";
  protected final String TEXT_743 = ");";
  protected final String TEXT_744 = NL + "\t\tresult.append(')');" + NL + "\t\treturn result.toString();" + NL + "\t}" + NL;
  protected final String TEXT_745 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected int hash = -1;" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic int getHash()" + NL + "\t{" + NL + "\t\tif (hash == -1)" + NL + "\t\t{" + NL + "\t\t\tObject theKey = getKey();" + NL + "\t\t\thash = (theKey == null ? 0 : theKey.hashCode());" + NL + "\t\t}" + NL + "\t\treturn hash;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void setHash(int hash)" + NL + "\t{" + NL + "\t\tthis.hash = hash;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic Object getKey()" + NL + "\t{";
  protected final String TEXT_746 = NL + "\t\treturn new ";
  protected final String TEXT_747 = "(getTypedKey());";
  protected final String TEXT_748 = NL + "\t\treturn getTypedKey();";
  protected final String TEXT_749 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void setKey(Object key)" + NL + "\t{";
  protected final String TEXT_750 = NL + "\t\tgetTypedKey().addAll((";
  protected final String TEXT_751 = ")key);";
  protected final String TEXT_752 = NL + "\t\tsetTypedKey(((";
  protected final String TEXT_753 = ")key).";
  protected final String TEXT_754 = "());";
  protected final String TEXT_755 = NL + "\t\tsetTypedKey((";
  protected final String TEXT_756 = ")key);";
  protected final String TEXT_757 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic Object getValue()" + NL + "\t{";
  protected final String TEXT_758 = NL + "\t\treturn new ";
  protected final String TEXT_759 = "(getTypedValue());";
  protected final String TEXT_760 = NL + "\t\treturn getTypedValue();";
  protected final String TEXT_761 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic Object setValue(Object value)" + NL + "\t{" + NL + "\t\tObject oldValue = getValue();";
  protected final String TEXT_762 = NL + "\t\tgetTypedValue().clear();" + NL + "\t\tgetTypedValue().addAll((";
  protected final String TEXT_763 = ")value);";
  protected final String TEXT_764 = NL + "\t\tsetTypedValue(((";
  protected final String TEXT_765 = ")value).";
  protected final String TEXT_766 = "());";
  protected final String TEXT_767 = NL + "\t\tsetTypedValue((";
  protected final String TEXT_768 = ")value);";
  protected final String TEXT_769 = NL + "\t\treturn oldValue;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_770 = " getEMap()" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_771 = " container = eContainer();" + NL + "\t\treturn container == null ? null : (";
  protected final String TEXT_772 = ")container.eGet(eContainmentFeature());" + NL + "\t}" + NL;
