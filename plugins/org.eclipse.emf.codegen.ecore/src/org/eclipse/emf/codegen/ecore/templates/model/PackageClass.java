...
public class PackageClass
{
  ...
  protected final String TEXT_153 = ".class";
  protected final String TEXT_154 = ", \"";
  protected final String TEXT_155 = "\", ";
  protected final String TEXT_156 = ", ";
  protected final String TEXT_157 = ", ";
  protected final String TEXT_158 = ");";
  protected final String TEXT_159 = NL + "\t\tinitEReference(get";
  ...
  protected final String TEXT_178 = NL + "\t\tinitEAttribute(get";
  ...
  protected final String TEXT_203 = "addEOperation(";
  protected final String TEXT_204 = ", null, \"";
  protected final String TEXT_205 = "\");";
  protected final String TEXT_206 = NL + "\t\taddEParameter(op, ";
  protected final String TEXT_207 = ".get";
  protected final String TEXT_208 = "(), \"";
  protected final String TEXT_209 = "\");";
  protected final String TEXT_210 = NL + "\t\taddEException(op, ";
  protected final String TEXT_211 = ".get";
  protected final String TEXT_212 = "());";
  protected final String TEXT_213 = NL;
  protected final String TEXT_214 = NL + NL + "\t\t// Initialize enums and add enum literals";
  protected final String TEXT_215 = NL + "\t\tinitEEnum(";
  protected final String TEXT_216 = ", ";
  protected final String TEXT_217 = ".class, \"";
  protected final String TEXT_218 = "\");";
  protected final String TEXT_219 = NL + "\t\taddEEnumLiteral(";
  protected final String TEXT_220 = ", ";
  protected final String TEXT_221 = ".";
  protected final String TEXT_222 = "_LITERAL);";
  protected final String TEXT_223 = NL;
  protected final String TEXT_224 = NL + NL + "\t\t// Initialize data types";
  protected final String TEXT_225 = NL + "\t\tinitEDataType(";
  protected final String TEXT_226 = ", ";
  protected final String TEXT_227 = ".class, \"";
  protected final String TEXT_228 = "\", ";
  protected final String TEXT_229 = ", ";
  protected final String TEXT_230 = ");";
  protected final String TEXT_231 = NL + NL + "\t\t// Create resource" + NL + "\t\tcreateResource(eNS_URI);";
  protected final String TEXT_232 = NL + NL + "\t\t// Create annotations";
  protected final String TEXT_233 = NL + "\t\t// ";
  protected final String TEXT_234 = NL + "\t\tcreate";
  protected final String TEXT_235 = "Annotations();";
  protected final String TEXT_236 = NL + "\t}" + NL;
  protected final String TEXT_237 = NL + "\t/**" + NL + "\t * Initializes the annotations for <b>";
  protected final String TEXT_238 = "</b>." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected void create";
  protected final String TEXT_239 = "Annotations()" + NL + "\t{" + NL + "\t\tString source = ";
  protected final String TEXT_240 = "null;";
  protected final String TEXT_241 = "\"";
  protected final String TEXT_242 = "\";";
  protected final String TEXT_243 = "\t";
  protected final String TEXT_244 = "\t" + NL + "\t\taddAnnotation" + NL + "\t\t  (";
  protected final String TEXT_245 = ", " + NL + "\t\t   source, " + NL + "\t\t   new String[] " + NL + "\t\t   {";
  protected final String TEXT_246 = NL + "\t\t\t ";
  protected final String TEXT_247 = ", ";
  protected final String TEXT_248 = NL + "\t\t   });";
  protected final String TEXT_249 = NL + "\t}" + NL;
  protected final String TEXT_250 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isLoaded = false;" + NL + "" + NL + "\t/**" + NL + "\t * Laods the package and any sub-packages from their serialized form." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void loadPackage()" + NL + "\t{" + NL + "\t\tif (isLoaded) return;" + NL + "\t\tisLoaded = true;" + NL + "" + NL + "\t\t";
  protected final String TEXT_251 = " url = getClass().getResource(packageFilename);" + NL + "\t\tif (url == null)" + NL + "\t\t{" + NL + "\t\t\tthrow new RuntimeException(\"Missing serialized package: \" + packageFilename);";
  protected final String TEXT_252 = NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_253 = " uri = ";
  protected final String TEXT_254 = ".createURI(url.toString());" + NL + "\t\t";
  protected final String TEXT_255 = " resource = new ";
  protected final String TEXT_256 = "().createResource(uri);" + NL + "\t\ttry" + NL + "\t\t{" + NL + "\t\t\tresource.load(null);" + NL + "\t\t}" + NL + "\t\tcatch (";
  protected final String TEXT_257 = " exception)" + NL + "\t\t{" + NL + "\t\t\tthrow new ";
  protected final String TEXT_258 = "(exception);" + NL + "\t\t}" + NL + "\t\tinitializeFromLoadedEPackage(this, (";
  protected final String TEXT_259 = ")resource.getContents().get(0));" + NL + "\t\tcreateResource(eNS_URI);" + NL + "\t}" + NL;
  protected final String TEXT_260 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isFixed = false;" + NL + "" + NL + "\t/**" + NL + "\t * Fixes up the loaded package, to make it appear as if it had been programmatically built." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void fixPackageContents()" + NL + "\t{" + NL + "\t\tif (isFixed) return;" + NL + "\t\tisFixed = true;" + NL + "\t\tfixEClassifiers();" + NL + "\t}";
