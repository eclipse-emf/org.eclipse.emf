...
public class PackageClass
{
  ...
  protected final String TEXT_55 = NL + NL + "\t\treturn the";
  protected final String TEXT_56 = ";" + NL + "\t}" + NL;
  protected final String TEXT_57 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_58 = " get";
  protected final String TEXT_59 = "()" + NL + "\t{" + NL + "\t\treturn ";
  protected final String TEXT_60 = ";" + NL + "\t}" + NL;
  protected final String TEXT_61 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_62 = " get";
  protected final String TEXT_63 = "()" + NL + "\t{" + NL + "\t\treturn (";
  protected final String TEXT_64 = ")";
  protected final String TEXT_65 = ".getEStructuralFeatures().get(";
  protected final String TEXT_66 = ");" + NL + "\t}" + NL;
  protected final String TEXT_67 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_68 = " get";
  protected final String TEXT_69 = "()" + NL + "\t{" + NL + "\t\treturn (";
  protected final String TEXT_70 = ")getEFactoryInstance();" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isCreated = false;" + NL + "" + NL + "\t/**" + NL + "\t * Creates the meta-model objects for the package.  This method is" + NL + "\t * guarded to have no affect on any invocation but its first." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void createPackageContents()" + NL + "\t{" + NL + "\t\tif (isCreated) return;" + NL + "\t\tisCreated = true;";
  protected final String TEXT_71 = NL + NL + "\t\t// Create classes and their features";
  protected final String TEXT_72 = NL + "\t\t";
  protected final String TEXT_73 = " = create";
  protected final String TEXT_74 = "(";
  protected final String TEXT_75 = ");";
  protected final String TEXT_76 = NL + "\t\tcreate";
  protected final String TEXT_77 = "(";
  protected final String TEXT_78 = ", ";
  protected final String TEXT_79 = ");";
  protected final String TEXT_80 = NL;
  protected final String TEXT_81 = NL + NL + "\t\t// Create enums";
  protected final String TEXT_82 = NL + "\t\t";
  protected final String TEXT_83 = " = createEEnum(";
  protected final String TEXT_84 = ");";
  protected final String TEXT_85 = NL + NL + "\t\t// Create data types";
  protected final String TEXT_86 = NL + "\t\t";
  protected final String TEXT_87 = " = createEDataType(";
  protected final String TEXT_88 = ");";
  protected final String TEXT_89 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isInitialized = false;" + NL + "" + NL + "\t/**" + NL + "\t * Complete the initialization of the package and its meta-model.  This" + NL + "\t * method is guarded to have no affect on any invocation but its first." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void initializePackageContents()" + NL + "\t{" + NL + "\t\tif (isInitialized) return;" + NL + "\t\tisInitialized = true;" + NL + "" + NL + "\t\t// Initialize package" + NL + "\t\tsetName(eNAME);" + NL + "\t\tsetNsPrefix(eNS_PREFIX);" + NL + "\t\tsetNsURI(eNS_URI);";
  protected final String TEXT_90 = NL + NL + "\t\t// Obtain other dependent packages";
  protected final String TEXT_91 = NL + "\t\t";
  protected final String TEXT_92 = " ";
  protected final String TEXT_93 = " = (";
  protected final String TEXT_94 = ")";
  protected final String TEXT_95 = ".Registry.INSTANCE.getEPackage(";
  protected final String TEXT_96 = ".eNS_URI);";
  protected final String TEXT_97 = NL + NL + "\t\t// Add subpackages";
  protected final String TEXT_98 = NL + "\t\tgetESubpackages().add(";
  protected final String TEXT_99 = ");";
  protected final String TEXT_100 = NL + NL + "\t\t// Add supertypes to classes";
  protected final String TEXT_101 = NL + "\t\t";
  protected final String TEXT_102 = ".getESuperTypes().add(";
  protected final String TEXT_103 = ".get";
  protected final String TEXT_104 = "());";
  protected final String TEXT_105 = NL + NL + "\t\t// Initialize classes and features; add operations and parameters";
  protected final String TEXT_106 = NL + "\t\tinitEClass(";
  protected final String TEXT_107 = ", ";
  protected final String TEXT_108 = ".class, \"";
  protected final String TEXT_109 = "\", ";
  protected final String TEXT_110 = ", ";
  protected final String TEXT_111 = ");";
  protected final String TEXT_112 = NL + "\t\tinitEReference(get";
  ...
  protected final String TEXT_129 = NL + "\t\tinitEAttribute(get";
  ...
  protected final String TEXT_146 = "addEOperation(";
  protected final String TEXT_147 = ", ";
  protected final String TEXT_148 = ".get";
  protected final String TEXT_149 = "(), \"";
  protected final String TEXT_150 = "\");";
  protected final String TEXT_151 = NL + "\t\t";
  protected final String TEXT_152 = "addEOperation(";
  protected final String TEXT_153 = ", null, \"";
  protected final String TEXT_154 = "\");";
  protected final String TEXT_155 = NL + "\t\taddEParameter(op, ";
  protected final String TEXT_156 = ".get";
  protected final String TEXT_157 = "(), \"";
  protected final String TEXT_158 = "\");";
  protected final String TEXT_159 = NL + "\t\taddEException(op, ";
  protected final String TEXT_160 = ".get";
  protected final String TEXT_161 = "());";
  protected final String TEXT_162 = NL;
  protected final String TEXT_163 = NL + NL + "\t\t// Initialize enums and add enum literals";
  protected final String TEXT_164 = NL + "\t\tinitEEnum(";
  protected final String TEXT_165 = ", ";
  protected final String TEXT_166 = ".class, \"";
  protected final String TEXT_167 = "\");";
  protected final String TEXT_168 = NL + "\t\taddEEnumLiteral(";
  protected final String TEXT_169 = ", ";
  protected final String TEXT_170 = ".";
  protected final String TEXT_171 = "_LITERAL);";
  protected final String TEXT_172 = NL;
  protected final String TEXT_173 = NL + NL + "\t\t// Initialize data types";
  protected final String TEXT_174 = NL + "\t\tinitEDataType(";
  protected final String TEXT_175 = ", ";
  protected final String TEXT_176 = ".class, \"";
  protected final String TEXT_177 = "\", ";
  protected final String TEXT_178 = ");";
  protected final String TEXT_179 = NL + NL + "\t\t// Create resource" + NL + "\t\tcreateResource(eNS_URI);";
  protected final String TEXT_180 = NL + NL + "\t\t// Create annotations";
  protected final String TEXT_181 = NL + "\t\t// ";
  protected final String TEXT_182 = NL + "\t\tcreate";
  protected final String TEXT_183 = "Annotations();";
  protected final String TEXT_184 = NL + "\t}";
  protected final String TEXT_185 = NL + NL + "\t/**" + NL + "\t * Initializes the annotations for <b>";
  protected final String TEXT_186 = "</b>." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected void create";
  protected final String TEXT_187 = "Annotations()" + NL + "\t{" + NL + "\t\tString source = ";
  protected final String TEXT_188 = "null;";
  protected final String TEXT_189 = "\"";
  protected final String TEXT_190 = "\";";
  protected final String TEXT_191 = "\t";
  protected final String TEXT_192 = "\t" + NL + "\t\taddAnnotation" + NL + "\t\t  (";
  protected final String TEXT_193 = ", " + NL + "\t\t   source, " + NL + "\t\t   new String[] " + NL + "\t\t   {";
