...
public class Plugin
{
  ...
  protected final String TEXT_32 = NL + "\t{" + NL + "\t\t/**" + NL + "\t\t * Creates an instance." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
  protected final String TEXT_33 = NL + "\t\t * @param descriptor the description of the plugin.";
  protected final String TEXT_34 = NL + "\t\t * @generated" + NL + "\t\t */" + NL + "\t\tpublic Implementation(";
  protected final String TEXT_35 = " descriptor";
  protected final String TEXT_36 = ")" + NL + "\t\t{" + NL + "\t\t\tsuper(";
  protected final String TEXT_37 = "descriptor";
  protected final String TEXT_38 = ");" + NL + "\t" + NL + "\t\t\t// Remember the static instance." + NL + "\t\t\t//" + NL + "\t\t\tplugin = this;" + NL + "\t\t}" + NL + "\t}" + NL;
