...
public class ModelWizard
{
  ...
  protected final String TEXT_52 = "()" + NL + "\t\t\t{" + NL + "\t\t\t\tpublic void run(IProgressMonitor progressMonitor)";
  ...
  protected final String TEXT_109 = ".getEClassifiers().iterator(); classifier.hasNext(); )" + NL + "\t\t\t{" + NL + "\t\t\t\tEClassifier eClassifier = (EClassifier)classifier.next();" + NL + "\t\t\t\tif (eClassifier instanceof EClass)" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\tEClass eClass = (EClass)eClassifier;" + NL + "\t\t\t\t\tif (!eClass.isAbstract())" + NL + "\t\t\t\t\t{" + NL + "\t\t\t\t\t\tobjectNames.add(getLabel(eClass));" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  ...
  protected final String TEXT_115 = ")elements.next();" + NL + "\t\t\t\tEClassifier eClassifier = eStructuralFeature.getEType();" + NL + "\t\t\t\tif (eClassifier instanceof EClass)" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\tEClass eClass = (EClass)eClassifier;" + NL + "\t\t\t\t\tif (!eClass.isAbstract())" + NL + "\t\t\t\t\t{" + NL + "\t\t\t\t\t\tobjectNames.add(getLabel(eStructuralFeature));" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  ...
  protected final String TEXT_126 = NL + "\t\t\t\tfor (Iterator classifier = ";
  protected final String TEXT_127 = ".getEClassifiers().iterator(); classifier.hasNext(); )" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\tEClassifier eClassifier = (EClassifier)classifier.next();" + NL + "\t\t\t\t\tif (eClassifier instanceof EClass)" + NL + "\t\t\t\t\t{" + NL + "\t\t\t\t\t\tEClass eClass = (EClass)eClassifier;" + NL + "\t\t\t\t\t\tif (!eClass.isAbstract() && getLabel(eClass).equals(label))" + NL + "\t\t\t\t\t\t{" + NL + "\t\t\t\t\t\t\treturn eClass.getName();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}";
  protected final String TEXT_128 = NL + "\t\t\t\tfor (Iterator elements = ";
  protected final String TEXT_129 = ".INSTANCE.getAllElements(";
  protected final String TEXT_130 = ".INSTANCE.getDocumentRoot(";
  protected final String TEXT_131 = ")).iterator(); elements.hasNext(); )" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\t";
  protected final String TEXT_132 = " eStructuralFeature = (";
  protected final String TEXT_133 = ")elements.next();" + NL + "\t\t\t\t\tEClassifier eClassifier = eStructuralFeature.getEType();" + NL + "\t\t\t\t\tif (eClassifier instanceof EClass)" + NL + "\t\t\t\t\t{" + NL + "\t\t\t\t\t\tEClass eClass = (EClass)eClassifier;" + NL + "\t\t\t\t\t\tif (!eClass.isAbstract() && getLabel(eStructuralFeature).equals(label))" + NL + "\t\t\t\t\t\t{" + NL + "\t\t\t\t\t\t\treturn eStructuralFeature.getName();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}";
  protected final String TEXT_134 = NL + "\t\t\t\treturn label;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "" + NL + "\t\t/**" + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL + "\t\t */" + NL + "\t\tpublic String getEncoding()" + NL + "\t\t{" + NL + "\t\t\treturn" + NL + "\t\t\t\tencoding == null ?" + NL + "\t\t\t\t\tencodingField.getText() :" + NL + "\t\t\t\t\tencoding;" + NL + "\t\t}";
  protected final String TEXT_135 = NL + NL + "\t\t/**" + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL + "\t\t */" + NL + "\t\tpublic URI getFileURI()" + NL + "\t\t{" + NL + "\t\t\treturn fileField == null ? fileURI : URI.createFileURI(fileField.getText());" + NL + "\t\t}" + NL + "" + NL + "\t\t/**" + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL + "\t\t */" + NL + "\t\tpublic void selectFileField()" + NL + "\t\t{" + NL + "\t\t\tif (fileField != null)" + NL + "\t\t\t{" + NL + "\t\t\t\tfileField.selectAll();" + NL + "\t\t\t\tfileField.setFocus();" + NL + "\t\t\t}" + NL + "\t\t}\t\t";
  protected final String TEXT_136 = NL + "\t\t/**" + NL + "\t\t * Returns the label of the specified element." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL + "\t\t */";
  protected final String TEXT_137 = NL + "\t\tprotected String getLabel(EClass eClass)" + NL + "\t\t{" + NL + "\t\t\tString name = eClass.getName();" + NL + "\t\t\ttry" + NL + "\t\t\t{" + NL + "\t\t\t\treturn ";
  protected final String TEXT_138 = ".INSTANCE.getString(\"_UI_\" + name + \"_type\");" + NL + "\t\t\t}" + NL + "\t\t\tcatch(MissingResourceException mre)" + NL + "\t\t\t{" + NL + "\t\t\t}" + NL + "\t\t\treturn name;" + NL + "\t\t}";
  protected final String TEXT_139 = NL + "\t\tprotected String getLabel(EStructuralFeature eStructuralFeature)" + NL + "\t\t{" + NL + "\t\t\tString name = eStructuralFeature.getName();" + NL + "\t\t\ttry" + NL + "\t\t\t{" + NL + "\t\t\t\treturn ";
  protected final String TEXT_140 = ".INSTANCE.getString(\"_UI_\" + name + \"_feature\");" + NL + "\t\t\t}" + NL + "\t\t\tcatch(MissingResourceException mre)" + NL + "\t\t\t{" + NL + "\t\t\t}" + NL + "\t\t\treturn name;" + NL + "\t\t}";
  protected final String TEXT_141 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * The framework calls this to create the contents of the wizard." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void addPages()" + NL + "\t{";
  protected final String TEXT_142 = NL + "\t\t// Create a page, set the title, and the initial model file name." + NL + "\t\t//" + NL + "\t\tnewFileCreationPage = new ";
  protected final String TEXT_143 = "NewFileCreationPage(\"Whatever\", selection);";
  protected final String TEXT_144 = NL + "\t\tnewFileCreationPage.setTitle(";
  protected final String TEXT_145 = ".INSTANCE.getString(\"_UI_";
  protected final String TEXT_146 = "_label\"));";
  protected final String TEXT_147 = NL + "\t\tnewFileCreationPage.setDescription(";
  protected final String TEXT_148 = ".INSTANCE.getString(\"_UI_";
  protected final String TEXT_149 = "_description\"));";
  protected final String TEXT_150 = NL + "\t\tnewFileCreationPage.setFileName(";
  protected final String TEXT_151 = ".INSTANCE.getString(\"_UI_";
  protected final String TEXT_152 = "FilenameDefaultBase\") + \".\" + ";
  protected final String TEXT_153 = ".INSTANCE.getString(\"_UI_";
  protected final String TEXT_154 = "FilenameExtension\"));";
  protected final String TEXT_155 = NL + "\t\taddPage(newFileCreationPage);" + NL + "" + NL + "\t\t// Try and get the resource selection to determine a current directory for the file dialog." + NL + "\t\t//" + NL + "\t\tif (selection != null && !selection.isEmpty())" + NL + "\t\t{" + NL + "\t\t\t// Get the resource..." + NL + "\t\t\t//" + NL + "\t\t\tObject selectedElement = selection.iterator().next();" + NL + "\t\t\tif (selectedElement instanceof IResource)" + NL + "\t\t\t{" + NL + "\t\t\t\t// Get the resource parent, if its a file." + NL + "\t\t\t\t//" + NL + "\t\t\t\tIResource selectedResource = (IResource)selectedElement;" + NL + "\t\t\t\tif (selectedResource.getType() == IResource.FILE)" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\tselectedResource = selectedResource.getParent();" + NL + "\t\t\t\t}" + NL + "" + NL + "\t\t\t\t// This gives us a directory..." + NL + "\t\t\t\t//" + NL + "\t\t\t\tif (selectedResource instanceof IFolder || selectedResource instanceof IProject)" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\t// Set this for the container." + NL + "\t\t\t\t\t//" + NL + "\t\t\t\t\tnewFileCreationPage.setContainerFullPath(selectedResource.getFullPath());" + NL + "" + NL + "\t\t\t\t\t// Make up a unique new name here." + NL + "\t\t\t\t\t//" + NL + "\t\t\t\t\tString defaultModelBaseFilename = ";
  protected final String TEXT_156 = ".INSTANCE.getString(\"_UI_";
  protected final String TEXT_157 = "FilenameDefaultBase\");";
  protected final String TEXT_158 = NL + "\t\t\t\t\tString defaultModelFilenameExtension = ";
  protected final String TEXT_159 = ".INSTANCE.getString(\"_UI_";
  protected final String TEXT_160 = "FilenameExtension\");";
  protected final String TEXT_161 = NL + "\t\t\t\t\tString modelFilename = defaultModelBaseFilename + \".\" + defaultModelFilenameExtension;";
  protected final String TEXT_162 = NL + "\t\t\t\t\tfor (int i = 1; ((IContainer)selectedResource).findMember(modelFilename) != null; ++i)" + NL + "\t\t\t\t\t{" + NL + "\t\t\t\t\t\tmodelFilename = defaultModelBaseFilename + i + \".\" + defaultModelFilenameExtension;";
  protected final String TEXT_163 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tnewFileCreationPage.setFileName(modelFilename);" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}";
  protected final String TEXT_164 = NL + "\t\tinitialObjectCreationPage = new ";
  protected final String TEXT_165 = "InitialObjectCreationPage(\"Whatever2\");";
  protected final String TEXT_166 = NL + "\t\tinitialObjectCreationPage.setTitle(";
  protected final String TEXT_167 = ".INSTANCE.getString(\"_UI_";
  protected final String TEXT_168 = "_label\"));";
  protected final String TEXT_169 = NL + "\t\tinitialObjectCreationPage.setDescription(";
  protected final String TEXT_170 = ".INSTANCE.getString(\"_UI_Wizard_initial_object_description\"));";
  protected final String TEXT_171 = NL + "\t\taddPage(initialObjectCreationPage);" + NL + "\t}" + NL;
  protected final String TEXT_172 = NL + "\t\t/**" + NL + "\t\t * Get the URI from the page." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL + "\t\t*/" + NL + "\t\tpublic URI getModelURI()" + NL + "\t\t{" + NL + "\t\t\treturn initialObjectCreationPage.getFileURI();" + NL + "\t\t}" + NL;
  protected final String TEXT_173 = NL + "\t/**" + NL + "\t * Get the file from the page." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic IFile getModelFile()" + NL + "\t{" + NL + "\t\treturn newFileCreationPage.getModelFile();" + NL + "\t}" + NL;
