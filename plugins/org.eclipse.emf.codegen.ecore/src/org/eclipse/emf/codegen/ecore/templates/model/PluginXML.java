...
public class PluginXML
{
  ...
  protected final String TEXT_17 = NL + "      <export name=\"*\"/>" + NL + "    </library>" + NL + "  </runtime>";
  protected final String TEXT_18 = NL + NL + "  <extension point=\"org.eclipse.emf.ecore.generated_package\">" + NL + "    <package " + NL + "       uri = \"";
  protected final String TEXT_19 = "\" " + NL + "       class = \"";
  protected final String TEXT_20 = "\" />" + NL + "  </extension>";
  protected final String TEXT_21 = NL + NL + "  <extension point=\"org.eclipse.emf.ecore.extension_parser\">" + NL + "    <parser " + NL + "       type=\"";
  protected final String TEXT_22 = "\" " + NL + "       class=\"";
  protected final String TEXT_23 = "\" />" + NL + "  </extension>";
  protected final String TEXT_24 = NL + NL + "</plugin>" + NL;
