...
public class PluginXML
{
  ...
  protected final String TEXT_30 = NL + NL + "   <extension point=\"org.eclipse.emf.ecore.content_parser\">" + NL + "      <parser" + NL + "            contentTypeIdentifier=\"";
  protected final String TEXT_31 = "\"" + NL + "            class=\"";
  protected final String TEXT_32 = "\"/>" + NL + "   </extension>" + NL + "" + NL + "   <extension point=\"org.eclipse.core.contenttype.contentTypes\">" + NL + "      <content-type" + NL + "            base-type=\"";
  protected final String TEXT_33 = "\"" + NL + "            file-extensions=\"";
  protected final String TEXT_34 = "\"" + NL + "            id=\"";
  protected final String TEXT_35 = "\"" + NL + "            name=\"%_UI_";
  protected final String TEXT_36 = "_content_type\"" + NL + "            priority=\"normal\">" + NL + "         <describer class=\"org.eclipse.emf.ecore.xmi.impl.RootXMLContentHandlerImpl$Describer\">";
  protected final String TEXT_37 = NL + "            <parameter name=\"namespace\" value=\"";
  protected final String TEXT_38 = "\"/>";
  protected final String TEXT_39 = NL + "            <parameter name=\"kind\" value=\"xmi\"/>";
  protected final String TEXT_40 = NL + "         </describer>" + NL + "      </content-type>" + NL + "   </extension>";
