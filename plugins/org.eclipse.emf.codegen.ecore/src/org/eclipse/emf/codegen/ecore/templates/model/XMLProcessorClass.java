...
public class XMLProcessorClass
{
  ...
  protected final String TEXT_17 = NL + NL + "\t/**" + NL + "\t * Public constructor to instantiate the helper." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_18 = "()" + NL + "\t{";
  protected final String TEXT_19 = NL + "\t\tsuper(new ";
  ...
  protected final String TEXT_24 = ".Registry.INSTANCE));" + NL + "\t\t";
  protected final String TEXT_25 = ".eINSTANCE.eClass();";
  protected final String TEXT_26 = NL + "\t}" + NL + "\t" + NL + "\t/**" + NL + "\t * Register for \"*\" and \"xml\" file extensions the ";
  protected final String TEXT_27 = " factory." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_28 = NL + "\t@Override";
  protected final String TEXT_29 = NL + "\tprotected Map";
  protected final String TEXT_30 = "<";
  protected final String TEXT_31 = ", ";
  protected final String TEXT_32 = ".Factory>";
  protected final String TEXT_33 = " getRegistrations()" + NL + "\t{" + NL + "\t\tif (registrations == null)" + NL + "\t\t{" + NL + "\t\t\tsuper.getRegistrations();" + NL + "\t\t\tregistrations.put(XML_EXTENSION, new ";
  protected final String TEXT_34 = "());" + NL + "\t\t\tregistrations.put(STAR_EXTENSION, new ";
  protected final String TEXT_35 = "());" + NL + "\t\t}" + NL + "\t\treturn registrations;" + NL + "\t}" + NL + "" + NL + "} //";
