...
public class ValidatorClass
{
  ...
  protected final String TEXT_419 = ".add" + NL + "\t\t\t\t\t(new ";
  protected final String TEXT_420 = NL + "\t\t\t\t\t\t(";
  protected final String TEXT_421 = ".ERROR," + NL + "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_422 = ".INSTANCE.getString(\"_UI_GenericConstraint_diagnostic\", new Object[] { \"";
  ...
  protected final String TEXT_435 = NL + "\t\t// TODO implement the constraint" + NL + "\t\t// -> specify the condition that violates the constraint" + NL + "\t\t// -> verify the diagnostic details, including severity, code, and message" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tif (false)" + NL + "\t\t{" + NL + "\t\t\tif (";
  protected final String TEXT_436 = " != null)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  protected final String TEXT_437 = ".add" + NL + "\t\t\t\t\t(new ";
  protected final String TEXT_438 = NL + "\t\t\t\t\t\t(";
  protected final String TEXT_439 = ".ERROR," + NL + "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_440 = ".INSTANCE.getString(\"_UI_GenericConstraint_diagnostic\", new Object[] { \"";
  protected final String TEXT_441 = "\", getValueLabel(";
  protected final String TEXT_442 = ", ";
  protected final String TEXT_443 = ", ";
  protected final String TEXT_444 = ") }),";
  protected final String TEXT_445 = NL + "\t\t\t\t\t\t new Object[] { ";
  protected final String TEXT_446 = " }));" + NL + "\t\t\t}" + NL + "\t\t\treturn false;" + NL + "\t\t}" + NL + "\t\treturn true;";
  protected final String TEXT_447 = NL + "\t\t// TODO override the constraint, if desired" + NL + "\t\t// -> uncomment the scaffolding" + NL + "\t\t// -> specify the condition that violates the constraint" + NL + "\t\t// -> verify the diagnostic details, including severity, code, and message" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tif (false)" + NL + "\t\t{" + NL + "\t\t\tif (";
  protected final String TEXT_448 = " != null)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  protected final String TEXT_449 = ".add" + NL + "\t\t\t\t\t(new ";
  protected final String TEXT_450 = NL + "\t\t\t\t\t\t(";
  protected final String TEXT_451 = ".ERROR," + NL + "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_452 = ".INSTANCE.getString(\"_UI_GenericConstraint_diagnostic\", new Object[] { \"";
  protected final String TEXT_453 = "\", getObjectLabel(";
  protected final String TEXT_454 = ", ";
  protected final String TEXT_455 = ") }),";
  protected final String TEXT_456 = NL + "\t\t\t\t\t\t new Object[] { ";
  protected final String TEXT_457 = " }));" + NL + "\t\t\t}" + NL + "\t\t\treturn false;" + NL + "\t\t}" + NL + "\t\treturn ";
  protected final String TEXT_458 = "validate";
  ...
  protected final String TEXT_474 = ".INSTANCE.getString(\"_UI_GenericConstraint_diagnostic\", new Object[] { \"";
  protected final String TEXT_475 = "\", getObjectLabel(";
  protected final String TEXT_476 = ", ";
  protected final String TEXT_477 = ") }),";
  protected final String TEXT_478 = NL + "\t\t\t\t\t\t new Object[] { ";
  protected final String TEXT_479 = " }));" + NL + "\t\t\t}" + NL + "\t\t\treturn false;" + NL + "\t\t}" + NL + "\t\treturn true;";
