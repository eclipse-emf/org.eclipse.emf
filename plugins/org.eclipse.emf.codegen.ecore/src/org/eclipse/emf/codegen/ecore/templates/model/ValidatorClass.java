...
public class ValidatorClass
{
  ...
  protected final String TEXT_140 = ".iterator(); i.hasNext() && (result || diagnostics != null); )" + NL + "\t\t{" + NL + "\t\t\tObject item = i.next();";
  ...
  protected final String TEXT_152 = ");" + NL + "\t\t\t}" + NL + "\t\t\telse";
  protected final String TEXT_153 = NL + "\t\t\tif (!";
  protected final String TEXT_154 = ".isInstance(item))";
  protected final String TEXT_155 = NL + "\t\t\t{" + NL + "\t\t\t\tresult = false;" + NL + "\t\t\t\treportDataValueTypeViolation(";
  protected final String TEXT_156 = ", item, ";
  protected final String TEXT_157 = ", ";
  protected final String TEXT_158 = ");" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\treturn result;";
  protected final String TEXT_159 = NL + "\t\tif (diagnostics != null)" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_160 = " tempDiagnostics = new BasicDiagnostic();";
  protected final String TEXT_161 = NL + "\t\t\tif (";
  protected final String TEXT_162 = "validate";
  protected final String TEXT_163 = "(";
  protected final String TEXT_164 = ", tempDiagnostics, ";
  protected final String TEXT_165 = ")) return true;";
  protected final String TEXT_166 = NL + "\t\t\tif (";
  protected final String TEXT_167 = ".isInstance(";
  protected final String TEXT_168 = "))" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  protected final String TEXT_169 = "if (";
  protected final String TEXT_170 = "validate";
  ...
  protected final String TEXT_179 = "return true;" + NL + "\t\t\t}";
  protected final String TEXT_180 = NL + "\t\t\t";
  protected final String TEXT_181 = " children = tempDiagnostics.getChildren();" + NL + "\t\t\tfor (int i = 0; i < children.size(); i++)" + NL + "\t\t\t{" + NL + "\t\t\t\tdiagnostics.add((";
  protected final String TEXT_182 = ")children.get(i));" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\telse" + NL + "\t\t{";
  protected final String TEXT_183 = NL + "\t\t\tif (";
  protected final String TEXT_184 = "validate";
  protected final String TEXT_185 = "(";
  protected final String TEXT_186 = ", null, ";
  protected final String TEXT_187 = ")) return true;";
  protected final String TEXT_188 = NL + "\t\t\tif (";
  protected final String TEXT_189 = ".isInstance(";
  protected final String TEXT_190 = "))" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  protected final String TEXT_191 = "if (";
  protected final String TEXT_192 = "validate";
  ...
  protected final String TEXT_201 = "return true;" + NL + "\t\t\t}";
  protected final String TEXT_202 = NL + "\t\t}" + NL + "\t\treturn false;";
  protected final String TEXT_203 = NL + "\t\treturn validatePattern(";
  protected final String TEXT_204 = ", ";
  protected final String TEXT_205 = "new ";
  protected final String TEXT_206 = "(";
  protected final String TEXT_207 = ")";
  protected final String TEXT_208 = ", ";
  protected final String TEXT_209 = "__VALUES, ";
  ...
  protected final String TEXT_219 = "__VALUES.contains(";
  protected final String TEXT_220 = ");" + NL + "\t\tif (!";
  protected final String TEXT_221 = " && ";
  protected final String TEXT_222 = " != null) " + NL + "\t\t\treportEnumerationViolation(";
  ...
  protected final String TEXT_229 = NL + "\t\tboolean ";
  protected final String TEXT_230 = " = ";
  protected final String TEXT_231 = " ";
  protected final String TEXT_232 = " ";
  protected final String TEXT_233 = "__VALUE;" + NL + "\t\tif (!";
  protected final String TEXT_234 = " && ";
  protected final String TEXT_235 = " != null) " + NL + "\t\t\treportMinViolation(";
  ...
  protected final String TEXT_247 = ".compareCalendar(";
  ...
  protected final String TEXT_253 = NL + "\t\tint ";
  protected final String TEXT_254 = " = ";
  protected final String TEXT_255 = ".compareDuration(";
  protected final String TEXT_256 = ", ";
  protected final String TEXT_257 = "__VALUE);" + NL + "\t\tboolean ";
  protected final String TEXT_258 = " = ";
  protected final String TEXT_259 = " == 0 || ";
  protected final String TEXT_260 = " == 1;";
  protected final String TEXT_261 = NL + "\t\tboolean ";
  protected final String TEXT_262 = " = ";
  protected final String TEXT_263 = ".compareTo(";
  protected final String TEXT_264 = "__VALUE) ";
  protected final String TEXT_265 = " 0;";
  protected final String TEXT_266 = NL + "\t\tif (!";
  protected final String TEXT_267 = " && ";
  protected final String TEXT_268 = " != null) " + NL + "\t\t\treportMinViolation(";
  protected final String TEXT_269 = ", ";
  protected final String TEXT_270 = ", ";
  protected final String TEXT_271 = "__VALUE, ";
  protected final String TEXT_272 = ", ";
  protected final String TEXT_273 = ", ";
  protected final String TEXT_274 = ");" + NL + "\t\treturn ";
  protected final String TEXT_275 = "; ";
  protected final String TEXT_276 = NL + "\t\tboolean ";
  protected final String TEXT_277 = " = ";
  protected final String TEXT_278 = " ";
  protected final String TEXT_279 = " ";
  protected final String TEXT_280 = "__VALUE;" + NL + "\t\tif (!";
  protected final String TEXT_281 = " && ";
  protected final String TEXT_282 = " != null) " + NL + "\t\t\treportMaxViolation(";
  ...
  protected final String TEXT_315 = " != null) " + NL + "\t\t\treportMaxViolation(";
  ...
  protected final String TEXT_323 = NL + "\t\tint length = ";
  ...
  protected final String TEXT_329 = " != null) " + NL + "\t\t\treportMinLengthViolation(";
  ...
  protected final String TEXT_342 = " != null) " + NL + "\t\t\treportMaxLengthViolation(";
  ...
  protected final String TEXT_349 = NL + "\t\tboolean ";
  protected final String TEXT_350 = " = ";
  protected final String TEXT_351 = " > ";
  protected final String TEXT_352 = "__LOWER_BOUND && ";
  protected final String TEXT_353 = " < ";
  protected final String TEXT_354 = "__UPPER_BOUND;" + NL + "\t\tif (!";
  protected final String TEXT_355 = " && ";
  protected final String TEXT_356 = " != null) " + NL + "\t\t\treportTotalDigitsViolation(";
  ...
  protected final String TEXT_365 = ".unscaledValue().abs().toString().length() <= ";
  protected final String TEXT_366 = ";" + NL + "\t\tif (!";
  protected final String TEXT_367 = " && ";
  protected final String TEXT_368 = " != null) " + NL + "\t\t\treportTotalDigitsViolation(";
  ...
  protected final String TEXT_377 = "__LOWER_BOUND) > 0 && ";
  protected final String TEXT_378 = ".compareTo(";
  protected final String TEXT_379 = "__UPPER_BOUND) < 0;" + NL + "\t\tif (!";
  ...
  protected final String TEXT_389 = NL + "\t\tboolean ";
  protected final String TEXT_390 = " = ";
  protected final String TEXT_391 = ".scale() <= ";
  protected final String TEXT_392 = ";" + NL + "\t\tif (!";
  protected final String TEXT_393 = " && ";
  protected final String TEXT_394 = " != null) " + NL + "\t\t\treportFractionDigitsViolation(";
  ...
  protected final String TEXT_412 = " }));" + NL + "\t\t\t}" + NL + "\t\t\treturn false;" + NL + "\t\t}" + NL + "\t\treturn ";
  protected final String TEXT_413 = "validate";
  protected final String TEXT_414 = "_";
  protected final String TEXT_415 = "(";
  protected final String TEXT_416 = ", ";
  protected final String TEXT_417 = ", ";
  protected final String TEXT_418 = ");";
  protected final String TEXT_419 = NL + "\t\t// TODO implement the constraint" + NL + "\t\t// -> specify the condition that violates the constraint" + NL + "\t\t// -> verify the diagnostic details, including severity, code, and message" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tif (false)" + NL + "\t\t{" + NL + "\t\t\tif (";
  protected final String TEXT_420 = " != null)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  protected final String TEXT_421 = ".add" + NL + "\t\t\t\t\t(new ";
  protected final String TEXT_422 = NL + "\t\t\t\t\t\t(";
  protected final String TEXT_423 = ".ERROR," + NL + "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_424 = ".INSTANCE.getString(\"_UI_GenericConstraint_diagnostic\", new Object[] { \"";
  protected final String TEXT_425 = "\", getValueLabel(";
