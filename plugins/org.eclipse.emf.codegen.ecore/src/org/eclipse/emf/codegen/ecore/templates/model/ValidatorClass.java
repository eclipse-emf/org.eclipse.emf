...
public class ValidatorClass
{
  ...
  protected final String TEXT_96 = " != null) result &= ";
  protected final String TEXT_97 = "validate";
  ...
  protected final String TEXT_110 = "__VALUE = ";
  ...
  protected final String TEXT_122 = "__UPPER_BOUND = ";
  protected final String TEXT_123 = ";" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t * @see #validate";
  protected final String TEXT_124 = "_";
  protected final String TEXT_125 = NL + "\t */" + NL + "\tpublic static final ";
  protected final String TEXT_126 = " ";
  protected final String TEXT_127 = "__LOWER_BOUND = ";
  protected final String TEXT_128 = ";" + NL;
  protected final String TEXT_129 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t * @see #validate";
  protected final String TEXT_130 = "_";
  protected final String TEXT_131 = NL + "\t */" + NL + "\tpublic static final  PatternMatcher [][] ";
  protected final String TEXT_132 = "__VALUES =" + NL + "\t\tnew PatternMatcher [][]" + NL + "\t\t{";
  protected final String TEXT_133 = NL + "\t\t\tnew PatternMatcher []" + NL + "\t\t\t{";
  protected final String TEXT_134 = NL + "\t\t\t\t";
  protected final String TEXT_135 = ".createPatternMatcher(";
  protected final String TEXT_136 = ")";
  protected final String TEXT_137 = NL + "\t\t\t}";
  protected final String TEXT_138 = NL + "\t\t};" + NL;
  protected final String TEXT_139 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t * @see #validate";
  protected final String TEXT_140 = "_";
  protected final String TEXT_141 = NL + "\t */";
  protected final String TEXT_142 = NL + "\t@SuppressWarnings(\"unchecked\")";
  protected final String TEXT_143 = NL + "\tpublic static final ";
  protected final String TEXT_144 = " ";
  protected final String TEXT_145 = "__VALUES =" + NL + "\t\twrapEnumerationValues" + NL + "\t\t\t(new Object[]" + NL + "\t\t\t {";
  protected final String TEXT_146 = NL + "\t\t\t\t ";
  protected final String TEXT_147 = "new ";
  protected final String TEXT_148 = "(";
  protected final String TEXT_149 = ")";
  protected final String TEXT_150 = NL + "\t\t\t });" + NL;
  protected final String TEXT_151 = NL + "\t/**" + NL + "\t * The cached validation expression for the ";
  protected final String TEXT_152 = " constraint of '<em>";
  protected final String TEXT_153 = "</em>'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected static final ";
  protected final String TEXT_154 = " ";
  protected final String TEXT_155 = "__";
  protected final String TEXT_156 = "__EEXPRESSION = \"";
  protected final String TEXT_157 = "\";";
  protected final String TEXT_158 = NL;
  protected final String TEXT_159 = NL + "\t/**" + NL + "\t * Validates the ";
  protected final String TEXT_160 = " constraint of '<em>";
  protected final String TEXT_161 = "</em>'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic boolean validate";
  protected final String TEXT_162 = "_";
  protected final String TEXT_163 = "(";
  protected final String TEXT_164 = " ";
  protected final String TEXT_165 = ", DiagnosticChain ";
  protected final String TEXT_166 = ", ";
  protected final String TEXT_167 = " ";
  protected final String TEXT_168 = ")" + NL + "\t{";
  protected final String TEXT_169 = NL + "\t\tboolean ";
  protected final String TEXT_170 = " = true;" + NL + "\t\tfor (";
  protected final String TEXT_171 = " i = ";
  protected final String TEXT_172 = ".iterator(); i.hasNext() && (result || diagnostics != null); )" + NL + "\t\t{" + NL + "\t\t\tObject item = i.next();";
  protected final String TEXT_173 = NL + "\t\t\tif (";
  protected final String TEXT_174 = ".isInstance(item))" + NL + "\t\t\t{" + NL + "\t\t\t\tresult &= ";
  ...
  protected final String TEXT_186 = ".isInstance(item))";
  protected final String TEXT_187 = NL + "\t\t\t{" + NL + "\t\t\t\tresult = false;" + NL + "\t\t\t\treportDataValueTypeViolation(";
  protected final String TEXT_188 = ", item, ";
  protected final String TEXT_189 = ", ";
  protected final String TEXT_190 = ");" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\treturn result;";
  protected final String TEXT_191 = NL + "\t\tif (diagnostics != null)" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_192 = " tempDiagnostics = new BasicDiagnostic();";
  protected final String TEXT_193 = NL + "\t\t\tif (";
  protected final String TEXT_194 = "validate";
  protected final String TEXT_195 = "(";
  protected final String TEXT_196 = ", tempDiagnostics, ";
  ...
  protected final String TEXT_213 = " diagnostic : tempDiagnostics.getChildren())" + NL + "\t\t\t{" + NL + "\t\t\t\tdiagnostics.add(diagnostic);" + NL + "\t\t\t}";
  protected final String TEXT_214 = NL + "\t\t\t";
  protected final String TEXT_215 = " children = tempDiagnostics.getChildren();" + NL + "\t\t\tfor (int i = 0; i < children.size(); i++)" + NL + "\t\t\t{" + NL + "\t\t\t\tdiagnostics.add((";
  protected final String TEXT_216 = ")children.get(i));" + NL + "\t\t\t}";
  protected final String TEXT_217 = NL + "\t\t}" + NL + "\t\telse" + NL + "\t\t{";
  protected final String TEXT_218 = NL + "\t\t\tif (";
  protected final String TEXT_219 = "validate";
  protected final String TEXT_220 = "(";
  protected final String TEXT_221 = ", null, ";
  protected final String TEXT_222 = ")) return true;";
  protected final String TEXT_223 = NL + "\t\t\tif (";
  protected final String TEXT_224 = ".isInstance(";
  protected final String TEXT_225 = "))" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  protected final String TEXT_226 = "if (";
  protected final String TEXT_227 = "validate";
  ...
  protected final String TEXT_236 = "return true;" + NL + "\t\t\t}";
  protected final String TEXT_237 = NL + "\t\t}" + NL + "\t\treturn false;";
  protected final String TEXT_238 = NL + "\t\treturn validatePattern(";
  ...
  protected final String TEXT_254 = "__VALUES.contains(";
  protected final String TEXT_255 = ");" + NL + "\t\tif (!";
  protected final String TEXT_256 = " && ";
  protected final String TEXT_257 = " != null)" + NL + "\t\t\treportEnumerationViolation(";
  protected final String TEXT_258 = ", ";
  protected final String TEXT_259 = ", ";
  protected final String TEXT_260 = "__VALUES, ";
  protected final String TEXT_261 = ", ";
  protected final String TEXT_262 = ");" + NL + "\t\treturn ";
  protected final String TEXT_263 = ";";
  protected final String TEXT_264 = NL + "\t\tboolean ";
  protected final String TEXT_265 = " = ";
  protected final String TEXT_266 = " ";
  protected final String TEXT_267 = " ";
  protected final String TEXT_268 = "__VALUE;" + NL + "\t\tif (!";
  ...
  protected final String TEXT_276 = "__VALUE), ";
  ...
  protected final String TEXT_289 = NL + "\t\tint ";
  protected final String TEXT_290 = " = ";
  protected final String TEXT_291 = ".compareCalendar(";
  protected final String TEXT_292 = ", ";
  protected final String TEXT_293 = "__VALUE);" + NL + "\t\tboolean ";
  protected final String TEXT_294 = " = ";
  protected final String TEXT_295 = " == 0 || ";
  protected final String TEXT_296 = " == 1;";
  protected final String TEXT_297 = NL + "\t\tint ";
  protected final String TEXT_298 = " = ";
  protected final String TEXT_299 = ".compareDuration(";
  protected final String TEXT_300 = ", ";
  protected final String TEXT_301 = "__VALUE);" + NL + "\t\tboolean ";
  protected final String TEXT_302 = " = ";
  protected final String TEXT_303 = " == 0 || ";
  protected final String TEXT_304 = " == 1;";
  protected final String TEXT_305 = NL + "\t\tboolean ";
  protected final String TEXT_306 = " = ";
  protected final String TEXT_307 = ".compareTo(";
  protected final String TEXT_308 = "__VALUE) ";
  protected final String TEXT_309 = " 0;";
  protected final String TEXT_310 = NL + "\t\tif (!";
  protected final String TEXT_311 = " && ";
  protected final String TEXT_312 = " != null)" + NL + "\t\t\treportMinViolation(";
  ...
  protected final String TEXT_320 = NL + "\t\tboolean ";
  protected final String TEXT_321 = " = ";
  protected final String TEXT_322 = " ";
  protected final String TEXT_323 = " ";
  protected final String TEXT_324 = "__VALUE;" + NL + "\t\tif (!";
  ...
  protected final String TEXT_345 = NL + "\t\tint ";
  protected final String TEXT_346 = " = ";
  protected final String TEXT_347 = ".compareCalendar(";
  protected final String TEXT_348 = ", ";
  protected final String TEXT_349 = "__VALUE);" + NL + "\t\tboolean ";
  protected final String TEXT_350 = " = ";
  protected final String TEXT_351 = " == 0 || ";
  protected final String TEXT_352 = " == -1;";
  protected final String TEXT_353 = NL + "\t\tint ";
  protected final String TEXT_354 = " = ";
  protected final String TEXT_355 = ".compareDuration(";
  protected final String TEXT_356 = ", ";
  protected final String TEXT_357 = "__VALUE);" + NL + "\t\tboolean ";
  ...
  protected final String TEXT_364 = "__VALUE) ";
  protected final String TEXT_365 = " 0;";
  protected final String TEXT_366 = NL + "\t\tif (!";
  protected final String TEXT_367 = " && ";
  protected final String TEXT_368 = " != null)" + NL + "\t\t\treportMaxViolation(";
  ...
  protected final String TEXT_376 = NL + "\t\tint length = ";
  protected final String TEXT_377 = ".";
  protected final String TEXT_378 = ";" + NL + "\t\tboolean ";
  protected final String TEXT_379 = " = length >= ";
  protected final String TEXT_380 = ";" + NL + "\t\tif (!";
  protected final String TEXT_381 = " && ";
  protected final String TEXT_382 = " != null)" + NL + "\t\t\treportMinLengthViolation(";
  ...
  protected final String TEXT_395 = " != null)" + NL + "\t\t\treportMaxLengthViolation(";
  ...
  protected final String TEXT_405 = "__LOWER_BOUND && ";
  protected final String TEXT_406 = " < ";
  protected final String TEXT_407 = "__UPPER_BOUND;" + NL + "\t\tif (!";
  protected final String TEXT_408 = " && ";
  protected final String TEXT_409 = " != null)";
  protected final String TEXT_410 = NL + "\t\t\treportTotalDigitsViolation(";
  ...
  protected final String TEXT_423 = NL + "\t\tboolean ";
  protected final String TEXT_424 = " = ";
  protected final String TEXT_425 = ".unscaledValue().abs().toString().length() <= ";
  protected final String TEXT_426 = ";" + NL + "\t\tif (!";
  protected final String TEXT_427 = " && ";
  protected final String TEXT_428 = " != null)" + NL + "\t\t\treportTotalDigitsViolation(";
  protected final String TEXT_429 = ", ";
  protected final String TEXT_430 = ", ";
  protected final String TEXT_431 = ", ";
  protected final String TEXT_432 = ", ";
  protected final String TEXT_433 = ");";
  protected final String TEXT_434 = NL + "\t\tboolean ";
  protected final String TEXT_435 = " = ";
  protected final String TEXT_436 = ".compareTo(";
  protected final String TEXT_437 = "__LOWER_BOUND) > 0 && ";
  protected final String TEXT_438 = ".compareTo(";
  protected final String TEXT_439 = "__UPPER_BOUND) < 0;" + NL + "\t\tif (!";
  protected final String TEXT_440 = " && ";
  protected final String TEXT_441 = " != null)" + NL + "\t\t\treportTotalDigitsViolation(";
  ...
  protected final String TEXT_451 = ".scale() <= ";
  protected final String TEXT_452 = ";" + NL + "\t\tif (!";
  protected final String TEXT_453 = " && ";
  protected final String TEXT_454 = " != null)" + NL + "\t\t\treportFractionDigitsViolation(";
  ...
  protected final String TEXT_463 = ".add";
  protected final String TEXT_464 = NL + "\t\t\t\t\t(createDiagnostic" + NL + "\t\t\t\t\t\t(";
  protected final String TEXT_465 = ".ERROR," + NL + "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL + "\t\t\t\t\t\t \"_UI_GenericConstraint_diagnostic\",";
  protected final String TEXT_466 = NL + "\t\t\t\t\t\t new Object[] { \"";
  protected final String TEXT_467 = "\", getValueLabel(";
  protected final String TEXT_468 = ", ";
  protected final String TEXT_469 = ", ";
  protected final String TEXT_470 = ") },";
  protected final String TEXT_471 = NL + "\t\t\t\t\t\t new Object[] { ";
  protected final String TEXT_472 = " }," + NL + "\t\t\t\t\t\t context));";
  protected final String TEXT_473 = NL + "\t\t\t\t\t(new ";
  protected final String TEXT_474 = NL + "\t\t\t\t\t\t(";
  protected final String TEXT_475 = ".ERROR," + NL + "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_476 = ".INSTANCE.getString(\"_UI_GenericConstraint_diagnostic\", new Object[] { \"";
  protected final String TEXT_477 = "\", getValueLabel(";
  protected final String TEXT_478 = ", ";
  protected final String TEXT_479 = ", ";
  protected final String TEXT_480 = ") }),";
  protected final String TEXT_481 = NL + "\t\t\t\t\t\t new Object[] { ";
  protected final String TEXT_482 = " }));";
  protected final String TEXT_483 = NL + "\t\t\t}" + NL + "\t\t\treturn false;" + NL + "\t\t}" + NL + "\t\treturn ";
  protected final String TEXT_484 = "validate";
  protected final String TEXT_485 = "_";
  protected final String TEXT_486 = "(";
  protected final String TEXT_487 = ", ";
  protected final String TEXT_488 = ", ";
  protected final String TEXT_489 = ");";
  protected final String TEXT_490 = NL + "\t\treturn" + NL + "\t\t\tvalidate" + NL + "\t\t\t\t(";
  ...
  protected final String TEXT_499 = "__";
  protected final String TEXT_500 = "__EEXPRESSION," + NL + "\t\t\t\t ";
  protected final String TEXT_501 = ".ERROR," + NL + "\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t 0);";
  protected final String TEXT_502 = NL + "\t\t// TODO implement the constraint" + NL + "\t\t// -> specify the condition that violates the constraint" + NL + "\t\t// -> verify the diagnostic details, including severity, code, and message" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tif (false)" + NL + "\t\t{" + NL + "\t\t\tif (";
  protected final String TEXT_503 = " != null)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  protected final String TEXT_504 = ".add";
  protected final String TEXT_505 = NL + "\t\t\t\t\t(createDiagnostic" + NL + "\t\t\t\t\t\t(";
  protected final String TEXT_506 = ".ERROR," + NL + "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL + "\t\t\t\t\t\t \"_UI_GenericConstraint_diagnostic\",";
  protected final String TEXT_507 = NL + "\t\t\t\t\t\t new Object[] { \"";
  protected final String TEXT_508 = "\", getValueLabel(";
  protected final String TEXT_509 = ", ";
  protected final String TEXT_510 = ", ";
  protected final String TEXT_511 = ") },";
  protected final String TEXT_512 = NL + "\t\t\t\t\t\t new Object[] { ";
  protected final String TEXT_513 = " }," + NL + "\t\t\t\t\t\t context));";
  protected final String TEXT_514 = NL + "\t\t\t\t\t(new ";
  protected final String TEXT_515 = NL + "\t\t\t\t\t\t(";
  protected final String TEXT_516 = ".ERROR," + NL + "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_517 = ".INSTANCE.getString(\"_UI_GenericConstraint_diagnostic\", new Object[] { \"";
  protected final String TEXT_518 = "\", getValueLabel(";
  protected final String TEXT_519 = ", ";
  protected final String TEXT_520 = ", ";
  protected final String TEXT_521 = ") }),";
  protected final String TEXT_522 = NL + "\t\t\t\t\t\t new Object[] { ";
  protected final String TEXT_523 = " }));";
  protected final String TEXT_524 = NL + "\t\t\t}" + NL + "\t\t\treturn false;" + NL + "\t\t}" + NL + "\t\treturn true;";
  protected final String TEXT_525 = NL + "\t\t// TODO override the constraint, if desired" + NL + "\t\t// -> uncomment the scaffolding" + NL + "\t\t// -> specify the condition that violates the constraint" + NL + "\t\t// -> verify the diagnostic details, including severity, code, and message" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tif (false)" + NL + "\t\t{" + NL + "\t\t\tif (";
  protected final String TEXT_526 = " != null)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  protected final String TEXT_527 = ".add";
  protected final String TEXT_528 = NL + "\t\t\t\t\t(createDiagnostic" + NL + "\t\t\t\t\t\t(";
  protected final String TEXT_529 = ".ERROR," + NL + "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL + "\t\t\t\t\t\t \"_UI_GenericConstraint_diagnostic\",";
  protected final String TEXT_530 = NL + "\t\t\t\t\t\t new Object[] { \"";
  protected final String TEXT_531 = "\", getObjectLabel(";
  protected final String TEXT_532 = ", ";
  protected final String TEXT_533 = ") },";
  protected final String TEXT_534 = NL + "\t\t\t\t\t\t new Object[] { ";
  protected final String TEXT_535 = " }," + NL + "\t\t\t\t\t\t context));";
  protected final String TEXT_536 = NL + "\t\t\t\t\t(new ";
  protected final String TEXT_537 = NL + "\t\t\t\t\t\t(";
  protected final String TEXT_538 = ".ERROR," + NL + "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_539 = ".INSTANCE.getString(\"_UI_GenericConstraint_diagnostic\", new Object[] { \"";
  protected final String TEXT_540 = "\", getObjectLabel(";
  protected final String TEXT_541 = ", ";
  protected final String TEXT_542 = ") }),";
  protected final String TEXT_543 = NL + "\t\t\t\t\t\t new Object[] { ";
  protected final String TEXT_544 = " }));";
  protected final String TEXT_545 = NL + "\t\t\t}" + NL + "\t\t\treturn false;" + NL + "\t\t}" + NL + "\t\treturn ";
  protected final String TEXT_546 = "validate";
  protected final String TEXT_547 = "_";
  ...
  protected final String TEXT_557 = NL + "\t\treturn" + NL + "\t\t\tvalidate" + NL + "\t\t\t\t(";
  ...
  protected final String TEXT_566 = "__";
  protected final String TEXT_567 = "__EEXPRESSION," + NL + "\t\t\t\t ";
  protected final String TEXT_568 = ".ERROR," + NL + "\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t 0);";
  protected final String TEXT_569 = NL + "\t\t// TODO implement the constraint" + NL + "\t\t// -> specify the condition that violates the constraint" + NL + "\t\t// -> verify the diagnostic details, including severity, code, and message" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tif (false)" + NL + "\t\t{" + NL + "\t\t\tif (";
  protected final String TEXT_570 = " != null)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  protected final String TEXT_571 = ".add";
  protected final String TEXT_572 = NL + "\t\t\t\t\t(createDiagnostic" + NL + "\t\t\t\t\t\t(";
  protected final String TEXT_573 = ".ERROR," + NL + "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL + "\t\t\t\t\t\t \"_UI_GenericConstraint_diagnostic\",";
  protected final String TEXT_574 = NL + "\t\t\t\t\t\t new Object[] { \"";
  protected final String TEXT_575 = "\", getObjectLabel(";
  protected final String TEXT_576 = ", ";
  protected final String TEXT_577 = ") },";
  protected final String TEXT_578 = NL + "\t\t\t\t\t\t new Object[] { ";
  protected final String TEXT_579 = " }," + NL + "\t\t\t\t\t\t context));";
  protected final String TEXT_580 = NL + "\t\t\t\t\t(new ";
  protected final String TEXT_581 = NL + "\t\t\t\t\t\t(";
  protected final String TEXT_582 = ".ERROR," + NL + "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_583 = ".INSTANCE.getString(\"_UI_GenericConstraint_diagnostic\", new Object[] { \"";
  protected final String TEXT_584 = "\", getObjectLabel(";
  protected final String TEXT_585 = ", ";
  protected final String TEXT_586 = ") }),";
  protected final String TEXT_587 = NL + "\t\t\t\t\t\t new Object[] { ";
  protected final String TEXT_588 = " }));";
  protected final String TEXT_589 = NL + "\t\t\t}" + NL + "\t\t\treturn false;" + NL + "\t\t}" + NL + "\t\treturn true;";
  protected final String TEXT_590 = NL + "\t}" + NL;
  protected final String TEXT_591 = NL + "\t/**" + NL + "\t * Returns the resource locator that will be used to fetch messages for this validator's diagnostics." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_592 = NL + "\t@Override";
  protected final String TEXT_593 = NL + "\tpublic ";
  protected final String TEXT_594 = " getResourceLocator()" + NL + "\t{";
  protected final String TEXT_595 = NL + "\t\treturn ";
  protected final String TEXT_596 = ".INSTANCE;";
  protected final String TEXT_597 = NL + "\t\t// TODO" + NL + "\t\t// Specialize this to return a resource locator for messages specific to this validator." + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\treturn super.getResourceLocator();";
