...
public class ValidatorClass
{
  ...
  protected final String TEXT_224 = "__VALUE) ";
  protected final String TEXT_225 = " 0;" + NL + "\t\tif (!";
  ...
  protected final String TEXT_231 = "__VALUE, ";
  ...
  protected final String TEXT_240 = "__VALUE;" + NL + "\t\tif (!";
  protected final String TEXT_241 = " && ";
  protected final String TEXT_242 = " != null) " + NL + "\t\t\treportMaxViolation(";
  ...
  protected final String TEXT_257 = " 0;" + NL + "\t\tif (!";
  ...
  protected final String TEXT_268 = NL + "\t\tint length = ";
  protected final String TEXT_269 = ".";
  protected final String TEXT_270 = ";  " + NL + "\t\tboolean ";
  protected final String TEXT_271 = " = length < ";
  protected final String TEXT_272 = ";" + NL + "\t\tif (!";
  protected final String TEXT_273 = " && ";
  protected final String TEXT_274 = " != null) " + NL + "\t\t\treportMinLengthViolation(";
  protected final String TEXT_275 = ".eINSTANCE.get";
  protected final String TEXT_276 = "(), ";
  protected final String TEXT_277 = ", length, ";
  protected final String TEXT_278 = ", ";
  protected final String TEXT_279 = ", ";
  protected final String TEXT_280 = ");" + NL + "\t\treturn ";
  protected final String TEXT_281 = ";";
  protected final String TEXT_282 = NL + "\t\tint length = ";
  protected final String TEXT_283 = ".";
  protected final String TEXT_284 = ";  " + NL + "\t\tboolean ";
  protected final String TEXT_285 = " = length > ";
  protected final String TEXT_286 = ";" + NL + "\t\tif (!";
  protected final String TEXT_287 = " && ";
  protected final String TEXT_288 = " != null) " + NL + "\t\t\treportMaxLengthViolation(";
  protected final String TEXT_289 = ".eINSTANCE.get";
  protected final String TEXT_290 = "(), ";
  protected final String TEXT_291 = ", length, ";
  ...
  protected final String TEXT_299 = "__LOWER_BOUND && ";
  protected final String TEXT_300 = " < ";
  protected final String TEXT_301 = "__UPPER_BOUND;" + NL + "\t\tif (!";
  protected final String TEXT_302 = " && ";
  protected final String TEXT_303 = " != null) " + NL + "\t\t\treportTotalDigitsViolation(";
  ...
  protected final String TEXT_313 = ".unscaledValue().abs().toString().length() <= ";
  protected final String TEXT_314 = ";" + NL + "\t\tif (!";
  protected final String TEXT_315 = " && ";
  protected final String TEXT_316 = " != null) " + NL + "\t\t\treportTotalDigitsViolation(";
  ...
  protected final String TEXT_325 = ".compareTo(";
  protected final String TEXT_326 = "__LOWER_BOUND) > 0 && ";
  protected final String TEXT_327 = ".compareTo(";
  protected final String TEXT_328 = "__UPPER_BOUND) < 0;" + NL + "\t\tif (!";
  protected final String TEXT_329 = " && ";
  protected final String TEXT_330 = " != null) " + NL + "\t\t\treportTotalDigitsViolation(";
  ...
  protected final String TEXT_341 = ".scale() <= ";
  protected final String TEXT_342 = ";" + NL + "\t\tif (!";
  protected final String TEXT_343 = " && ";
  protected final String TEXT_344 = " != null) " + NL + "\t\t\treportFractionDigitsViolation(";
  ...
  protected final String TEXT_352 = NL + "\t\t// TODO override the constraint" + NL + "\t\treturn ";
  protected final String TEXT_353 = "validate";
  protected final String TEXT_354 = "_";
  protected final String TEXT_355 = "(";
  protected final String TEXT_356 = ", ";
  protected final String TEXT_357 = ", ";
  protected final String TEXT_358 = ");";
  protected final String TEXT_359 = NL + "\t\t// TODO implement the constraint" + NL + "\t\treturn true;";
  protected final String TEXT_360 = NL + "\t\t// TODO override the constraint" + NL + "\t\treturn ";
  protected final String TEXT_361 = "validate";
  ...
  protected final String TEXT_372 = NL + "\t\t// TODO implement the constraint" + NL + "\t\treturn true;";
