...
public class ValidatorClass
{
  ...
  protected final String TEXT_158 = ".isInstance(";
  protected final String TEXT_159 = "))" + NL + "\t\t\t{" + NL + "\t\t\t\tif (";
  protected final String TEXT_160 = "validate";
  ...
  protected final String TEXT_167 = ", tempDiagnostics, ";
  protected final String TEXT_168 = ")) return true;" + NL + "\t\t\t}";
  protected final String TEXT_169 = NL + "\t\t\t";
  protected final String TEXT_170 = " children = tempDiagnostics.getChildren();" + NL + "\t\t\tfor (int i = 0; i < children.size(); i++)" + NL + "\t\t\t{" + NL + "\t\t\t\tdiagnostics.add((";
  protected final String TEXT_171 = ")children.get(i));" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\telse" + NL + "\t\t{";
  ...
  protected final String TEXT_183 = ")) return true;" + NL + "\t\t\t}";
  protected final String TEXT_184 = NL + "\t\t}" + NL + "\t\treturn false;";
  protected final String TEXT_185 = NL + "\t\treturn validatePattern(";
  protected final String TEXT_186 = ", ";
  protected final String TEXT_187 = "new ";
  protected final String TEXT_188 = "(";
  protected final String TEXT_189 = ")";
  protected final String TEXT_190 = ", ";
  protected final String TEXT_191 = "__VALUES, ";
  ...
  protected final String TEXT_199 = NL + "\t\tboolean ";
  protected final String TEXT_200 = " = ";
  protected final String TEXT_201 = "__VALUES.contains(";
  protected final String TEXT_202 = ");" + NL + "\t\tif (!";
  protected final String TEXT_203 = " && ";
  protected final String TEXT_204 = " != null) " + NL + "\t\t\treportEnumerationViolation(";
  protected final String TEXT_205 = ", ";
  protected final String TEXT_206 = ", ";
  protected final String TEXT_207 = "__VALUES, ";
  protected final String TEXT_208 = ", ";
  protected final String TEXT_209 = ");" + NL + "\t\treturn ";
  protected final String TEXT_210 = "; ";
  protected final String TEXT_211 = NL + "\t\tboolean ";
  protected final String TEXT_212 = " = ";
  protected final String TEXT_213 = " ";
  protected final String TEXT_214 = " ";
  protected final String TEXT_215 = "__VALUE;" + NL + "\t\tif (!";
  protected final String TEXT_216 = " && ";
  protected final String TEXT_217 = " != null) " + NL + "\t\t\treportMinViolation(";
  protected final String TEXT_218 = ", new ";
  protected final String TEXT_219 = "(";
  protected final String TEXT_220 = "), new ";
  protected final String TEXT_221 = "(";
  protected final String TEXT_222 = "__VALUE), ";
  protected final String TEXT_223 = ", ";
  protected final String TEXT_224 = ", ";
  protected final String TEXT_225 = ");" + NL + "\t\treturn ";
  protected final String TEXT_226 = ";";
  protected final String TEXT_227 = NL + "\t\tint ";
  protected final String TEXT_228 = " = ";
  protected final String TEXT_229 = ".compareCalendar(";
  protected final String TEXT_230 = ", ";
  protected final String TEXT_231 = "__VALUE);" + NL + "\t\tboolean ";
  protected final String TEXT_232 = " = ";
  protected final String TEXT_233 = " == 0 || ";
  protected final String TEXT_234 = " == 1;";
  protected final String TEXT_235 = NL + "\t\tint ";
  protected final String TEXT_236 = " = ";
  protected final String TEXT_237 = ".compareDuration(";
  protected final String TEXT_238 = ", ";
  protected final String TEXT_239 = "__VALUE);" + NL + "\t\tboolean ";
  protected final String TEXT_240 = " = ";
  protected final String TEXT_241 = " == 0 || ";
  protected final String TEXT_242 = " == 1;";
  protected final String TEXT_243 = NL + "\t\tboolean ";
  protected final String TEXT_244 = " = ";
  protected final String TEXT_245 = ".compareTo(";
  protected final String TEXT_246 = "__VALUE) ";
  protected final String TEXT_247 = " 0;";
  protected final String TEXT_248 = NL + "\t\tif (!";
  protected final String TEXT_249 = " && ";
  protected final String TEXT_250 = " != null) " + NL + "\t\t\treportMinViolation(";
  ...
  protected final String TEXT_262 = "__VALUE;" + NL + "\t\tif (!";
  protected final String TEXT_263 = " && ";
  protected final String TEXT_264 = " != null) " + NL + "\t\t\treportMaxViolation(";
  protected final String TEXT_265 = ", new ";
  protected final String TEXT_266 = "(";
  protected final String TEXT_267 = "), new ";
  protected final String TEXT_268 = "(";
  protected final String TEXT_269 = "__VALUE), ";
  protected final String TEXT_270 = ", ";
  protected final String TEXT_271 = ", ";
  protected final String TEXT_272 = ");" + NL + "\t\treturn ";
  protected final String TEXT_273 = "; ";
  protected final String TEXT_274 = NL + "\t\tint ";
  protected final String TEXT_275 = " = ";
  protected final String TEXT_276 = ".compareCalendar(";
  protected final String TEXT_277 = ", ";
  protected final String TEXT_278 = "__VALUE);" + NL + "\t\tboolean ";
  protected final String TEXT_279 = " = ";
  protected final String TEXT_280 = " == 0 || ";
  protected final String TEXT_281 = " == -1;";
  protected final String TEXT_282 = NL + "\t\tint ";
  protected final String TEXT_283 = " = ";
  protected final String TEXT_284 = ".compareDuration(";
  protected final String TEXT_285 = ", ";
  protected final String TEXT_286 = "__VALUE);" + NL + "\t\tboolean ";
  protected final String TEXT_287 = " = ";
  protected final String TEXT_288 = " == 0 || ";
  protected final String TEXT_289 = " == -1;";
  protected final String TEXT_290 = NL + "\t\tboolean ";
  protected final String TEXT_291 = " = ";
  protected final String TEXT_292 = ".compareTo(";
  protected final String TEXT_293 = "__VALUE) ";
  protected final String TEXT_294 = " 0;";
  protected final String TEXT_295 = NL + "\t\tif (!";
  protected final String TEXT_296 = " && ";
  protected final String TEXT_297 = " != null) " + NL + "\t\t\treportMaxViolation(";
  ...
  protected final String TEXT_305 = NL + "\t\tint length = ";
  protected final String TEXT_306 = ".";
  protected final String TEXT_307 = ";  " + NL + "\t\tboolean ";
  protected final String TEXT_308 = " = length >= ";
  protected final String TEXT_309 = ";" + NL + "\t\tif (!";
  protected final String TEXT_310 = " && ";
  protected final String TEXT_311 = " != null) " + NL + "\t\t\treportMinLengthViolation(";
  protected final String TEXT_312 = ", ";
  protected final String TEXT_313 = ", length, ";
  protected final String TEXT_314 = ", ";
  protected final String TEXT_315 = ", ";
  protected final String TEXT_316 = ");" + NL + "\t\treturn ";
  protected final String TEXT_317 = ";";
  protected final String TEXT_318 = NL + "\t\tint length = ";
  protected final String TEXT_319 = ".";
  protected final String TEXT_320 = ";  " + NL + "\t\tboolean ";
  protected final String TEXT_321 = " = length <= ";
  protected final String TEXT_322 = ";" + NL + "\t\tif (!";
  protected final String TEXT_323 = " && ";
  protected final String TEXT_324 = " != null) " + NL + "\t\t\treportMaxLengthViolation(";
  protected final String TEXT_325 = ", ";
  protected final String TEXT_326 = ", length, ";
  ...
  protected final String TEXT_334 = "__LOWER_BOUND && ";
  protected final String TEXT_335 = " < ";
  protected final String TEXT_336 = "__UPPER_BOUND;" + NL + "\t\tif (!";
  protected final String TEXT_337 = " && ";
  protected final String TEXT_338 = " != null) " + NL + "\t\t\treportTotalDigitsViolation(";
  ...
  protected final String TEXT_358 = ".compareTo(";
  protected final String TEXT_359 = "__LOWER_BOUND) > 0 && ";
  protected final String TEXT_360 = ".compareTo(";
  protected final String TEXT_361 = "__UPPER_BOUND) < 0;" + NL + "\t\tif (!";
  ...
  protected final String TEXT_371 = NL + "\t\tboolean ";
  protected final String TEXT_372 = " = ";
  protected final String TEXT_373 = ".scale() <= ";
  protected final String TEXT_374 = ";" + NL + "\t\tif (!";
  protected final String TEXT_375 = " && ";
  protected final String TEXT_376 = " != null) " + NL + "\t\t\treportFractionDigitsViolation(";
  ...
  protected final String TEXT_383 = NL + "\t\t// TODO override the constraint, if desired" + NL + "\t\t// -> uncomment the scaffolding" + NL + "\t\t// -> specify the condition that violates the constraint" + NL + "\t\t// -> verify the diagnostic details, including severity, code, and message" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tif (false)" + NL + "\t\t{" + NL + "\t\t\tif (";
  protected final String TEXT_384 = " != null)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  protected final String TEXT_385 = ".add" + NL + "\t\t\t\t\t(new ";
  protected final String TEXT_386 = NL + "\t\t\t\t\t\t(";
  protected final String TEXT_387 = ".ERROR," + NL + "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_388 = ".INSTANCE.getString(\"_UI_GenericConstraint_diagnostic\", new Object[] { \"";
  protected final String TEXT_389 = "\", getValueLabel(";
  protected final String TEXT_390 = ", ";
  protected final String TEXT_391 = ", ";
  protected final String TEXT_392 = ") }),";
  protected final String TEXT_393 = NL + "\t\t\t\t\t\t new Object[] { ";
  protected final String TEXT_394 = " }));" + NL + "\t\t\t}" + NL + "\t\t\treturn false;" + NL + "\t\t}" + NL + "\t\treturn ";
  ...
  protected final String TEXT_401 = NL + "\t\t// TODO implement the constraint" + NL + "\t\t// -> specify the condition that violates the constraint" + NL + "\t\t// -> verify the diagnostic details, including severity, code, and message" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tif (false)" + NL + "\t\t{" + NL + "\t\t\tif (";
  protected final String TEXT_402 = " != null)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  protected final String TEXT_403 = ".add" + NL + "\t\t\t\t\t(new ";
  protected final String TEXT_404 = NL + "\t\t\t\t\t\t(";
  protected final String TEXT_405 = ".ERROR," + NL + "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_406 = ".INSTANCE.getString(\"_UI_GenericConstraint_diagnostic\", new Object[] { \"";
  protected final String TEXT_407 = "\", getValueLabel(";
  protected final String TEXT_408 = ", ";
  protected final String TEXT_409 = ", ";
  protected final String TEXT_410 = ") }),";
  protected final String TEXT_411 = NL + "\t\t\t\t\t\t new Object[] { ";
  protected final String TEXT_412 = " }));" + NL + "\t\t\t}" + NL + "\t\t\treturn false;" + NL + "\t\t}" + NL + "\t\treturn true;";
  protected final String TEXT_413 = NL + "\t\t// TODO override the constraint, if desired" + NL + "\t\t// -> uncomment the scaffolding" + NL + "\t\t// -> specify the condition that violates the constraint" + NL + "\t\t// -> verify the diagnostic details, including severity, code, and message" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tif (false)" + NL + "\t\t{" + NL + "\t\t\tif (";
  protected final String TEXT_414 = " != null)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  protected final String TEXT_415 = ".add" + NL + "\t\t\t\t\t(new ";
  protected final String TEXT_416 = NL + "\t\t\t\t\t\t(";
  protected final String TEXT_417 = ".ERROR," + NL + "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_418 = ".INSTANCE.getString(\"_UI_GenericConstraint_diagnostic\", new Object[] { \"";
  protected final String TEXT_419 = "\", getObjectLabel(";
  protected final String TEXT_420 = ", ";
  protected final String TEXT_421 = ") }),";
  protected final String TEXT_422 = NL + "\t\t\t\t\t\t new Object[] { ";
  protected final String TEXT_423 = " }));" + NL + "\t\t\t}" + NL + "\t\t\treturn false;" + NL + "\t\t}" + NL + "\t\treturn ";
  protected final String TEXT_424 = "validate";
  ...
  protected final String TEXT_441 = "\", getObjectLabel(";
  protected final String TEXT_442 = ", ";
  protected final String TEXT_443 = ") }),";
  protected final String TEXT_444 = NL + "\t\t\t\t\t\t new Object[] { ";
  protected final String TEXT_445 = " }));" + NL + "\t\t\t}" + NL + "\t\t\treturn false;" + NL + "\t\t}" + NL + "\t\treturn true;";
