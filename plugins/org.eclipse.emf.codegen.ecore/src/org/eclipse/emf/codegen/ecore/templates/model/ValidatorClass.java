...
public class ValidatorClass
{
  ...
  protected final String TEXT_97 = NL + "\t/**" + NL + "\t * Validates the ";
  protected final String TEXT_98 = " constraint of '<em>";
  protected final String TEXT_99 = "</em>'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic boolean validate";
  protected final String TEXT_100 = "_";
  protected final String TEXT_101 = "(";
  protected final String TEXT_102 = " ";
  protected final String TEXT_103 = ", DiagnosticChain ";
  protected final String TEXT_104 = ", Map ";
  protected final String TEXT_105 = ")" + NL + "\t{";
  protected final String TEXT_106 = NL + "\t\tboolean ";
  protected final String TEXT_107 = " = ";
  protected final String TEXT_108 = " ";
  protected final String TEXT_109 = " ";
  protected final String TEXT_110 = "__VALUE;" + NL + "\t\tif (!";
  protected final String TEXT_111 = " && ";
  protected final String TEXT_112 = " != null) " + NL + "\t\t\treportMinViolation(";
  ...
  protected final String TEXT_123 = NL + "\t\tboolean ";
  protected final String TEXT_124 = " = ";
  protected final String TEXT_125 = ".compareTo(";
  protected final String TEXT_126 = "__VALUE) ";
  protected final String TEXT_127 = " 0;" + NL + "\t\tif (!";
  protected final String TEXT_128 = " && ";
  protected final String TEXT_129 = " != null) " + NL + "\t\t\treportMinViolation(";
  protected final String TEXT_130 = ".eINSTANCE.get";
  protected final String TEXT_131 = "(), ";
  protected final String TEXT_132 = ", ";
  protected final String TEXT_133 = "__VALUE, ";
  protected final String TEXT_134 = ", ";
  protected final String TEXT_135 = ", ";
  protected final String TEXT_136 = ");" + NL + "\t\treturn ";
  protected final String TEXT_137 = "; ";
  protected final String TEXT_138 = NL + "\t\tboolean ";
  protected final String TEXT_139 = " = ";
  protected final String TEXT_140 = " ";
  protected final String TEXT_141 = " ";
  protected final String TEXT_142 = "__VALUE;" + NL + "\t\tif (!";
  protected final String TEXT_143 = " && ";
  protected final String TEXT_144 = " != null) " + NL + "\t\t\treportMaxViolation(";
  ...
  protected final String TEXT_150 = "__VALUE), ";
  ...
  protected final String TEXT_157 = ".compareTo(";
  protected final String TEXT_158 = "__VALUE) ";
  protected final String TEXT_159 = " 0;" + NL + "\t\tif (!";
  protected final String TEXT_160 = " && ";
  protected final String TEXT_161 = " != null) " + NL + "\t\t\treportMaxViolation(";
  protected final String TEXT_162 = ".eINSTANCE.get";
  protected final String TEXT_163 = "(), ";
  protected final String TEXT_164 = ", ";
  protected final String TEXT_165 = "__VALUE, ";
  ...
  protected final String TEXT_176 = " != null) " + NL + "\t\t\treportMinLengthViolation(";
  protected final String TEXT_177 = ".eINSTANCE.get";
  protected final String TEXT_178 = "(), ";
  protected final String TEXT_179 = ", length, ";
  protected final String TEXT_180 = ", ";
  protected final String TEXT_181 = ", ";
  protected final String TEXT_182 = ");" + NL + "\t\treturn ";
  protected final String TEXT_183 = ";";
  protected final String TEXT_184 = NL + "\t\tint length = ";
  protected final String TEXT_185 = ".";
  protected final String TEXT_186 = ";  " + NL + "\t\tboolean ";
  protected final String TEXT_187 = " = length > ";
  protected final String TEXT_188 = ";" + NL + "\t\tif (!";
  protected final String TEXT_189 = " && ";
  protected final String TEXT_190 = " != null) " + NL + "\t\t\treportMaxLengthViolation(";
  protected final String TEXT_191 = ".eINSTANCE.get";
  protected final String TEXT_192 = "(), ";
  protected final String TEXT_193 = ", length, ";
  protected final String TEXT_194 = ", ";
  protected final String TEXT_195 = ", ";
  protected final String TEXT_196 = ");" + NL + "\t\treturn ";
  protected final String TEXT_197 = ";";
  protected final String TEXT_198 = NL + "\t\t// TODO override the constraint" + NL + "\t\treturn ";
  ...
  protected final String TEXT_205 = NL + "\t\treturn true;";
  protected final String TEXT_206 = NL + "\t\t// TODO override the constraint" + NL + "\t\treturn ";
  ...
  protected final String TEXT_218 = NL + "\t\t// TODO implement the constraint" + NL + "\t\treturn true;";
