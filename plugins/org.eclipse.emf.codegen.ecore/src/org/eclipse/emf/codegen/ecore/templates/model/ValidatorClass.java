...
public class ValidatorClass
{
  ...
  protected final String TEXT_252 = NL + "\t\t\treportMinViolation(";
  protected final String TEXT_253 = ", new ";
  protected final String TEXT_254 = "(";
  protected final String TEXT_255 = "), new ";
  protected final String TEXT_256 = "(";
  protected final String TEXT_257 = "__VALUE), ";
  protected final String TEXT_258 = ", ";
  protected final String TEXT_259 = ", ";
  protected final String TEXT_260 = ");";
  protected final String TEXT_261 = NL + "\t\t\treportMinViolation(";
  protected final String TEXT_262 = ", ";
  protected final String TEXT_263 = ", ";
  protected final String TEXT_264 = "__VALUE, ";
  ...
  protected final String TEXT_293 = " != null)" + NL + "\t\t\treportMinViolation(";
  ...
  protected final String TEXT_301 = NL + "\t\tboolean ";
  protected final String TEXT_302 = " = ";
  protected final String TEXT_303 = " ";
  protected final String TEXT_304 = " ";
  protected final String TEXT_305 = "__VALUE;" + NL + "\t\tif (!";
  protected final String TEXT_306 = " && ";
  protected final String TEXT_307 = " != null)";
  protected final String TEXT_308 = NL + "\t\t\treportMaxViolation(";
  ...
  protected final String TEXT_317 = NL + "\t\t\treportMaxViolation(";
  ...
  protected final String TEXT_326 = NL + "\t\tint ";
  protected final String TEXT_327 = " = ";
  protected final String TEXT_328 = ".compareCalendar(";
  protected final String TEXT_329 = ", ";
  protected final String TEXT_330 = "__VALUE);" + NL + "\t\tboolean ";
  protected final String TEXT_331 = " = ";
  protected final String TEXT_332 = " == 0 || ";
  protected final String TEXT_333 = " == -1;";
  protected final String TEXT_334 = NL + "\t\tint ";
  protected final String TEXT_335 = " = ";
  protected final String TEXT_336 = ".compareDuration(";
  protected final String TEXT_337 = ", ";
  protected final String TEXT_338 = "__VALUE);" + NL + "\t\tboolean ";
  protected final String TEXT_339 = " = ";
  protected final String TEXT_340 = " == 0 || ";
  protected final String TEXT_341 = " == -1;";
  protected final String TEXT_342 = NL + "\t\tboolean ";
  protected final String TEXT_343 = " = ";
  protected final String TEXT_344 = ".compareTo(";
  protected final String TEXT_345 = "__VALUE) ";
  protected final String TEXT_346 = " 0;";
  protected final String TEXT_347 = NL + "\t\tif (!";
  protected final String TEXT_348 = " && ";
  protected final String TEXT_349 = " != null)" + NL + "\t\t\treportMaxViolation(";
  ...
  protected final String TEXT_357 = NL + "\t\tint length = ";
  ...
  protected final String TEXT_363 = " != null)" + NL + "\t\t\treportMinLengthViolation(";
  ...
  protected final String TEXT_370 = NL + "\t\tint length = ";
  protected final String TEXT_371 = ".";
  protected final String TEXT_372 = ";" + NL + "\t\tboolean ";
  protected final String TEXT_373 = " = length <= ";
  protected final String TEXT_374 = ";" + NL + "\t\tif (!";
  protected final String TEXT_375 = " && ";
  protected final String TEXT_376 = " != null)" + NL + "\t\t\treportMaxLengthViolation(";
  protected final String TEXT_377 = ", ";
  protected final String TEXT_378 = ", length, ";
  ...
  protected final String TEXT_386 = "__LOWER_BOUND && ";
  protected final String TEXT_387 = " < ";
  protected final String TEXT_388 = "__UPPER_BOUND;" + NL + "\t\tif (!";
  protected final String TEXT_389 = " && ";
  protected final String TEXT_390 = " != null)";
  protected final String TEXT_391 = NL + "\t\t\treportTotalDigitsViolation(";
  ...
  protected final String TEXT_398 = NL + "\t\t\treportTotalDigitsViolation(";
  ...
  protected final String TEXT_406 = ".unscaledValue().abs().toString().length() <= ";
  protected final String TEXT_407 = ";" + NL + "\t\tif (!";
  protected final String TEXT_408 = " && ";
  protected final String TEXT_409 = " != null)" + NL + "\t\t\treportTotalDigitsViolation(";
  ...
  protected final String TEXT_418 = "__LOWER_BOUND) > 0 && ";
  protected final String TEXT_419 = ".compareTo(";
  protected final String TEXT_420 = "__UPPER_BOUND) < 0;" + NL + "\t\tif (!";
  protected final String TEXT_421 = " && ";
  protected final String TEXT_422 = " != null)" + NL + "\t\t\treportTotalDigitsViolation(";
  ...
  protected final String TEXT_432 = ".scale() <= ";
  protected final String TEXT_433 = ";" + NL + "\t\tif (!";
  protected final String TEXT_434 = " && ";
  protected final String TEXT_435 = " != null)" + NL + "\t\t\treportFractionDigitsViolation(";
  ...
  protected final String TEXT_442 = NL + "\t\t// TODO override the constraint, if desired" + NL + "\t\t// -> uncomment the scaffolding" + NL + "\t\t// -> specify the condition that violates the constraint" + NL + "\t\t// -> verify the diagnostic details, including severity, code, and message" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tif (false)" + NL + "\t\t{" + NL + "\t\t\tif (";
  protected final String TEXT_443 = " != null)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  protected final String TEXT_444 = ".add";
  protected final String TEXT_445 = NL + "\t\t\t\t\t(createDiagnostic" + NL + "\t\t\t\t\t\t(";
  protected final String TEXT_446 = ".ERROR," + NL + "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL + "\t\t\t\t\t\t \"_UI_GenericConstraint_diagnostic\",";
  protected final String TEXT_447 = NL + "\t\t\t\t\t\t new Object[] { \"";
  protected final String TEXT_448 = "\", getValueLabel(";
  protected final String TEXT_449 = ", ";
  protected final String TEXT_450 = ", ";
  protected final String TEXT_451 = ") },";
  protected final String TEXT_452 = NL + "\t\t\t\t\t\t new Object[] { ";
  protected final String TEXT_453 = " }," + NL + "\t\t\t\t\t\t context));";
  protected final String TEXT_454 = NL + "\t\t\t\t\t(new ";
  protected final String TEXT_455 = NL + "\t\t\t\t\t\t(";
  protected final String TEXT_456 = ".ERROR," + NL + "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_457 = ".INSTANCE.getString(\"_UI_GenericConstraint_diagnostic\", new Object[] { \"";
  ...
  protected final String TEXT_471 = NL + "\t\t// TODO implement the constraint" + NL + "\t\t// -> specify the condition that violates the constraint" + NL + "\t\t// -> verify the diagnostic details, including severity, code, and message" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tif (false)" + NL + "\t\t{" + NL + "\t\t\tif (";
  protected final String TEXT_472 = " != null)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  protected final String TEXT_473 = ".add";
  protected final String TEXT_474 = NL + "\t\t\t\t\t(createDiagnostic" + NL + "\t\t\t\t\t\t(";
  protected final String TEXT_475 = ".ERROR," + NL + "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL + "\t\t\t\t\t\t \"_UI_GenericConstraint_diagnostic\",";
  ...
  protected final String TEXT_482 = " }," + NL + "\t\t\t\t\t\t context));";
  protected final String TEXT_483 = NL + "\t\t\t\t\t(new ";
  protected final String TEXT_484 = NL + "\t\t\t\t\t\t(";
  protected final String TEXT_485 = ".ERROR," + NL + "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_486 = ".INSTANCE.getString(\"_UI_GenericConstraint_diagnostic\", new Object[] { \"";
  protected final String TEXT_487 = "\", getValueLabel(";
  protected final String TEXT_488 = ", ";
  protected final String TEXT_489 = ", ";
  protected final String TEXT_490 = ") }),";
  protected final String TEXT_491 = NL + "\t\t\t\t\t\t new Object[] { ";
  protected final String TEXT_492 = " }));";
  protected final String TEXT_493 = NL + "\t\t\t}" + NL + "\t\t\treturn false;" + NL + "\t\t}" + NL + "\t\treturn true;";
  protected final String TEXT_494 = NL + "\t\t// TODO override the constraint, if desired" + NL + "\t\t// -> uncomment the scaffolding" + NL + "\t\t// -> specify the condition that violates the constraint" + NL + "\t\t// -> verify the diagnostic details, including severity, code, and message" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tif (false)" + NL + "\t\t{" + NL + "\t\t\tif (";
  protected final String TEXT_495 = " != null)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  protected final String TEXT_496 = ".add";
  protected final String TEXT_497 = NL + "\t\t\t\t\t(createDiagnostic" + NL + "\t\t\t\t\t\t(";
  protected final String TEXT_498 = ".ERROR," + NL + "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL + "\t\t\t\t\t\t \"_UI_GenericConstraint_diagnostic\",";
  protected final String TEXT_499 = NL + "\t\t\t\t\t\t new Object[] { \"";
  protected final String TEXT_500 = "\", getObjectLabel(";
  protected final String TEXT_501 = ", ";
  protected final String TEXT_502 = ") },";
  protected final String TEXT_503 = NL + "\t\t\t\t\t\t new Object[] { ";
  protected final String TEXT_504 = " }," + NL + "\t\t\t\t\t\t context));";
  protected final String TEXT_505 = NL + "\t\t\t\t\t(new ";
  protected final String TEXT_506 = NL + "\t\t\t\t\t\t(";
  protected final String TEXT_507 = ".ERROR," + NL + "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_508 = ".INSTANCE.getString(\"_UI_GenericConstraint_diagnostic\", new Object[] { \"";
  protected final String TEXT_509 = "\", getObjectLabel(";
  protected final String TEXT_510 = ", ";
  protected final String TEXT_511 = ") }),";
  protected final String TEXT_512 = NL + "\t\t\t\t\t\t new Object[] { ";
  protected final String TEXT_513 = " }));";
  protected final String TEXT_514 = NL + "\t\t\t}" + NL + "\t\t\treturn false;" + NL + "\t\t}" + NL + "\t\treturn ";
  protected final String TEXT_515 = "validate";
  ...
  protected final String TEXT_526 = NL + "\t\t// TODO implement the constraint" + NL + "\t\t// -> specify the condition that violates the constraint" + NL + "\t\t// -> verify the diagnostic details, including severity, code, and message" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tif (false)" + NL + "\t\t{" + NL + "\t\t\tif (";
  protected final String TEXT_527 = " != null)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  protected final String TEXT_528 = ".add";
  protected final String TEXT_529 = NL + "\t\t\t\t\t(createDiagnostic" + NL + "\t\t\t\t\t\t(";
  protected final String TEXT_530 = ".ERROR," + NL + "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL + "\t\t\t\t\t\t \"_UI_GenericConstraint_diagnostic\",";
  protected final String TEXT_531 = NL + "\t\t\t\t\t\t new Object[] { \"";
  protected final String TEXT_532 = "\", getObjectLabel(";
  protected final String TEXT_533 = ", ";
  protected final String TEXT_534 = ") },";
  protected final String TEXT_535 = NL + "\t\t\t\t\t\t new Object[] { ";
  protected final String TEXT_536 = " }," + NL + "\t\t\t\t\t\t context));";
  protected final String TEXT_537 = NL + "\t\t\t\t\t(new ";
  protected final String TEXT_538 = NL + "\t\t\t\t\t\t(";
  protected final String TEXT_539 = ".ERROR," + NL + "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_540 = ".INSTANCE.getString(\"_UI_GenericConstraint_diagnostic\", new Object[] { \"";
  protected final String TEXT_541 = "\", getObjectLabel(";
  protected final String TEXT_542 = ", ";
  protected final String TEXT_543 = ") }),";
  protected final String TEXT_544 = NL + "\t\t\t\t\t\t new Object[] { ";
  protected final String TEXT_545 = " }));";
  protected final String TEXT_546 = NL + "\t\t\t}" + NL + "\t\t\treturn false;" + NL + "\t\t}" + NL + "\t\treturn true;";
  protected final String TEXT_547 = NL + "\t}" + NL;
  protected final String TEXT_548 = NL + "\t/**" + NL + "\t * Returns the resource locator that will be used to fetch messages for this validator's diagnostics." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_549 = NL + "\t@Override";
  protected final String TEXT_550 = NL + "\tpublic ";
  protected final String TEXT_551 = " getResourceLocator()" + NL + "\t{";
  protected final String TEXT_552 = NL + "\t\treturn ";
  protected final String TEXT_553 = ".INSTANCE;";
  protected final String TEXT_554 = NL + "\t\t// TODO" + NL + "\t\t// Specialize this to return a resource locator for messages specific to this validator." + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\treturn super.getResourceLocator();";
