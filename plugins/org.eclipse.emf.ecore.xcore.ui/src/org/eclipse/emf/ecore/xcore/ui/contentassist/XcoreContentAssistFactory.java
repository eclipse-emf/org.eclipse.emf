...
public class XcoreContentAssistFactory extends StatefulFactory
{
  @Override
  ...
  {
    return ((PartialParsingContentAssistParser)parser).getFollowElements(parseResult, offset, strict);
  }
  ...
  {
    return InternalXcoreParser.RULE_ANY_OTHER == token;
  }
}
