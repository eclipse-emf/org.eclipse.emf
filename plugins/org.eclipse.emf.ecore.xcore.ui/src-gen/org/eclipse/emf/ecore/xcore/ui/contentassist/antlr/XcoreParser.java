		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getXReferenceAccess().getGroup_1_1(), "rule__XReference__Group_1_1__0");
					put(grammarAccess.getXReferenceAccess().getGroup_1_2(), "rule__XReference__Group_1_2__0");
					put(grammarAccess.getXReferenceAccess().getGroup_1_4(), "rule__XReference__Group_1_4__0");
					put(grammarAccess.getXReferenceAccess().getGroup_1_5(), "rule__XReference__Group_1_5__0");
					put(grammarAccess.getXReferenceAccess().getGroup_1_7(), "rule__XReference__Group_1_7__0");
					put(grammarAccess.getXReferenceAccess().getGroup_1_8(), "rule__XReference__Group_1_8__0");
					...
					put(grammarAccess.getXReferenceAccess().getResolveProxiesAssignment_1_1_0(), "rule__XReference__ResolveProxiesAssignment_1_1_0");
					put(grammarAccess.getXReferenceAccess().getContainmentAssignment_1_1_1(), "rule__XReference__ContainmentAssignment_1_1_1");
					put(grammarAccess.getXReferenceAccess().getContainmentAssignment_1_2_0(), "rule__XReference__ContainmentAssignment_1_2_0");
					put(grammarAccess.getXReferenceAccess().getResolveProxiesAssignment_1_2_1(), "rule__XReference__ResolveProxiesAssignment_1_2_1");
					put(grammarAccess.getXReferenceAccess().getContainerAssignment_1_3(), "rule__XReference__ContainerAssignment_1_3");
					put(grammarAccess.getXReferenceAccess().getResolveProxiesAssignment_1_4_0(), "rule__XReference__ResolveProxiesAssignment_1_4_0");
					put(grammarAccess.getXReferenceAccess().getContainerAssignment_1_4_1(), "rule__XReference__ContainerAssignment_1_4_1");
					put(grammarAccess.getXReferenceAccess().getContainerAssignment_1_5_0(), "rule__XReference__ContainerAssignment_1_5_0");
					put(grammarAccess.getXReferenceAccess().getResolveProxiesAssignment_1_5_1(), "rule__XReference__ResolveProxiesAssignment_1_5_1");
					put(grammarAccess.getXReferenceAccess().getLocalAssignment_1_7_0(), "rule__XReference__LocalAssignment_1_7_0");
					put(grammarAccess.getXReferenceAccess().getLocalAssignment_1_8_1(), "rule__XReference__LocalAssignment_1_8_1");
