 ...
 * </copyright>
 *
 * $Id: EEnumLiteralImpl.java,v 1.1.2.1 2005/06/08 18:27:43 nickb Exp $
 */
...
public class EEnumLiteralImpl extends ENamedElementImpl implements EEnumLiteral
{
  ...
  public NotificationChain eBasicRemoveFromContainer(NotificationChain msgs)
  {
    if (eContainerFeatureID >= 0)
    {
      ...
      {
        case EcorePackage.EENUM_LITERAL__EENUM:
          return ((InternalEObject)eContainer).eInverseRemove(this, EcorePackage.EENUM__ELITERALS, EEnum.class, msgs);
        default:
