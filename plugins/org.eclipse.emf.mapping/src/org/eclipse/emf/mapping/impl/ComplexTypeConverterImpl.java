 ...
 * </copyright>
 *
 * $Id: ComplexTypeConverterImpl.java,v 1.1.2.1 2005/06/08 18:27:44 nickb Exp $
 */
...
public class ComplexTypeConverterImpl extends TypeConverterImpl implements ComplexTypeConverter
{
    ...
    if (featureID >= 0)
    {
      switch (eDerivedStructuralFeatureID(featureID, baseClass))
      {
        case MappingPackage.COMPLEX_TYPE_CONVERTER__MAPPER:
          ...
          return eBasicSetContainer(otherEnd, MappingPackage.COMPLEX_TYPE_CONVERTER__MAPPER, msgs);
        case MappingPackage.COMPLEX_TYPE_CONVERTER__NESTED_IN:
          if (eContainer != null)
            msgs = eBasicRemoveFromContainer(msgs);
          return eBasicSetContainer(otherEnd, MappingPackage.COMPLEX_TYPE_CONVERTER__NESTED_IN, msgs);
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs)
  {
    if (featureID >= 0)
    {
      ...
      {
        case MappingPackage.COMPLEX_TYPE_CONVERTER__MAPPER:
          return eBasicSetContainer(null, MappingPackage.COMPLEX_TYPE_CONVERTER__MAPPER, msgs);
        case MappingPackage.COMPLEX_TYPE_CONVERTER__NESTED_IN:
          return eBasicSetContainer(null, MappingPackage.COMPLEX_TYPE_CONVERTER__NESTED_IN, msgs);
        case MappingPackage.COMPLEX_TYPE_CONVERTER__NESTED:
