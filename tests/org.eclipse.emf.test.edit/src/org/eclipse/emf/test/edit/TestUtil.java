 ...
 * </copyright>
 *
 * $Id: TestUtil.java,v 1.2 2005/02/22 05:17:48 marcelop Exp $
 */
...
public class TestUtil
{
  ...
  public static String getPluginDirectory()
  {
    try
    {
       return new File(Platform.asLocalURL(EMFTestEditPlugin.getPlugin().getBundle().getEntry("/")).getFile()).toString();
    }
    catch (Throwable t)
    {
    }
