 ...
 * </copyright>
 *
 * $Id: EPOAdapterFactory.java,v 1.1.2.1 2005/05/30 19:26:59 nickb Exp $
 */
...
public class EPOAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected EPOSwitch modelSwitch =
		new EPOSwitch() {
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.example.epo.Item <em>Item</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.example.epo.USAddress <em>US Address</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.example.epo.PurchaseOrder <em>Purchase Order</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.example.epo.Supplier <em>Supplier</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
