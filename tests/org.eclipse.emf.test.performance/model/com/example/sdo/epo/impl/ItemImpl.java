 ...
 * </copyright>
 *
 * $Id: ItemImpl.java,v 1.1.2.1 2005/05/30 19:26:59 nickb Exp $
 */
 ...
 * <ul>
 *   <li>{@link com.example.sdo.epo.impl.ItemImpl#getProductName <em>Product Name</em>}</li>
 *   <li>{@link com.example.sdo.epo.impl.ItemImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link com.example.sdo.epo.impl.ItemImpl#getUSPrice <em>US Price</em>}</li>
 *   <li>{@link com.example.sdo.epo.impl.ItemImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link com.example.sdo.epo.impl.ItemImpl#getShipDate <em>Ship Date</em>}</li>
 *   <li>{@link com.example.sdo.epo.impl.ItemImpl#getPartNum <em>Part Num</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ItemImpl extends EDataObjectImpl implements Item {
	...
	protected EClass eStaticClass() {
		return EPOPackage.eINSTANCE.getItem();
	}
	...
	public void setProductName(String newProductName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EPOPackage.ITEM__PRODUCT_NAME, oldProductName, productName));
	}
	...
	public void setQuantity(int newQuantity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EPOPackage.ITEM__QUANTITY, oldQuantity, quantity));
	}
	...
	public void setUSPrice(int newUSPrice) {
		...
		usPrice = newUSPrice;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EPOPackage.ITEM__US_PRICE, oldUSPrice, usPrice));
	}
	...
	public void setComment(String newComment) {
		...
		comment = newComment;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EPOPackage.ITEM__COMMENT, oldComment, comment));
	}
	...
	public void setShipDate(Date newShipDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EPOPackage.ITEM__SHIP_DATE, oldShipDate, shipDate));
	}
	...
	public void setPartNum(String newPartNum) {
		...
		partNum = newPartNum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EPOPackage.ITEM__PART_NUM, oldPartNum, partNum));
	}
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case EPOPackage.ITEM__US_PRICE:
				return new Integer(getUSPrice());
			case EPOPackage.ITEM__COMMENT:
				return getComment();
			case EPOPackage.ITEM__SHIP_DATE:
				return getShipDate();
			case EPOPackage.ITEM__PART_NUM:
				return getPartNum();
		}
