 ...
 * </copyright>
 *
 * $Id: DynamicSDODeserializationTest.java,v 1.1 2005/02/15 20:21:05 bportier Exp $
 */
 ...
 */
public class DynamicSDODeserializationTest extends EMFPerformanceTestCase
{
  ...
  public DynamicSDODeserializationTest(String name)
  {
    super(name);
  ...
  public static Test suite()
  {
    ...
    ts.addTest(new DynamicSDODeserializationTest("testLoad").setRepetitions(REPETITIONS));
    ts.addTest(new DynamicSDODeserializationTest("testLoadParserCache").setRepetitions(REPETITIONS));
    ts.addTest(new DynamicSDODeserializationTest("testLoadParserAndFeatureMapCache").setRepetitions(REPETITIONS));
    return ts;
  }
