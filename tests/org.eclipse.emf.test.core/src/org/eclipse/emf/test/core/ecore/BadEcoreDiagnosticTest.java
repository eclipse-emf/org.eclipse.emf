...
public class BadEcoreDiagnosticTest extends TestCase
{
  ...
  public void testDiagnostic() throws Exception
  {
    ...
    assertEquals(102, diagnostic1.getChildren().size());
    ...
    assertEquals("The namespace prefix 'xml.prefix' is not well formed", removeObjectHashCode(diagnostic58.getMessage()));
    ...
    assertEquals("The namespace prefix 'bad.package:nonNSNamePrefix' is not well formed", removeObjectHashCode(diagnostic59.getMessage()));
    ...
    assertEquals("There may not be two classifiers named 'a'", removeObjectHashCode(diagnostic60.getMessage()));
    assertEquals(29, diagnostic60.getCode());
    ...
    assertEquals(Diagnostic.WARNING, diagnostic61.getSeverity());
    assertEquals("org.eclipse.emf.ecore.model", diagnostic61.getSource());
    assertEquals("There may not be a classifier named 'A_' as well a classifier named 'a'", removeObjectHashCode(diagnostic61.getMessage()));
    ...
    assertEquals("There may not be two packages with namespace URI 'platform:/plugin/org.eclipse.emf.test.core/models/Bad.ecore#//package/duplicateNsURIs/a1'", removeObjectHashCode(diagnostic62.getMessage()));
    assertEquals(33, diagnostic62.getCode());
    ...
    assertEquals("The opposite of the opposite may not be a reference different from this one", removeObjectHashCode(diagnostic64.getMessage()));
    assertEquals(14, diagnostic64.getCode());
    assertEquals(0, diagnostic64.getChildren().size());
    assertEquals(3, diagnostic64.getData().size());
    ...
    assertEquals("The opposite must be a feature of the reference's type", removeObjectHashCode(diagnostic65.getMessage()));
    assertEquals(13, diagnostic65.getCode());
    ...
    assertEquals("The opposite of a transient reference must transient if it is proxy resolving", removeObjectHashCode(diagnostic66.getMessage()));
    assertEquals(11, diagnostic66.getCode());
    ...
    assertEquals("A container reference must have upper bound of 1 not 2", removeObjectHashCode(diagnostic67.getMessage()));
    assertEquals(28, diagnostic67.getCode());
    ...
    assertEquals("The opposite of a containment reference must not be a containment reference", removeObjectHashCode(diagnostic68.getMessage()));
    assertEquals(12, diagnostic68.getCode());
    ...
    assertEquals("The lower bound -1 must be greater than or equal to 0", removeObjectHashCode(diagnostic70.getMessage()));
    assertEquals(39, diagnostic70.getCode());
    ...
    assertEquals("The upper bound 0 must be -2, -1, or greater than 0", removeObjectHashCode(diagnostic71.getMessage()));
    assertEquals(41, diagnostic71.getCode());
    ...
    assertEquals("The upper bound -3 must be -2, -1, or greater than 0", removeObjectHashCode(diagnostic72.getMessage()));
    ...
    assertEquals("The lower bound 2 must be less than or equal to the upper bound 1", removeObjectHashCode(diagnostic73.getMessage()));
    assertEquals(6, diagnostic73.getCode());
    ...
    assertEquals("The required feature 'eAttributeType' of 'org.eclipse.emf.ecore.impl.EAttributeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//genericType/AttributeClassType/a}' must be set", removeObjectHashCode(diagnostic74.getMessage()));
    ...
    assertEquals("The generic attribute type must not refer to a class", removeObjectHashCode(diagnostic75.getMessage()));
    assertEquals(19, diagnostic75.getCode());
    ...
    assertEquals("org.eclipse.emf.ecore", diagnostic76.getSource());
    assertEquals("The required feature 'eReferenceType' of 'org.eclipse.emf.ecore.impl.EReferenceImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//genericType/ReferenceDataType/r}' must be set", removeObjectHashCode(diagnostic76.getMessage()));
    assertEquals(1, diagnostic76.getCode());
    ...
    assertEquals("The generic reference type must not refer to a data type", removeObjectHashCode(diagnostic77.getMessage()));
    assertEquals(20, diagnostic77.getCode());
    ...
    assertEquals("A generic type can't refer to both a type parameter and a classifier", removeObjectHashCode(diagnostic78.getMessage()));
    assertEquals(21, diagnostic78.getCode());
    ...
    assertEquals("A generic super type must refer to a class", removeObjectHashCode(diagnostic79.getMessage()));
    assertEquals(18, diagnostic79.getCode());
    ...
    assertEquals("The generic super types at index '1' and '0' must not be duplicates", removeObjectHashCode(diagnostic81.getMessage()));
    assertEquals(16, diagnostic81.getCode());
    ...
    assertEquals("A generic type in this context must refer to a classifier or a type parameter", removeObjectHashCode(diagnostic82.getMessage()));
    assertEquals(24, diagnostic82.getCode());
    ...
    assertEquals("A generic type must not have both a lower and an upper bound", removeObjectHashCode(diagnostic83.getMessage()));
    assertEquals(9, diagnostic83.getCode());
    ...
    assertEquals("A generic type may have bounds only when used as a type argument", removeObjectHashCode(diagnostic84.getMessage()));
    assertEquals(7, diagnostic84.getCode());
    ...
    assertEquals("A generic type with bounds must not also refer to a type parameter or classifier", removeObjectHashCode(diagnostic85.getMessage()));
    assertEquals(8, diagnostic85.getCode());
    ...
    assertEquals("A generic type may have arguments only if it refers to a classifier", removeObjectHashCode(diagnostic86.getMessage()));
    assertEquals(5, diagnostic86.getCode());
    ...
    assertEquals(Diagnostic.WARNING, diagnostic87.getSeverity());
    assertEquals("org.eclipse.emf.ecore.model", diagnostic87.getSource());
    assertEquals("The generic type associated with the 'EJavaClass' classifier should have 1 type argument(s) to match the number of type parameter(s) of the classifier ", removeObjectHashCode(diagnostic87.getMessage()));
    assertEquals(4, diagnostic87.getCode());
    ...
    assertEquals("The generic type associated with the 'EJavaClass' classifier must not have 2 argument(s) when the classifier has 1 type parameter(s)", removeObjectHashCode(diagnostic88.getMessage()));
    assertEquals(2, diagnostic88.getCode());
    ...
    assertEquals("A generic type may only refer to a type parameter that is in scope", removeObjectHashCode(diagnostic89.getMessage()));
    ...
    assertEquals("The generic super types instantiate 'org.eclipse.emf.ecore.impl.EClassImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//genericType/BaseClass}' inconsistently", removeObjectHashCode(diagnostic90.getMessage()));
    assertEquals(15, diagnostic90.getCode());
    ...
    assertEquals("A generic type may only refer to a type parameter that is in scope", removeObjectHashCode(diagnostic91.getMessage()));
    assertEquals(23, diagnostic91.getCode());
    ...
    assertEquals("The primitive type 'int' cannot be used in this context", removeObjectHashCode(diagnostic93.getMessage()));
    ...
    assertEquals("The key 'org.eclipse.emf.ecore.impl.EAttributeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//key/ReferenceWithKeyNotFromReferenceType/a}' must be feature of the reference's type", removeObjectHashCode(diagnostic98.getMessage()));
    assertEquals(10, diagnostic98.getCode());
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container/f/b//.1}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container/U}'", removeObjectHashCode(diagnostic99.getMessage()));
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container/f/g//.2}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container/V}'", removeObjectHashCode(diagnostic101.getMessage()));
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container2/g/b//.1}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container2/U}'", removeObjectHashCode(diagnostic102.getMessage()));
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/g/b//.1}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/U}'", removeObjectHashCode(diagnostic104.getMessage()));
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/g/g//.2}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/V}'", removeObjectHashCode(diagnostic106.getMessage()));
    ...
    assertEquals(Diagnostic.WARNING, diagnostic108.getSeverity());
    assertEquals("org.eclipse.emf.ecore.model", diagnostic108.getSource());
    assertEquals("The generic type associated with the 'A' classifier should have 1 type argument(s) to match the number of type parameter(s) of the classifier ", removeObjectHashCode(diagnostic108.getMessage()));
    assertEquals(4, diagnostic108.getCode());
    assertEquals(0, diagnostic108.getChildren().size());
    assertEquals(1, diagnostic108.getData().size());
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/h/b//.1}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/U}'", removeObjectHashCode(diagnostic109.getMessage()));
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/h/g//.2}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/V}'", removeObjectHashCode(diagnostic111.getMessage()));
    ...
    assertEquals(Diagnostic.WARNING, diagnostic113.getSeverity());
    assertEquals("org.eclipse.emf.ecore.model", diagnostic113.getSource());
    assertEquals("The generic type associated with the 'B' classifier should have 1 type argument(s) to match the number of type parameter(s) of the classifier ", removeObjectHashCode(diagnostic113.getMessage()));
    assertEquals(4, diagnostic113.getCode());
    assertEquals(0, diagnostic113.getChildren().size());
    assertEquals(1, diagnostic113.getData().size());
    ...
    assertEquals("The default value literal '256' must be a valid literal of the attribute's type", removeObjectHashCode(diagnostic114.getMessage()));
    assertEquals(39, diagnostic114.getCode());
    assertEquals(1, diagnostic114.getChildren().size());
    ...
    assertEquals("org.eclipse.emf.ecore", diagnostic115.getSource());
    assertEquals("The value '256' must be less than or equal to '255' ", removeObjectHashCode(diagnostic115.getMessage()));
    assertEquals(5, diagnostic115.getCode());
    ...
    assertEquals("The default value literal '' must be a valid literal of the attribute's type", removeObjectHashCode(diagnostic116.getMessage()));
    assertEquals(39, diagnostic116.getCode());
    assertEquals(0, diagnostic116.getChildren().size());
    assertEquals(1, diagnostic116.getData().size());
