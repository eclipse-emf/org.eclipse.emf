...
public class BadEcoreDiagnosticTest extends TestCase
{
  ...
  public void testDiagnostic() throws Exception
  {
    ...
    assertEquals("There may not be two enumerators named 'A'", removeObjectHashCode(diagnostic46.getMessage()));
    ...
    assertEquals("There should not be an enumerator named 'A' as well an enumerator named 'a'", removeObjectHashCode(diagnostic47.getMessage()));
    ...
    assertEquals("There should not be an enumerator named 'A_' as well an enumerator named 'a'", removeObjectHashCode(diagnostic48.getMessage()));
    assertEquals(31, diagnostic48.getCode());
    ...
    assertEquals("There may not be two enumerators with literal value 'x'", removeObjectHashCode(diagnostic49.getMessage()));
    assertEquals(30, diagnostic49.getCode());
    ...
    assertEquals("There may not be two parameters named 'x'", removeObjectHashCode(diagnostic50.getMessage()));
    assertEquals(35, diagnostic50.getCode());
    ...
    assertEquals("There may not be two type parameters named 'T'", removeObjectHashCode(diagnostic51.getMessage()));
    ...
    assertEquals("There may not be two type parameters named 'A'", removeObjectHashCode(diagnostic52.getMessage()));
    assertEquals(37, diagnostic52.getCode());
    ...
    assertEquals("An operation with void return type must have an upper bound of 1 not -1", removeObjectHashCode(diagnostic53.getMessage()));
    assertEquals(27, diagnostic53.getCode());
    ...
    assertEquals("There may not be two packages named 'duplicateName'", removeObjectHashCode(diagnostic54.getMessage()));
    assertEquals(36, diagnostic54.getCode());
    ...
    assertEquals("The namespace URI 'null' is not well formed", removeObjectHashCode(diagnostic55.getMessage()));
    ...
    assertEquals("The namespace URI '' is not well formed", removeObjectHashCode(diagnostic56.getMessage()));
    ...
    assertEquals("The namespace URI 'NSUI With Space' is not well formed", removeObjectHashCode(diagnostic57.getMessage()));
    ...
    assertEquals("The namespace URI 'NsURIWithUnencoded%' is not well formed", removeObjectHashCode(diagnostic58.getMessage()));
    assertEquals(46, diagnostic58.getCode());
