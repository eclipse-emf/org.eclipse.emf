...
public class BadEcoreDiagnosticTest extends TestCase
{
  ...
  public void testDiagnostic() throws Exception
  {
    ...
    assertEquals("A class that is an interface must also be abstract", removeObjectHashCode(diagnostic19.getMessage()));
    ...
    assertEquals("The features 'a' and 'b' cannot both be IDs", removeObjectHashCode(diagnostic20.getMessage()));
    ...
    assertEquals("There may not be two features named 'a'", removeObjectHashCode(diagnostic22.getMessage()));
    ...
    assertEquals("There should not be a feature named 'A' as well a feature named 'a'", removeObjectHashCode(diagnostic23.getMessage()));
    ...
    assertEquals("There should not be a feature named 'A_' as well a feature named 'a'", removeObjectHashCode(diagnostic24.getMessage()));
    ...
    assertEquals("There may not be two operations 'org.eclipse.emf.ecore.impl.EOperationImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//class/TwoOperationsWithMatchingSignatures/f.1}' and 'org.eclipse.emf.ecore.impl.EOperationImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//class/TwoOperationsWithMatchingSignatures/f}' with the same signature", removeObjectHashCode(diagnostic25.getMessage()));
    ...
    assertEquals("A class may not be a super type of itself", removeObjectHashCode(diagnostic26.getMessage()));
    assertEquals(26, diagnostic26.getCode());
    ...
    assertEquals("There may not be two enumerators named 'A'", removeObjectHashCode(diagnostic30.getMessage()));
    assertEquals(31, diagnostic30.getCode());
    ...
    assertEquals(Diagnostic.WARNING, diagnostic31.getSeverity());
    assertEquals("org.eclipse.emf.ecore.model", diagnostic31.getSource());
    assertEquals("There should not be an enumerator named 'A' as well an enumerator named 'a'", removeObjectHashCode(diagnostic31.getMessage()));
    ...
    assertEquals("There should not be an enumerator named 'A_' as well an enumerator named 'a'", removeObjectHashCode(diagnostic32.getMessage()));
    ...
    assertEquals("There may not be two enumerators with literal value 'x'", removeObjectHashCode(diagnostic33.getMessage()));
    assertEquals(30, diagnostic33.getCode());
    ...
    assertEquals("There may not be two parameters named 'x'", removeObjectHashCode(diagnostic34.getMessage()));
    assertEquals(35, diagnostic34.getCode());
    ...
    assertEquals("There may not be two type parameters named 'T'", removeObjectHashCode(diagnostic35.getMessage()));
    assertEquals(37, diagnostic35.getCode());
    ...
    assertEquals("There may not be two type parameters named 'A'", removeObjectHashCode(diagnostic36.getMessage()));
    ...
    assertEquals("An operation with void return type must have an upper bound of 1 not -1", removeObjectHashCode(diagnostic37.getMessage()));
    assertEquals(27, diagnostic37.getCode());
    assertEquals(0, diagnostic37.getChildren().size());
    assertEquals(1, diagnostic37.getData().size());
    ...
    assertEquals("There may not be two packages named 'duplicateName'", removeObjectHashCode(diagnostic38.getMessage()));
    assertEquals(36, diagnostic38.getCode());
    ...
    assertEquals("There may not be two classifiers named 'a'", removeObjectHashCode(diagnostic46.getMessage()));
    assertEquals(29, diagnostic46.getCode());
    ...
    assertEquals("There may not be a classifier named 'A_' as well a classifier named 'a'", removeObjectHashCode(diagnostic47.getMessage()));
    ...
    assertEquals("There may not be two packages with namespace URI 'platform:/plugin/org.eclipse.emf.test.core/models/Bad.ecore#//package/duplicateNsURIs/a1'", removeObjectHashCode(diagnostic48.getMessage()));
    assertEquals(33, diagnostic48.getCode());
    assertEquals(0, diagnostic48.getChildren().size());
    assertEquals(2, diagnostic48.getData().size());
    ...
    assertEquals("The opposite of the opposite may not be a reference different from this one", removeObjectHashCode(diagnostic50.getMessage()));
    assertEquals(14, diagnostic50.getCode());
    ...
    assertEquals("The opposite must be a feature of the reference's type", removeObjectHashCode(diagnostic51.getMessage()));
    assertEquals(13, diagnostic51.getCode());
    ...
    assertEquals("The opposite of a transient reference must transient if it is proxy resolving", removeObjectHashCode(diagnostic52.getMessage()));
    assertEquals(11, diagnostic52.getCode());
    ...
    assertEquals("A container reference must have upper bound of 1 not 2", removeObjectHashCode(diagnostic53.getMessage()));
    assertEquals(28, diagnostic53.getCode());
    ...
    assertEquals("The opposite of a containment reference must not be a containment reference", removeObjectHashCode(diagnostic54.getMessage()));
    assertEquals(12, diagnostic54.getCode());
    assertEquals(0, diagnostic54.getChildren().size());
    assertEquals(2, diagnostic54.getData().size());
    ...
    assertEquals("The lower bound 2 must be less than or equal to the upper bound 1", removeObjectHashCode(diagnostic59.getMessage()));
    assertEquals(6, diagnostic59.getCode());
    ...
    assertEquals("org.eclipse.emf.ecore", diagnostic60.getSource());
    assertEquals("The required feature 'eAttributeType' of 'org.eclipse.emf.ecore.impl.EAttributeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//genericType/AttributeClassType/a}' must be set", removeObjectHashCode(diagnostic60.getMessage()));
    assertEquals(1, diagnostic60.getCode());
    ...
    assertEquals("The generic attribute type must not refer to a class", removeObjectHashCode(diagnostic61.getMessage()));
    assertEquals(19, diagnostic61.getCode());
    ...
    assertEquals("org.eclipse.emf.ecore", diagnostic62.getSource());
    assertEquals("The required feature 'eReferenceType' of 'org.eclipse.emf.ecore.impl.EReferenceImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//genericType/ReferenceDataType/r}' must be set", removeObjectHashCode(diagnostic62.getMessage()));
    assertEquals(1, diagnostic62.getCode());
    ...
    assertEquals("The generic reference type must not refer to a data type", removeObjectHashCode(diagnostic63.getMessage()));
    assertEquals(20, diagnostic63.getCode());
    ...
    assertEquals("A generic type can't refer to both a type parameter and a classifier", removeObjectHashCode(diagnostic64.getMessage()));
    assertEquals(21, diagnostic64.getCode());
    ...
    assertEquals("A generic super type must refer to a class", removeObjectHashCode(diagnostic65.getMessage()));
    assertEquals(18, diagnostic65.getCode());
    ...
    assertEquals("The generic super types at index '1' and '0' must not be duplicates", removeObjectHashCode(diagnostic67.getMessage()));
    assertEquals(16, diagnostic67.getCode());
    assertEquals(0, diagnostic67.getChildren().size());
    assertEquals(3, diagnostic67.getData().size());
    ...
    assertEquals("A generic type in this context must refer to a classifier or a type parameter", removeObjectHashCode(diagnostic68.getMessage()));
    assertEquals(24, diagnostic68.getCode());
    ...
    assertEquals("A generic type must not have both a lower and an upper bound", removeObjectHashCode(diagnostic69.getMessage()));
    assertEquals(9, diagnostic69.getCode());
    ...
    assertEquals("A generic type may have bounds only when used as a type argument", removeObjectHashCode(diagnostic70.getMessage()));
    assertEquals(7, diagnostic70.getCode());
    ...
    assertEquals("A generic type with bounds must not also refer to a type parameter or classifier", removeObjectHashCode(diagnostic71.getMessage()));
    assertEquals(8, diagnostic71.getCode());
    ...
    assertEquals("A generic type may have arguments only if it refers to a classifier", removeObjectHashCode(diagnostic72.getMessage()));
    assertEquals(5, diagnostic72.getCode());
    ...
    assertEquals(Diagnostic.WARNING, diagnostic73.getSeverity());
    assertEquals("org.eclipse.emf.ecore.model", diagnostic73.getSource());
    assertEquals("The generic type associated with the 'EJavaClass' classifier should have 1 type argument(s) to match the number of type parameter(s) of the classifier ", removeObjectHashCode(diagnostic73.getMessage()));
    assertEquals(4, diagnostic73.getCode());
    ...
    assertEquals("The generic type associated with the 'EJavaClass' classifier must not have 2 argument(s) when the classifier has 1 type parameter(s)", removeObjectHashCode(diagnostic74.getMessage()));
    assertEquals(2, diagnostic74.getCode());
    ...
    assertEquals("A generic type may only refer to a type parameter that is in scope", removeObjectHashCode(diagnostic75.getMessage()));
    assertEquals(23, diagnostic75.getCode());
    ...
    assertEquals("The generic super types instantiate 'org.eclipse.emf.ecore.impl.EClassImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//genericType/BaseClass}' inconsistently", removeObjectHashCode(diagnostic76.getMessage()));
    assertEquals(15, diagnostic76.getCode());
    ...
    assertEquals("A generic type may only refer to a type parameter that is in scope", removeObjectHashCode(diagnostic77.getMessage()));
    assertEquals(23, diagnostic77.getCode());
    ...
    assertEquals("The primitive type 'int' cannot be used in this context", removeObjectHashCode(diagnostic79.getMessage()));
    assertEquals(22, diagnostic79.getCode());
    ...
    assertEquals("The key 'org.eclipse.emf.ecore.impl.EAttributeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//key/ReferenceWithKeyNotFromReferenceType/a}' must be feature of the reference's type", removeObjectHashCode(diagnostic84.getMessage()));
    assertEquals(10, diagnostic84.getCode());
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container/f/b//.1}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container/U}'", removeObjectHashCode(diagnostic85.getMessage()));
    assertEquals(3, diagnostic85.getCode());
    assertEquals(0, diagnostic85.getChildren().size());
    assertEquals(3, diagnostic85.getData().size());
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container/f/g//.2}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container/V}'", removeObjectHashCode(diagnostic87.getMessage()));
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container2/g/b//.1}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container2/U}'", removeObjectHashCode(diagnostic88.getMessage()));
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/g/b//.1}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/U}'", removeObjectHashCode(diagnostic90.getMessage()));
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/g/g//.2}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/V}'", removeObjectHashCode(diagnostic92.getMessage()));
    ...
    assertEquals(Diagnostic.WARNING, diagnostic94.getSeverity());
    assertEquals("org.eclipse.emf.ecore.model", diagnostic94.getSource());
    assertEquals("The generic type associated with the 'A' classifier should have 1 type argument(s) to match the number of type parameter(s) of the classifier ", removeObjectHashCode(diagnostic94.getMessage()));
    assertEquals(4, diagnostic94.getCode());
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/h/b//.1}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/U}'", removeObjectHashCode(diagnostic95.getMessage()));
    assertEquals(3, diagnostic95.getCode());
    assertEquals(0, diagnostic95.getChildren().size());
    assertEquals(3, diagnostic95.getData().size());
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/h/g//.2}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/V}'", removeObjectHashCode(diagnostic97.getMessage()));
    ...
    assertEquals(Diagnostic.WARNING, diagnostic99.getSeverity());
    assertEquals("org.eclipse.emf.ecore.model", diagnostic99.getSource());
    assertEquals("The generic type associated with the 'B' classifier should have 1 type argument(s) to match the number of type parameter(s) of the classifier ", removeObjectHashCode(diagnostic99.getMessage()));
