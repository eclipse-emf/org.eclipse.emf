...
public class BadEcoreDiagnosticTest extends TestCase
{
  ...
  public void testDiagnostic() throws Exception
  {
    ...
    assertEquals(99, diagnostic1.getChildren().size());
    ...
    assertEquals("The instance type name 'T<X>[]' is not well formed", removeObjectHashCode(diagnostic18.getMessage()));
    ...
    assertEquals("The instance type name 'T<X Y>' is not well formed", removeObjectHashCode(diagnostic19.getMessage()));
    assertEquals(41, diagnostic19.getCode());
    ...
    assertEquals("A class that is an interface must also be abstract", removeObjectHashCode(diagnostic20.getMessage()));
    assertEquals(25, diagnostic20.getCode());
    ...
    assertEquals("The features 'a' and 'b' cannot both be IDs", removeObjectHashCode(diagnostic21.getMessage()));
    ...
    assertEquals("The features 'a' and 'b' cannot both be IDs", removeObjectHashCode(diagnostic22.getMessage()));
    assertEquals(1, diagnostic22.getCode());
    ...
    assertEquals("There may not be two features named 'a'", removeObjectHashCode(diagnostic23.getMessage()));
    ...
    assertEquals("There should not be a feature named 'A' as well a feature named 'a'", removeObjectHashCode(diagnostic24.getMessage()));
    ...
    assertEquals(Diagnostic.WARNING, diagnostic25.getSeverity());
    assertEquals("org.eclipse.emf.ecore.model", diagnostic25.getSource());
    assertEquals("There should not be a feature named 'A_' as well a feature named 'a'", removeObjectHashCode(diagnostic25.getMessage()));
    assertEquals(32, diagnostic25.getCode());
    ...
    assertEquals("There may not be two operations 'org.eclipse.emf.ecore.impl.EOperationImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//class/TwoOperationsWithMatchingSignatures/f.1}' and 'org.eclipse.emf.ecore.impl.EOperationImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//class/TwoOperationsWithMatchingSignatures/f}' with the same signature", removeObjectHashCode(diagnostic26.getMessage()));
    assertEquals(34, diagnostic26.getCode());
    ...
    assertEquals("A class may not be a super type of itself", removeObjectHashCode(diagnostic27.getMessage()));
    assertEquals(26, diagnostic27.getCode());
    ...
    assertEquals("A class may not be a super type of itself", removeObjectHashCode(diagnostic28.getMessage()));
    assertEquals(26, diagnostic28.getCode());
    ...
    assertEquals("A map entry class must have a feature called 'key'", removeObjectHashCode(diagnostic29.getMessage()));
    ...
    assertEquals("A map entry class must have a feature called 'value'", removeObjectHashCode(diagnostic30.getMessage()));
    ...
    assertEquals("There may not be two enumerators named 'A'", removeObjectHashCode(diagnostic31.getMessage()));
    assertEquals(31, diagnostic31.getCode());
    ...
    assertEquals(Diagnostic.WARNING, diagnostic32.getSeverity());
    assertEquals("org.eclipse.emf.ecore.model", diagnostic32.getSource());
    assertEquals("There should not be an enumerator named 'A' as well an enumerator named 'a'", removeObjectHashCode(diagnostic32.getMessage()));
    assertEquals(31, diagnostic32.getCode());
    ...
    assertEquals(Diagnostic.WARNING, diagnostic33.getSeverity());
    assertEquals("org.eclipse.emf.ecore.model", diagnostic33.getSource());
    assertEquals("There should not be an enumerator named 'A_' as well an enumerator named 'a'", removeObjectHashCode(diagnostic33.getMessage()));
    assertEquals(31, diagnostic33.getCode());
    ...
    assertEquals("There may not be two enumerators with literal value 'x'", removeObjectHashCode(diagnostic34.getMessage()));
    assertEquals(30, diagnostic34.getCode());
    ...
    assertEquals("There may not be two parameters named 'x'", removeObjectHashCode(diagnostic35.getMessage()));
    assertEquals(35, diagnostic35.getCode());
    ...
    assertEquals("There may not be two type parameters named 'T'", removeObjectHashCode(diagnostic36.getMessage()));
    assertEquals(37, diagnostic36.getCode());
    ...
    assertEquals("There may not be two type parameters named 'A'", removeObjectHashCode(diagnostic37.getMessage()));
    assertEquals(37, diagnostic37.getCode());
    ...
    assertEquals("An operation with void return type must have an upper bound of 1 not -1", removeObjectHashCode(diagnostic38.getMessage()));
    assertEquals(27, diagnostic38.getCode());
    ...
    assertEquals("There may not be two packages named 'duplicateName'", removeObjectHashCode(diagnostic39.getMessage()));
    assertEquals(36, diagnostic39.getCode());
    ...
    assertEquals("The namespace URI 'null' is not well formed", removeObjectHashCode(diagnostic40.getMessage()));
    ...
    assertEquals("The namespace URI '' is not well formed", removeObjectHashCode(diagnostic41.getMessage()));
    ...
    assertEquals("The namespace URI 'NSUI With Space' is not well formed", removeObjectHashCode(diagnostic42.getMessage()));
    ...
    assertEquals("The namespace URI 'NsURIWithUnencoded%' is not well formed", removeObjectHashCode(diagnostic43.getMessage()));
    ...
    assertEquals("The namespace prefix '' is not well formed", removeObjectHashCode(diagnostic44.getMessage()));
    ...
    assertEquals("The namespace prefix 'xml.prefix' is not well formed", removeObjectHashCode(diagnostic45.getMessage()));
    ...
    assertEquals("The namespace prefix 'bad.package:nonNSNamePrefix' is not well formed", removeObjectHashCode(diagnostic46.getMessage()));
    assertEquals(44, diagnostic46.getCode());
    assertEquals(0, diagnostic46.getChildren().size());
    assertEquals(1, diagnostic46.getData().size());
    ...
    assertEquals("There may not be two classifiers named 'a'", removeObjectHashCode(diagnostic47.getMessage()));
    assertEquals(29, diagnostic47.getCode());
    ...
    assertEquals(Diagnostic.WARNING, diagnostic48.getSeverity());
    assertEquals("org.eclipse.emf.ecore.model", diagnostic48.getSource());
    assertEquals("There may not be a classifier named 'A_' as well a classifier named 'a'", removeObjectHashCode(diagnostic48.getMessage()));
    assertEquals(29, diagnostic48.getCode());
    ...
    assertEquals("There may not be two packages with namespace URI 'platform:/plugin/org.eclipse.emf.test.core/models/Bad.ecore#//package/duplicateNsURIs/a1'", removeObjectHashCode(diagnostic49.getMessage()));
    assertEquals(33, diagnostic49.getCode());
    assertEquals(0, diagnostic49.getChildren().size());
    assertEquals(2, diagnostic49.getData().size());
    ...
    assertEquals("There may not be two packages with namespace URI 'platform:/plugin/org.eclipse.emf.test.core/models/Bad.ecore#//package/duplicateNsURIs/a1'", removeObjectHashCode(diagnostic50.getMessage()));
    assertEquals(33, diagnostic50.getCode());
    assertEquals(0, diagnostic50.getChildren().size());
    assertEquals(2, diagnostic50.getData().size());
    ...
    assertEquals("The opposite of the opposite may not be a reference different from this one", removeObjectHashCode(diagnostic51.getMessage()));
    assertEquals(14, diagnostic51.getCode());
    ...
    assertEquals("The opposite must be a feature of the reference's type", removeObjectHashCode(diagnostic52.getMessage()));
    assertEquals(13, diagnostic52.getCode());
    ...
    assertEquals("The opposite of a transient reference must transient if it is proxy resolving", removeObjectHashCode(diagnostic53.getMessage()));
    assertEquals(11, diagnostic53.getCode());
    ...
    assertEquals("A container reference must have upper bound of 1 not 2", removeObjectHashCode(diagnostic54.getMessage()));
    assertEquals(28, diagnostic54.getCode());
    ...
    assertEquals("The opposite of a containment reference must not be a containment reference", removeObjectHashCode(diagnostic55.getMessage()));
    assertEquals(12, diagnostic55.getCode());
    assertEquals(0, diagnostic55.getChildren().size());
    assertEquals(2, diagnostic55.getData().size());
    ...
    assertEquals("The opposite of a containment reference must not be a containment reference", removeObjectHashCode(diagnostic56.getMessage()));
    assertEquals(12, diagnostic56.getCode());
    assertEquals(0, diagnostic56.getChildren().size());
    assertEquals(2, diagnostic56.getData().size());
    ...
    assertEquals("The lower bound -1 must be greater than or equal to 0", removeObjectHashCode(diagnostic57.getMessage()));
    assertEquals(38, diagnostic57.getCode());
    ...
    assertEquals("The upper bound 0 must be -2, -1, or greater than 0", removeObjectHashCode(diagnostic58.getMessage()));
    ...
    assertEquals("The upper bound -3 must be -2, -1, or greater than 0", removeObjectHashCode(diagnostic59.getMessage()));
    assertEquals(40, diagnostic59.getCode());
    assertEquals(0, diagnostic59.getChildren().size());
    assertEquals(1, diagnostic59.getData().size());
    ...
    assertEquals("The lower bound 2 must be less than or equal to the upper bound 1", removeObjectHashCode(diagnostic60.getMessage()));
    assertEquals(6, diagnostic60.getCode());
    assertEquals(0, diagnostic60.getChildren().size());
    assertEquals(1, diagnostic60.getData().size());
    ...
    assertEquals("org.eclipse.emf.ecore", diagnostic61.getSource());
    assertEquals("The required feature 'eAttributeType' of 'org.eclipse.emf.ecore.impl.EAttributeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//genericType/AttributeClassType/a}' must be set", removeObjectHashCode(diagnostic61.getMessage()));
    assertEquals(1, diagnostic61.getCode());
    ...
    assertEquals("The generic attribute type must not refer to a class", removeObjectHashCode(diagnostic62.getMessage()));
    assertEquals(19, diagnostic62.getCode());
    assertEquals(0, diagnostic62.getChildren().size());
    assertEquals(1, diagnostic62.getData().size());
    ...
    assertEquals("org.eclipse.emf.ecore", diagnostic63.getSource());
    assertEquals("The required feature 'eReferenceType' of 'org.eclipse.emf.ecore.impl.EReferenceImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//genericType/ReferenceDataType/r}' must be set", removeObjectHashCode(diagnostic63.getMessage()));
    assertEquals(1, diagnostic63.getCode());
    ...
    assertEquals("The generic reference type must not refer to a data type", removeObjectHashCode(diagnostic64.getMessage()));
    assertEquals(20, diagnostic64.getCode());
    ...
    assertEquals("A generic type can't refer to both a type parameter and a classifier", removeObjectHashCode(diagnostic65.getMessage()));
    assertEquals(21, diagnostic65.getCode());
    ...
    assertEquals("A generic super type must refer to a class", removeObjectHashCode(diagnostic66.getMessage()));
    assertEquals(18, diagnostic66.getCode());
    ...
    assertEquals("A generic super type must refer to a class", removeObjectHashCode(diagnostic67.getMessage()));
    assertEquals(18, diagnostic67.getCode());
    ...
    assertEquals("The generic super types at index '1' and '0' must not be duplicates", removeObjectHashCode(diagnostic68.getMessage()));
    assertEquals(16, diagnostic68.getCode());
    ...
    assertEquals("A generic type in this context must refer to a classifier or a type parameter", removeObjectHashCode(diagnostic69.getMessage()));
    assertEquals(24, diagnostic69.getCode());
    ...
    assertEquals("A generic type must not have both a lower and an upper bound", removeObjectHashCode(diagnostic70.getMessage()));
    assertEquals(9, diagnostic70.getCode());
    ...
    assertEquals("A generic type may have bounds only when used as a type argument", removeObjectHashCode(diagnostic71.getMessage()));
    assertEquals(7, diagnostic71.getCode());
    ...
    assertEquals("A generic type with bounds must not also refer to a type parameter or classifier", removeObjectHashCode(diagnostic72.getMessage()));
    assertEquals(8, diagnostic72.getCode());
    assertEquals(0, diagnostic72.getChildren().size());
    assertEquals(1, diagnostic72.getData().size());
    ...
    assertEquals("A generic type may have arguments only if it refers to a classifier", removeObjectHashCode(diagnostic73.getMessage()));
    assertEquals(5, diagnostic73.getCode());
    ...
    assertEquals(Diagnostic.WARNING, diagnostic74.getSeverity());
    assertEquals("org.eclipse.emf.ecore.model", diagnostic74.getSource());
    assertEquals("The generic type associated with the 'EJavaClass' classifier should have 1 type argument(s) to match the number of type parameter(s) of the classifier ", removeObjectHashCode(diagnostic74.getMessage()));
    assertEquals(4, diagnostic74.getCode());
    assertEquals(0, diagnostic74.getChildren().size());
    assertEquals(1, diagnostic74.getData().size());
    ...
    assertEquals("The generic type associated with the 'EJavaClass' classifier must not have 2 argument(s) when the classifier has 1 type parameter(s)", removeObjectHashCode(diagnostic75.getMessage()));
    assertEquals(2, diagnostic75.getCode());
    ...
    assertEquals("A generic type may only refer to a type parameter that is in scope", removeObjectHashCode(diagnostic76.getMessage()));
    assertEquals(23, diagnostic76.getCode());
    ...
    assertEquals("The generic super types instantiate 'org.eclipse.emf.ecore.impl.EClassImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//genericType/BaseClass}' inconsistently", removeObjectHashCode(diagnostic77.getMessage()));
    assertEquals(15, diagnostic77.getCode());
    ...
    assertEquals("A generic type may only refer to a type parameter that is in scope", removeObjectHashCode(diagnostic78.getMessage()));
    assertEquals(23, diagnostic78.getCode());
    ...
    assertEquals("A generic type may only refer to a type parameter that is in scope", removeObjectHashCode(diagnostic79.getMessage()));
    assertEquals(23, diagnostic79.getCode());
    ...
    assertEquals("The primitive type 'int' cannot be used in this context", removeObjectHashCode(diagnostic80.getMessage()));
    assertEquals(22, diagnostic80.getCode());
    ...
    assertEquals("The primitive type 'int' cannot be used in this context", removeObjectHashCode(diagnostic81.getMessage()));
    assertEquals(22, diagnostic81.getCode());
    ...
    assertEquals("The primitive type 'int' cannot be used in this context", removeObjectHashCode(diagnostic82.getMessage()));
    assertEquals(22, diagnostic82.getCode());
    ...
    assertEquals("The primitive type 'int' cannot be used in this context", removeObjectHashCode(diagnostic83.getMessage()));
    assertEquals(22, diagnostic83.getCode());
    ...
    assertEquals("The primitive type 'int' cannot be used in this context", removeObjectHashCode(diagnostic84.getMessage()));
    assertEquals(22, diagnostic84.getCode());
    ...
    assertEquals("The key 'org.eclipse.emf.ecore.impl.EAttributeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//key/ReferenceWithKeyNotFromReferenceType/a}' must be feature of the reference's type", removeObjectHashCode(diagnostic85.getMessage()));
    assertEquals(10, diagnostic85.getCode());
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container/f/b//.1}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container/U}'", removeObjectHashCode(diagnostic86.getMessage()));
    assertEquals(3, diagnostic86.getCode());
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container/f/d//.1}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container/U}'", removeObjectHashCode(diagnostic87.getMessage()));
    assertEquals(3, diagnostic87.getCode());
    assertEquals(0, diagnostic87.getChildren().size());
    assertEquals(3, diagnostic87.getData().size());
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container/f/g//.2}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container/V}'", removeObjectHashCode(diagnostic88.getMessage()));
    assertEquals(3, diagnostic88.getCode());
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container2/g/b//.1}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container2/U}'", removeObjectHashCode(diagnostic89.getMessage()));
    assertEquals(3, diagnostic89.getCode());
    assertEquals(0, diagnostic89.getChildren().size());
    assertEquals(3, diagnostic89.getData().size());
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container2/g/d//.1}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container2/U}'", removeObjectHashCode(diagnostic90.getMessage()));
    assertEquals(3, diagnostic90.getCode());
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/g/b//.1}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/U}'", removeObjectHashCode(diagnostic91.getMessage()));
    assertEquals(3, diagnostic91.getCode());
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/g/d//.1}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/U}'", removeObjectHashCode(diagnostic92.getMessage()));
    assertEquals(3, diagnostic92.getCode());
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/g/g//.2}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/V}'", removeObjectHashCode(diagnostic93.getMessage()));
    assertEquals(3, diagnostic93.getCode());
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/g/j//.2}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/V}'", removeObjectHashCode(diagnostic94.getMessage()));
    assertEquals(3, diagnostic94.getCode());
    assertEquals(0, diagnostic94.getChildren().size());
    assertEquals(3, diagnostic94.getData().size());
    ...
    assertEquals("The generic type associated with the 'A' classifier should have 1 type argument(s) to match the number of type parameter(s) of the classifier ", removeObjectHashCode(diagnostic95.getMessage()));
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/h/b//.1}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/U}'", removeObjectHashCode(diagnostic96.getMessage()));
    assertEquals(3, diagnostic96.getCode());
    assertEquals(0, diagnostic96.getChildren().size());
    assertEquals(3, diagnostic96.getData().size());
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/h/d//.1}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/U}'", removeObjectHashCode(diagnostic97.getMessage()));
    assertEquals(3, diagnostic97.getCode());
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/h/g//.2}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/V}'", removeObjectHashCode(diagnostic98.getMessage()));
    assertEquals(3, diagnostic98.getCode());
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/h/j//.2}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/V}'", removeObjectHashCode(diagnostic99.getMessage()));
    assertEquals(3, diagnostic99.getCode());
    ...
    assertEquals(Diagnostic.WARNING, diagnostic100.getSeverity());
    assertEquals("org.eclipse.emf.ecore.model", diagnostic100.getSource());
    assertEquals("The generic type associated with the 'B' classifier should have 1 type argument(s) to match the number of type parameter(s) of the classifier ", removeObjectHashCode(diagnostic100.getMessage()));
