...
public class BadEcoreDiagnosticTest extends TestCase
{
  ...
  public void testDiagnostic() throws Exception
  {
    ...
    assertEquals(103, diagnostic1.getChildren().size());
    ...
    assertEquals("There may not be two enumerators named 'A'", removeObjectHashCode(diagnostic45.getMessage()));
    assertEquals(31, diagnostic45.getCode());
    ...
    assertEquals(Diagnostic.WARNING, diagnostic46.getSeverity());
    assertEquals("org.eclipse.emf.ecore.model", diagnostic46.getSource());
    assertEquals("There should not be an enumerator named 'A' as well an enumerator named 'a'", removeObjectHashCode(diagnostic46.getMessage()));
    assertEquals(31, diagnostic46.getCode());
    ...
    assertEquals(Diagnostic.WARNING, diagnostic47.getSeverity());
    assertEquals("org.eclipse.emf.ecore.model", diagnostic47.getSource());
    assertEquals("There should not be an enumerator named 'A_' as well an enumerator named 'a'", removeObjectHashCode(diagnostic47.getMessage()));
    assertEquals(31, diagnostic47.getCode());
    ...
    assertEquals("There may not be two enumerators with literal value 'x'", removeObjectHashCode(diagnostic48.getMessage()));
    assertEquals(30, diagnostic48.getCode());
    ...
    assertEquals("There may not be two parameters named 'x'", removeObjectHashCode(diagnostic49.getMessage()));
    assertEquals(35, diagnostic49.getCode());
    ...
    assertEquals("There may not be two type parameters named 'T'", removeObjectHashCode(diagnostic50.getMessage()));
    assertEquals(37, diagnostic50.getCode());
    ...
    assertEquals("There may not be two type parameters named 'A'", removeObjectHashCode(diagnostic51.getMessage()));
    assertEquals(37, diagnostic51.getCode());
    ...
    assertEquals("An operation with void return type must have an upper bound of 1 not -1", removeObjectHashCode(diagnostic52.getMessage()));
    assertEquals(27, diagnostic52.getCode());
    ...
    assertEquals("There may not be two packages named 'duplicateName'", removeObjectHashCode(diagnostic53.getMessage()));
    assertEquals(36, diagnostic53.getCode());
    assertEquals(0, diagnostic53.getChildren().size());
    assertEquals(3, diagnostic53.getData().size());
    ...
    assertEquals("The namespace URI 'null' is not well formed", removeObjectHashCode(diagnostic54.getMessage()));
    assertEquals(46, diagnostic54.getCode());
    ...
    assertEquals("The namespace URI '' is not well formed", removeObjectHashCode(diagnostic55.getMessage()));
    assertEquals(46, diagnostic55.getCode());
    ...
    assertEquals("The namespace URI 'NSUI With Space' is not well formed", removeObjectHashCode(diagnostic56.getMessage()));
    assertEquals(46, diagnostic56.getCode());
    ...
    assertEquals("The namespace URI 'NsURIWithUnencoded%' is not well formed", removeObjectHashCode(diagnostic57.getMessage()));
    assertEquals(46, diagnostic57.getCode());
    ...
    assertEquals("The namespace prefix '' is not well formed", removeObjectHashCode(diagnostic58.getMessage()));
    assertEquals(45, diagnostic58.getCode());
    ...
    assertEquals("The namespace prefix 'xml.prefix' is not well formed", removeObjectHashCode(diagnostic59.getMessage()));
    assertEquals(45, diagnostic59.getCode());
    ...
    assertEquals("The namespace prefix 'bad.package:nonNSNamePrefix' is not well formed", removeObjectHashCode(diagnostic60.getMessage()));
    assertEquals(45, diagnostic60.getCode());
    ...
    assertEquals("There may not be two classifiers named 'a'", removeObjectHashCode(diagnostic61.getMessage()));
    assertEquals(29, diagnostic61.getCode());
    assertEquals(0, diagnostic61.getChildren().size());
    assertEquals(3, diagnostic61.getData().size());
    assertNull(diagnostic61.getException());

    Diagnostic diagnostic62 = diagnosticIterator.next();
    assertEquals(Diagnostic.WARNING, diagnostic62.getSeverity());
    assertEquals("org.eclipse.emf.ecore.model", diagnostic62.getSource());
    assertEquals("There may not be a classifier named 'A_' as well a classifier named 'a'", removeObjectHashCode(diagnostic62.getMessage()));
    assertEquals(29, diagnostic62.getCode());
    ...
    assertEquals("There may not be two packages with namespace URI 'platform:/plugin/org.eclipse.emf.test.core/models/Bad.ecore#//package/duplicateNsURIs/a1'", removeObjectHashCode(diagnostic63.getMessage()));
    assertEquals(33, diagnostic63.getCode());
    ...
    assertEquals("There may not be two packages with namespace URI 'platform:/plugin/org.eclipse.emf.test.core/models/Bad.ecore#//package/duplicateNsURIs/a1'", removeObjectHashCode(diagnostic64.getMessage()));
    assertEquals(33, diagnostic64.getCode());
    ...
    assertEquals("The opposite of the opposite may not be a reference different from this one", removeObjectHashCode(diagnostic65.getMessage()));
    assertEquals(14, diagnostic65.getCode());
    assertEquals(0, diagnostic65.getChildren().size());
    assertEquals(3, diagnostic65.getData().size());
    ...
    assertEquals("The opposite must be a feature of the reference's type", removeObjectHashCode(diagnostic66.getMessage()));
    assertEquals(13, diagnostic66.getCode());
    assertEquals(0, diagnostic66.getChildren().size());
    assertEquals(3, diagnostic66.getData().size());
    ...
    assertEquals("The opposite of a transient reference must transient if it is proxy resolving", removeObjectHashCode(diagnostic67.getMessage()));
    assertEquals(11, diagnostic67.getCode());
    ...
    assertEquals("A container reference must have upper bound of 1 not 2", removeObjectHashCode(diagnostic68.getMessage()));
    assertEquals(28, diagnostic68.getCode());
    ...
    assertEquals("The opposite of a containment reference must not be a containment reference", removeObjectHashCode(diagnostic69.getMessage()));
    assertEquals(12, diagnostic69.getCode());
    assertEquals(0, diagnostic69.getChildren().size());
    assertEquals(2, diagnostic69.getData().size());
    ...
    assertEquals("The opposite of a containment reference must not be a containment reference", removeObjectHashCode(diagnostic70.getMessage()));
    assertEquals(12, diagnostic70.getCode());
    assertEquals(0, diagnostic70.getChildren().size());
    assertEquals(2, diagnostic70.getData().size());
    ...
    assertEquals("The lower bound -1 must be greater than or equal to 0", removeObjectHashCode(diagnostic71.getMessage()));
    assertEquals(39, diagnostic71.getCode());
    ...
    assertEquals("The upper bound 0 must be -2, -1, or greater than 0", removeObjectHashCode(diagnostic72.getMessage()));
    assertEquals(41, diagnostic72.getCode());
    ...
    assertEquals("The upper bound -3 must be -2, -1, or greater than 0", removeObjectHashCode(diagnostic73.getMessage()));
    assertEquals(41, diagnostic73.getCode());
    ...
    assertEquals("The lower bound 2 must be less than or equal to the upper bound 1", removeObjectHashCode(diagnostic74.getMessage()));
    assertEquals(6, diagnostic74.getCode());
    ...
    assertEquals("org.eclipse.emf.ecore", diagnostic75.getSource());
    assertEquals("The required feature 'eAttributeType' of 'org.eclipse.emf.ecore.impl.EAttributeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//genericType/AttributeClassType/a}' must be set", removeObjectHashCode(diagnostic75.getMessage()));
    assertEquals(1, diagnostic75.getCode());
    ...
    assertEquals("The generic attribute type must not refer to a class", removeObjectHashCode(diagnostic76.getMessage()));
    assertEquals(19, diagnostic76.getCode());
    ...
    assertEquals("org.eclipse.emf.ecore", diagnostic77.getSource());
    assertEquals("The required feature 'eReferenceType' of 'org.eclipse.emf.ecore.impl.EReferenceImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//genericType/ReferenceDataType/r}' must be set", removeObjectHashCode(diagnostic77.getMessage()));
    assertEquals(1, diagnostic77.getCode());
    ...
    assertEquals("The generic reference type must not refer to a data type", removeObjectHashCode(diagnostic78.getMessage()));
    assertEquals(20, diagnostic78.getCode());
    ...
    assertEquals("A generic type can't refer to both a type parameter and a classifier", removeObjectHashCode(diagnostic79.getMessage()));
    assertEquals(21, diagnostic79.getCode());
    ...
    assertEquals("A generic super type must refer to a class", removeObjectHashCode(diagnostic80.getMessage()));
    assertEquals(18, diagnostic80.getCode());
    ...
    assertEquals("A generic super type must refer to a class", removeObjectHashCode(diagnostic81.getMessage()));
    assertEquals(18, diagnostic81.getCode());
    ...
    assertEquals("The generic super types at index '1' and '0' must not be duplicates", removeObjectHashCode(diagnostic82.getMessage()));
    assertEquals(16, diagnostic82.getCode());
    assertEquals(0, diagnostic82.getChildren().size());
    assertEquals(3, diagnostic82.getData().size());
    ...
    assertEquals("A generic type in this context must refer to a classifier or a type parameter", removeObjectHashCode(diagnostic83.getMessage()));
    assertEquals(24, diagnostic83.getCode());
    ...
    assertEquals("A generic type must not have both a lower and an upper bound", removeObjectHashCode(diagnostic84.getMessage()));
    assertEquals(9, diagnostic84.getCode());
    ...
    assertEquals("A generic type may have bounds only when used as a type argument", removeObjectHashCode(diagnostic85.getMessage()));
    assertEquals(7, diagnostic85.getCode());
    ...
    assertEquals("A generic type with bounds must not also refer to a type parameter or classifier", removeObjectHashCode(diagnostic86.getMessage()));
    assertEquals(8, diagnostic86.getCode());
    ...
    assertEquals("A generic type may have arguments only if it refers to a classifier", removeObjectHashCode(diagnostic87.getMessage()));
    assertEquals(5, diagnostic87.getCode());
    ...
    assertEquals(Diagnostic.WARNING, diagnostic88.getSeverity());
    assertEquals("org.eclipse.emf.ecore.model", diagnostic88.getSource());
    assertEquals("The generic type associated with the 'EJavaClass' classifier should have 1 type argument(s) to match the number of type parameter(s) of the classifier ", removeObjectHashCode(diagnostic88.getMessage()));
    assertEquals(4, diagnostic88.getCode());
    ...
    assertEquals("The generic type associated with the 'EJavaClass' classifier must not have 2 argument(s) when the classifier has 1 type parameter(s)", removeObjectHashCode(diagnostic89.getMessage()));
    assertEquals(2, diagnostic89.getCode());
    ...
    assertEquals("A generic type may only refer to a type parameter that is in scope", removeObjectHashCode(diagnostic90.getMessage()));
    ...
    assertEquals("The generic super types instantiate 'org.eclipse.emf.ecore.impl.EClassImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//genericType/BaseClass}' inconsistently", removeObjectHashCode(diagnostic91.getMessage()));
    assertEquals(15, diagnostic91.getCode());
    ...
    assertEquals("A generic type may only refer to a type parameter that is in scope", removeObjectHashCode(diagnostic92.getMessage()));
    assertEquals(23, diagnostic92.getCode());
    ...
    assertEquals("A generic type may only refer to a type parameter that is in scope", removeObjectHashCode(diagnostic93.getMessage()));
    assertEquals(23, diagnostic93.getCode());
    ...
    assertEquals("The primitive type 'int' cannot be used in this context", removeObjectHashCode(diagnostic94.getMessage()));
    ...
    assertEquals("The primitive type 'int' cannot be used in this context", removeObjectHashCode(diagnostic95.getMessage()));
    ...
    assertEquals("The primitive type 'int' cannot be used in this context", removeObjectHashCode(diagnostic96.getMessage()));
    assertEquals(22, diagnostic96.getCode());
    ...
    assertEquals("The primitive type 'int' cannot be used in this context", removeObjectHashCode(diagnostic97.getMessage()));
    assertEquals(22, diagnostic97.getCode());
    ...
    assertEquals("The primitive type 'int' cannot be used in this context", removeObjectHashCode(diagnostic98.getMessage()));
    assertEquals(22, diagnostic98.getCode());
    ...
    assertEquals("The key 'org.eclipse.emf.ecore.impl.EAttributeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//key/ReferenceWithKeyNotFromReferenceType/a}' must be feature of the reference's type", removeObjectHashCode(diagnostic99.getMessage()));
    assertEquals(10, diagnostic99.getCode());
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container/f/b//.1}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container/U}'", removeObjectHashCode(diagnostic100.getMessage()));
    assertEquals(3, diagnostic100.getCode());
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container/f/d//.1}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container/U}'", removeObjectHashCode(diagnostic101.getMessage()));
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container/f/g//.2}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container/V}'", removeObjectHashCode(diagnostic102.getMessage()));
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container2/g/b//.1}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container2/U}'", removeObjectHashCode(diagnostic103.getMessage()));
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container2/g/d//.1}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container2/U}'", removeObjectHashCode(diagnostic104.getMessage()));
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/g/b//.1}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/U}'", removeObjectHashCode(diagnostic105.getMessage()));
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/g/d//.1}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/U}'", removeObjectHashCode(diagnostic106.getMessage()));
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/g/g//.2}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/V}'", removeObjectHashCode(diagnostic107.getMessage()));
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/g/j//.2}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/V}'", removeObjectHashCode(diagnostic108.getMessage()));
    ...
    assertEquals(Diagnostic.WARNING, diagnostic109.getSeverity());
    assertEquals("org.eclipse.emf.ecore.model", diagnostic109.getSource());
    assertEquals("The generic type associated with the 'A' classifier should have 1 type argument(s) to match the number of type parameter(s) of the classifier ", removeObjectHashCode(diagnostic109.getMessage()));
    assertEquals(4, diagnostic109.getCode());
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/h/b//.1}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/U}'", removeObjectHashCode(diagnostic110.getMessage()));
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/h/d//.1}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/U}'", removeObjectHashCode(diagnostic111.getMessage()));
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/h/g//.2}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/V}'", removeObjectHashCode(diagnostic112.getMessage()));
    ...
    assertEquals("The generic type 'org.eclipse.emf.ecore.impl.EGenericTypeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/h/j//.2}' is not a valid substitution for type parameter 'org.eclipse.emf.ecore.impl.ETypeParameterImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//substitution/Container3/V}'", removeObjectHashCode(diagnostic113.getMessage()));
    ...
    assertEquals(Diagnostic.WARNING, diagnostic114.getSeverity());
    assertEquals("org.eclipse.emf.ecore.model", diagnostic114.getSource());
    assertEquals("The generic type associated with the 'B' classifier should have 1 type argument(s) to match the number of type parameter(s) of the classifier ", removeObjectHashCode(diagnostic114.getMessage()));
    assertEquals(4, diagnostic114.getCode());
    assertEquals(0, diagnostic114.getChildren().size());
    assertEquals(1, diagnostic114.getData().size());
    ...
    assertEquals("The default value literal '256' must be a valid literal of the attribute's type", removeObjectHashCode(diagnostic115.getMessage()));
    assertEquals(39, diagnostic115.getCode());
    assertEquals(1, diagnostic115.getChildren().size());
    ...
    assertEquals("org.eclipse.emf.ecore", diagnostic116.getSource());
    assertEquals("The value '256' must be less than or equal to '255' ", removeObjectHashCode(diagnostic116.getMessage()));
    assertEquals(5, diagnostic116.getCode());
    ...
    assertEquals("The default value literal '' must be a valid literal of the attribute's type", removeObjectHashCode(diagnostic117.getMessage()));
    assertEquals(39, diagnostic117.getCode());
