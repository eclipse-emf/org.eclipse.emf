 ...
 * </copyright>
 *
 * $Id: KeyFactoryImpl.java,v 1.1 2006/12/18 22:02:03 marcelop Exp $
 */
...
public class KeyFactoryImpl extends EFactoryImpl implements KeyFactory
{
  ...
  public static KeyFactory init()
  {
    try
    {
      KeyFactory theKeyFactory = (KeyFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.eclipse.org/emf/test/models/key"); 
