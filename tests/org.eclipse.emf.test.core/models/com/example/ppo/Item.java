 ...
 * </copyright>
 *
 * $Id: Item.java,v 1.1 2005/03/14 22:15:58 marcelop Exp $
 */
 ...
 * <ul>
 *   <li>{@link com.example.ppo.Item#getProductName <em>Product Name</em>}</li>
 *   <li>{@link com.example.ppo.Item#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link com.example.ppo.Item#getUSPrice <em>US Price</em>}</li>
 *   <li>{@link com.example.ppo.Item#getComment <em>Comment</em>}</li>
 *   <li>{@link com.example.ppo.Item#getShipDate <em>Ship Date</em>}</li>
 *   <li>{@link com.example.ppo.Item#getPartNum <em>Part Num</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.example.ppo.PPOPackage#getItem()
...
public interface Item extends EObject
{
   ...
   * @see com.example.ppo.PPOPackage#getItem_ProductName()
   * @model
   * @generated
   */
   ...
   * @see #setQuantity(int)
   * @see com.example.ppo.PPOPackage#getItem_Quantity()
   * @model
   * @generated
   */
  int getQuantity();
   ...
   * @see #setUSPrice(int)
   * @see com.example.ppo.PPOPackage#getItem_USPrice()
   * @model
   * @generated
   */
  int getUSPrice();
   ...
   * @see com.example.ppo.PPOPackage#getItem_Comment()
   * @model
   * @generated
   */
  String getComment();
   ...
   * @see com.example.ppo.PPOPackage#getItem_ShipDate()
   ...
   * @see com.example.ppo.PPOPackage#getItem_PartNum()
