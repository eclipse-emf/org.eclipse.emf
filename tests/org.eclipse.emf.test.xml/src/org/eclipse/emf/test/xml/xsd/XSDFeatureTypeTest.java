 ...
 * </copyright>
 *
 * $Id: XSDFeatureTypeTest.java,v 1.1.2.1 2007/02/23 22:34:43 emerks Exp $
 */
...
public class XSDFeatureTypeTest extends TestCase
{
  ...
  protected void setUp() throws Exception
  {
    ...
    resource.setURI(URI.createFileURI(TestUtil.getPluginDirectory() + "/data/xsd/TestSchema.xsd"));
    ...
    try
    {
      ...
      anyType = (XSDTypeDefinition) schema.getSchemaForSchema().resolveTypeDefinition(ANY_TYPE);
    }
    catch (IOException e)
    {
      e.printStackTrace();
