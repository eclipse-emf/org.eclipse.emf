 ...
 * </copyright>
 *
 * $Id: LibraryFactoryImpl.java,v 1.1 2006/12/15 20:41:37 marcelop Exp $
 */
...
public class LibraryFactoryImpl extends EFactoryImpl implements LibraryFactory
{
  ...
  public static LibraryFactory init()
  {
    try
    {
      LibraryFactory theLibraryFactory = (LibraryFactory)EPackage.Registry.INSTANCE.getEFactory("http:///library.ecore"); //$NON-NLS-1$ 
