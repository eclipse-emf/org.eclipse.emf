 ...
 * </p>
 *
 * @see org.eclipse.emf.test.models.personal.mixed.MixedPackage#getDocumentRoot()
...
public interface DocumentRoot
{
   ...
   * @see org.eclipse.emf.test.models.personal.mixed.MixedPackage#getDocumentRoot_Mixed()
   ...
   * @see org.eclipse.emf.test.models.personal.mixed.MixedPackage#getDocumentRoot_XMLNSPrefixMap()
   ...
   * @see org.eclipse.emf.test.models.personal.mixed.MixedPackage#getDocumentRoot_XSISchemaLocation()
   * @model mapType="org.eclipse.emf.ecore.EStringToStringMapEntry" keyType="java.lang.String" valueType="java.lang.String" transient="true"
   ...
   * @see #setEmail(String)
   * @see org.eclipse.emf.test.models.personal.mixed.MixedPackage#getDocumentRoot_Email()
   ...
   * @see org.eclipse.emf.test.models.personal.mixed.MixedPackage#getDocumentRoot_Family()
   * @model unique="false" dataType="org.eclipse.emf.ecore.xml.type.String" upper="-2" transient="true" volatile="true" derived="true"
   ...
   * @see #setGiven(String)
   * @see org.eclipse.emf.test.models.personal.mixed.MixedPackage#getDocumentRoot_Given()
   * @model unique="false" dataType="org.eclipse.emf.ecore.xml.type.String" upper="-2" transient="true" volatile="true" derived="true"
   ...
   * @see org.eclipse.emf.test.models.personal.mixed.MixedPackage#getDocumentRoot_Link()
   ...
   * @see org.eclipse.emf.test.models.personal.mixed.MixedPackage#getDocumentRoot_Name()
   * @model containment="true" upper="-2" transient="true" volatile="true" derived="true"
   ...
   * @see org.eclipse.emf.test.models.personal.mixed.MixedPackage#getDocumentRoot_Person()
   * @model containment="true" upper="-2" transient="true" volatile="true" derived="true"
   ...
   * @see org.eclipse.emf.test.models.personal.mixed.MixedPackage#getDocumentRoot_Personnel()
   * @model containment="true" upper="-2" transient="true" volatile="true" derived="true"
   ...
   * @see #setUrl(UrlType)
   * @see org.eclipse.emf.test.models.personal.mixed.MixedPackage#getDocumentRoot_Url()
   * @model containment="true" upper="-2" transient="true" volatile="true" derived="true"
