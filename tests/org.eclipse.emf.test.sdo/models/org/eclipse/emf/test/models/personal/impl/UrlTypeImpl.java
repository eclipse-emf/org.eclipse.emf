 ...
 * </copyright>
 *
 * $Id: UrlTypeImpl.java,v 1.2 2006/12/30 03:44:08 marcelop Exp $
 */
...
public class UrlTypeImpl extends EDataObjectImpl implements UrlType
{
  ...
  {
    return PersonalPackage.Literals.URL_TYPE;
  }
  ...
  public void setHref(String newHref)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PersonalPackage.URL_TYPE__HREF, oldHref, href, !oldHrefESet));
  }
  ...
  public void unsetHref()
  {
    ...
    hrefESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, PersonalPackage.URL_TYPE__HREF, oldHref, HREF_EDEFAULT, oldHrefESet));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PersonalPackage.URL_TYPE__HREF:
        return getHref();
    }
