 ...
 */
package org.eclipse.emf.test.models.dynamic.util;
...
public class DynamicAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected DynamicSwitch<Adapter> modelSwitch =
    new DynamicSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseBase(EObject object)
      {
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.emf.test.models.dynamic.Provider <em>Provider</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.emf.test.models.dynamic.Admin <em>Admin</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.emf.test.models.dynamic.Service <em>Service</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.emf.test.models.dynamic.Detail <em>Detail</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.emf.ecore.EObject <em>Base</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
