 ...
 * </copyright>
 *
 * $Id: CirculatingItemItemProvider.java,v 1.1 2005/11/10 18:56:39 marcelop Exp $
 */
...
public class CirculatingItemItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EXTLibraryPackage.eINSTANCE.getLendable_Copies(),
				 true,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EXTLibraryPackage.eINSTANCE.getLendable_Borrowers(),
				 true,
				 null,
				 null,
				 null));
	...
	public Object getImage(Object object) {
		return getResourceLocator().getImage("full/obj16/CirculatingItem"); //$NON-NLS-1$
	}
