 ...
 * </copyright>
 *
 * $Id: AddLibraryCommand.java,v 1.1 2005/11/10 18:57:56 marcelop Exp $
 */
	...
	public AddLibraryCommand(EditingDomain domain, EList list, Object value) {
		...
		if (domain instanceof AdapterFactoryEditingDomain) {
			labelProvider = (IItemLabelProvider) ((AdapterFactoryEditingDomain) domain)
				.getAdapterFactory().adapt(value, IItemLabelProvider.class);
		}

		setLabel(EMFEditPlugin.INSTANCE.getString(
			"_UI_CreateChildCommand_label", new Object[] {getText()})); //$NON-NLS-1$
		setDescription(EMFEditPlugin.INSTANCE
			.getString("_UI_CreateChildCommand_description")); //$NON-NLS-1$
	}
